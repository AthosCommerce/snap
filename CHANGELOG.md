...
- **pluginshopifymarkets:** bugfix for shopify markets plugin, moving from using currency to country for base compare ([cdcec4d](https://github.com/AthosCommerce/snap/commit/cdcec4d2c55c0ba660261afc7f6983a7422852f6))
...
- Revert "fix(ci): reduce Core tests worker concurrency to avoid resource exhaustion" ([e1c170d](https://github.com/AthosCommerce/snap/commit/e1c170d9ef74563810b5f78b3bd7eb4d5574db3a))
- Revert "debug(ci): drop to --maxWorkers=1 to isolate whether concurrency is the driver" ([6797a47](https://github.com/AthosCommerce/snap/commit/6797a47ebd2ecc83d4b3b9557c309dba6ad65182))
