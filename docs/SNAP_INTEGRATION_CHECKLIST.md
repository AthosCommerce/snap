...
- [ ] Product click/impression tracking wired via `withTracking` (or the library `ResultTracker`) — see [Product Click](https://athoscommerce.github.io/snap/snap-tracking#product-click) and [Impressions](https://athoscommerce.github.io/snap/snap-tracking#impressions)
...
## Tracking 📊 
- [ ] Result impression tracking added — confirm via dev tools network tab — see [Impressions](https://athoscommerce.github.io/snap/snap-tracking#impressions)
- [ ] Result click tracking added (not required if using `withTracking`/`ResultTracker`) — see [Product Click](https://athoscommerce.github.io/snap/snap-tracking#product-click)
- [ ] Result add-to-cart tracking added — see [Product Add To Cart](https://athoscommerce.github.io/snap/snap-tracking#product-add-to-cart)
- [ ] Shopper login tracking added — see [Shopper Login](https://athoscommerce.github.io/snap/snap-tracking#shopper-login)
- [ ] Currency tracking added (if multi-currency) — see [Currency](https://athoscommerce.github.io/snap/snap-tracking#currency)
- [ ] Product view tracking added — see [Product View](https://athoscommerce.github.io/snap/snap-tracking#product-view)
- [ ] Order transaction tracking added — see [Order Transaction](https://athoscommerce.github.io/snap/snap-tracking#order-transaction)
- [ ] Cart contents tracking added — see [Cart Contents](https://athoscommerce.github.io/snap/snap-tracking#cart-contents)
- [ ] Cart attribute tracking added, if using Realtime Recommendations — see [Cart Attribute Tracking](https://athoscommerce.github.io/snap/snap-tracking#cart-attribute-tracking)
