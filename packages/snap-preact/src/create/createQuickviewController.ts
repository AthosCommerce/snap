...
import type { SnapControllerServices, SnapQuickviewControllerConfig } from '../types';

export default (config: SnapQuickviewControllerConfig, services?: SnapControllerServices): QuickviewController => {
	...
	const cntrlr = new QuickviewController(
		config.controller,
		{
