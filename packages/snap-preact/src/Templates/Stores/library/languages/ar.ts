...
export const ar: LangComponents = {
	...
	searchHeader: {
		...
		expandedSearchText: {
			value: (data) => {
				return `لم نتمكن من العثور على تطابق تام لـ "<span className="ss__search-header__results-query">${data?.search?.query?.string}</span>"، ولكن إليك شيء مشابه:`;
			},
		},
	},
	noResults: {
		...
		suggestionsList: {
			value:
				'<ul className="ss__no-results__suggestions__list"><li className="ss__no-results__suggestions__list__option">تحقق من الأخطاء الإملائية.</li><li className="ss__no-results__suggestions__list__option">احذف أي كلمات مفتاحية زائدة (مثل: "منتجات").</li><li className="ss__no-results__suggestions__list__option">استخدم كلمات أخرى لوصف ما تبحث عنه.</li></ul>',
		},
		// contactsTitleText: {
