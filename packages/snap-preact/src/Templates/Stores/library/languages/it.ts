...
export const it: LangComponents = {
	...
	searchHeader: {
		...
		expandedSearchText: {
			value: (data) => {
				return `Non siamo riusciti a trovare una corrispondenza esatta per "<span className="ss__search-header__results-query">${data?.search?.query?.string}</span>", ma ecco qualcosa di simile:`;
			},
		},
	},
	noResults: {
		...
		suggestionsList: {
			value:
				'<ul className="ss__no-results__suggestions__list"><li className="ss__no-results__suggestions__list__option">Controlla eventuali errori di ortografia.</li><li className="ss__no-results__suggestions__list__option">Rimuovi eventuali parole chiave ridondanti (es: "prodotti").</li><li className="ss__no-results__suggestions__list__option">Usa altre parole per descrivere ciò che stai cercando.</li></ul>',
		},
		// contactsTitleText: {
