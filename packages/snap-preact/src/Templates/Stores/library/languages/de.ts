...
export const de: LangComponents = {
	...
	searchHeader: {
		...
		expandedSearchText: {
			value: (data) => {
				return `Wir konnten keine exakte Übereinstimmung für "<span className="ss__search-header__results-query">${data?.search?.query?.string}</span>" finden, aber hier ist etwas Ähnliches:`;
			},
		},
	},
	noResults: {
