...
export const tr: LangComponents = {
	...
	searchHeader: {
		...
		expandedSearchText: {
			value: (data) => {
				return `"<span className="ss__search-header__results-query">${data?.search?.query?.string}</span>" için tam bir eşleşme bulamadık, ancak işte benzer bir şey:`;
			},
		},
	},
	noResults: {
