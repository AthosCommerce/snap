					...
					Z = (0, l.PA)((A) => {
						...
						const c = f?.display?.mappings.core || f?.mappings?.core,
							...
							u = {
								...
								price: { internalClassName: 'ss__overlay-result__price', ...(0, m.s)({ disableStyles: y }), theme: _.theme, treePath: h },
								calloutBadge: {
								...
								image: {
									...
									alt: c?.name || '',
									src: c?.imageUrl || '',
									...(0, m.s)({ disableStyles: y, fallback: q }),
									theme: _.theme,
									treePath: h,
								},
								rating: {
								...
								button: {
									...
									onClick: (b) => {
										I(!0), L && L(b, f), P?.addToCart([f]), setTimeout(() => I(!1), oe);
									},
									...(0, m.s)({ disableStyles: y }),
									theme: _.theme,
									treePath: h,
						...
						const _e = (0, T.Z)(_, H),
							...
							me = Y()(fe, _.lang || {}),
							ue = (0, z.u)(me, { result: f, controller: P }),
							S = !!(c?.msrp && c?.price && c?.price < c?.msrp),
							ge = P?.store?.config?.asyncState?.product?.price ? f.state.priceFetched : !0;
						return c
							? (0, a.Y)(g._, {
														...
														children: (0, a.FD)('div', {
															...
															children: [
																...
																!J && ge && c.price && c.price > 0
																	...
																	: null,
																(0, B.Y)(X, { result: f, treePath: h }),
																!se && f.variants?.selections.length
																	? (0, a.Y)('div', {
																			className: 'ss__overlay-result__details__variant-selection',
																			children: f.variants?.selections.map((b) => (0, a.Y)(V.m, { ...u.variantSelection, selection: b })),
																	  })
																	: null,
																!ae &&
																	(0, a.Y)('div', {
