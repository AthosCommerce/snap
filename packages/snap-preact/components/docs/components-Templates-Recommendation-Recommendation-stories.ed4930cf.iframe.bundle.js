  ...
  return <Recommendation {...props} controller={controller} />;
				...
				const N = ({ vertical: v, theme: h }) =>
					...
					y = (0, i.PA)((v) => {
						...
						if (
							...
							const r = p()(C?.theme || {}, k?.theme || {}, { arrayMerge: (P, $) => $ });
							C.autoAdjustSlides &&
						...
						const {
							...
							{ overrideElement: fe, shouldRenderDefault: de } = (0, S._)('carousel', C);
						if (!de) return fe;
						let H = C.pagination,
							O = C.navigation,
							F = C.scrollbar;
						const Z = { icon: { internalClassName: 'ss__carousel__icon', ...(0, R.s)({ disableStyles: me }), theme: C.theme, treePath: ce } },
						...
						(0, n.vJ)(() => {
							if (z.current) {
								const P = z.current.querySelector('.swiper');
							...
							O &&
								(typeof O == 'object'
									? (O = { nextEl: '.ss_carousel_DNE', prevEl: '.ss_carousel_DNE', ...O })
									: (O = { nextEl: '.ss_carousel_DNE', prevEl: '.ss_carousel_DNE' })),
							F && (typeof F == 'object' ? (F = { enabled: !0, ...F }) : (F = { enabled: !0 }));
						const Y = () => {
							if (z.current) {
								const P = z.current?.querySelectorAll('.swiper-slide-visible');
								P.forEach(($, ge) => {
									$.classList.remove('swiper-last-visible-slide'), ge == P.length - 1 && $.classList.add('swiper-last-visible-slide');
								});
							}
						};
						return (
							...
							ne?.length
								? (0, t.Y)(M._, {
										children: (0, t.FD)('div', {
											ref: z,
											...se,
											className: s()('ss__carousel', I ? 'ss__carousel-vertical' : '', Ee, pe),
											children: [
												O !== !1 &&
													(0, t.Y)('div', {
														...
														children: (0, t.Y)('div', {
															...
															ref: ee,
															onClick: V && ((r) => V(r)),
															children: w || (0, t.Y)(B.I, { icon: I ? 'angle-up' : 'angle-left', ...Z.icon, name: 'prev' }),
														}),
													}),
												(0, t.Y)(c.RC, {
													...
													onBeforeInit: (r) => {
														O &&
															...
															(r.params.navigation.nextEl = K.current ? K.current : void 0)),
															re && re(r);
													},
													onInit: (r) => {
														W && W(r);
												...
												O !== !1 &&
													(0, t.Y)('div', {
														...
														children: (0, t.Y)('div', {
															...
															ref: K,
															onClick: le && ((r) => le(r)),
															children: b || (0, t.Y)(B.I, { icon: I ? 'angle-down' : 'angle-right', ...Z.icon, name: 'next' }),
														}),
													}),
											],
										}),
			...
			'./components/src/components/Molecules/Result/Result.tsx'(A, a, e) {
				...
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					S = e('./components/src/components/Molecules/Rating/Rating.tsx'),
				...
				const x = () =>
					...
					oe = (0, o.PA)((C) => {
						const k = (0, _.u)(),
							...
							{ overrideElement: F, shouldRenderDefault: Z } = (0, v._)('result', {
								...b,
								customComponent: b.customComponent && b.customComponent !== 'Result' ? b.customComponent : void 0,
							});
						if (!Z) return F;
						const D = w?.display?.mappings.core || w?.mappings?.core,
							[he, ee] = (0, n.J0)(!1),
							K = {
								variantSelection: {
								...
								price: { internalClassName: 'ss__result__price', ...(0, d.s)({ disableStyles: V }), theme: b.theme, treePath: O },
								calloutBadge: {
								...
								button: {
									...
									onClick: (J) => {
										ee(!0), pe && pe(J, w), X?.addToCart([w]), setTimeout(() => ee(!1), fe);
									},
									...(0, d.s)({ disableStyles: V }),
									theme: b.theme,
									treePath: O,
						...
						let z = D?.name;
						b.truncateTitle && (z = M.x(D?.name || '', b.truncateTitle.limit, b.truncateTitle.append));
						const se = (0, B.Z)(b, x),
							Y = { addToCartButtonText: { value: he ? G : ce } },
							r = f()(Y, b.lang || {}),
							P = (0, y.u)(r, { result: w, controller: X }),
							$ = !!(D?.msrp && D?.price && D?.price < D?.msrp),
							ge = X?.store?.config?.asyncState?.product?.price ? w.state.priceFetched : !0;
						return D
							? (0, t.Y)(c._, {
									children: (0, t.FD)('article', {
										...se,
										className: i()('ss__result', `ss__result--${ue}`, { 'ss__result--sale': $ }, ie, me),
										ref: H,
										children: [
											!re &&
												(0, t.Y)('div', {
													...
													children: (0, t.Y)('a', {
														...
														children: q
															? (0, t.Y)(u._, { ...K.image })
															: (0, t.Y)(L.Q, { ...K.overlayBadge, controller: X, children: (0, t.Y)(u._, { ...K.image }) }),
													}),
												}),
											(0, t.FD)('div', {
												className: 'ss__result__details',
												children: [
													!q && (0, t.Y)(T.W, { ...K.calloutBadge, controller: X }),
													!I &&
														(0, t.Y)('div', {
													...
													!de && (0, t.Y)(S.G, { ...K.rating }),
													!W && ge && D.price && D.price > 0
														? (0, t.Y)('div', {
																className: 'ss__result__details__pricing',
																children: $
																	? (0, t.FD)(t.FK, {
																			children: [
																				(0, t.Y)(p.g, { ...K.price, value: D.msrp, lineThrough: !0, name: 'msrp' }),
																				'\xA0',
																				(0, t.Y)(p.g, { ...K.price, value: D.price, name: 'price' }),
																			],
																	  })
																	: (0, t.Y)(p.g, { ...K.price, value: D.price }),
														  })
														: null,
													(0, g.Y)(ae, { result: w, treePath: O }),
													!_e && w.variants?.selections.length
														? (0, t.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: w.variants?.selections.map((J) => (0, t.Y)(h.m, { ...K.variantSelection, type: J.type, selection: J })),
														  })
														: null,
													!Ee &&
														(0, t.Y)('div', {
															className: 'ss__result__add-to-cart-wrapper',
															children: (0, t.Y)(N.$, { ...K.button, ...P.addToCartButtonText.all }),
														}),
												],
											}),
										],
			...
			'./components/src/components/Templates/Recommendation/Recommendation.tsx'(A, a, e) {
				...
				const v = ({ vertical: x }) => (0, o.AH)({ height: x ? '100%' : void 0, '.ss__result__image-wrapper': { height: x ? '85%' : void 0 } }),
					h = (0, i.PA)((x) => {
						...
						let U = (0, d.v6)('recommendation', oe, k, ne),
							b;
						!(x.theme?.type == 'templates' || oe?.type == 'templates') &&
							U.breakpoints &&
							((b = (0, N.X)(U.breakpoints)), b && Object.keys(b).length && (U = { ...U, ...b }));
						const {
								title: w,
								description: q,
								controller: I,
							...
							{ ComponentOverride: ee, shouldWaitForNamedOverride: K } = (0, M.x)(he, Z ? D : void 0),
							z = Z ? ee : O,
							se = { enabled: !0, offset: '10%', ...ce };
						if (!I || I.type !== 'recommendation')
							throw new Error("<Recommendation> Component requires 'controller' prop with an instance of RecommendationController");
						const Y = ae || I.store?.results;
						if (Array.isArray(W) && W.length !== Y.length)
							return (
								I.log.error(
						...
						const r = {
								...
								result: { internalClassName: 'ss__recommendation__result', ...(0, g.s)({ disableStyles: ue }), theme: U?.theme, treePath: de },
							},
							P = (0, E.Z)(U, v),
							[$, ge] = (0, n.J0)(!1),
							J = (0, n.li)(null);
						(!se?.enabled || (0, B.v)(J, `${se.offset} 0px ${se.offset} 0px`, !0)) && ge(!0);
						const Pe = { titleText: { value: `${w}` } },
							ye = p()(Pe, U.lang || {}),
							be = (0, f.u)(ye, {});
						return (Array.isArray(W) && W.length) || Y?.length
							? (0, t.Y)(j._, {
									children: (0, t.Y)('div', {
										...P,
										...
										children: $
											? (0, t.FD)(m.l, {
													controller: I,
													children: [
														w && !fe && (0, t.Y)('h3', { className: 'ss__recommendation__title', ...be.titleText?.all, children: w }),
														...
														(0, t.Y)(c.FN, {
															...
															children:
																Array.isArray(W) && W.length
																	? W.map((Q, ve) => (0, t.Y)(y.o, { controller: I, result: Y[ve], children: Q }))
																	: Y.map((Q) =>
																			(0, t.Y)(y.o, {
																				controller: I,
																				result: Q,
																				children:
																					z && I
																						? (0, R.Y)(z, {
																								controller: I,
																								result: Q,
																								treePath: r.result.treePath,
																								theme: Z ? p()(U.theme || {}, { components: { result: { customComponent: O } } }) : U.theme,
																						  })
																						: K
																						? null
																						: (0, t.Y)(_.Q, { ...r.result, controller: I, result: Q }, Q.id),
																			})
																	  ),
														}),
													],
											...
											: (0, t.Y)(m.l, {
													...
													children:
														Array.isArray(W) && W.length
															? W.map((Q, ve) => (0, t.Y)(y.o, { controller: I, result: Y[ve], children: (0, t.Y)(t.FK, {}) }))
															: Y.map((Q) => (0, t.Y)(y.o, { controller: I, result: Q, children: (0, t.Y)(t.FK, {}) })),
											  }),
									}),
							  })
							: (0, t.Y)(t.FK, {});
				...
				const c = { ResultTracker: () => (0, n.AH)({}) },
					_ = (0, o.PA)((R) => {
						const g = (0, i.u)(),
							...
							{ children: B, result: M, track: j, controller: T, className: L, internalClassName: S, disableStyles: N, style: m } = d,
							f = { ...E, ...j },
							{ ref: y, inViewport: v } = (0, p.Q)();
						v && f.impression && T?.track.product.impression(M);
						const h = {};
						return (
							N ? m && (h.css = [m]) : (h.css = [c.ResultTracker(), m]),
							(0, t.Y)('div', {
								className: s()('ss__result-tracker', `ss__${T?.type}-result-tracker`, L, S),
								onClick: (x) => {
									f.click && T?.track.product.click(x, M);
								},
								ref: y,
								...h,
								children: B,
						...
						return (
							(0, t.vJ)(() => {
								...
								return (
									...
									() => {
										g(!1), S(), d.current && window.clearTimeout(d.current), T && s.current && T.unobserve(s.current);
									}
								);
							}, [s, B]),
							{ inViewport: R, updateRef: j }
						);
					};
				function l(s) {
			...
			'./components/src/utilities/snapify.ts'(A, a, e) {
				...
				class T {
					static recommendation(f) {
						const y = f.id;
						if (M[y]) return M[y];
						const v = (M[y] = S({ client: j, controller: f }));
						return (
					...
					static autocomplete(f) {
						const y = f.id;
						if (M[y]) return M[y];
						const v = (M[y] = N({ client: j, controller: f }));
						return (
							v.on('afterStore', async ({ controller: h }, x) => {
								h.log.debug('controller', h), h.log.debug('store', h.store.toJSON()), await x();
							}),
					...
					static search(f) {
						const y = f.id;
						if (M[y]) return M[y];
						const v = (M[y] = L({ client: j, controller: f }));
						return (
							v.on('afterStore', async ({ controller: h }, x) => {
								h.log.debug('controller', h), h.log.debug('store', h.store.toJSON()), await x();
							}),
				...
				function t(n, o) {
					...
					(n.prototype.toName = function (p) {
						...
						if (p?.closest) {
							...
							for (var M in l) {
								var j = ((c = g), (_ = u[M]), Math.pow(c.r - _.r, 2) + Math.pow(c.g - _.g, 2) + Math.pow(c.b - _.b, 2));
								j < d && ((d = j), (E = M));
							}
							return E;
						}
...
//# sourceMappingURL=components-Templates-Recommendation-Recommendation-stories.ed4930cf.iframe.bundle.js.map
