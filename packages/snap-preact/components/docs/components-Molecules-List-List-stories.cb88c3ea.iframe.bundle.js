(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[3893],
		{
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/handleize.js'(M, a, e) {
				'use strict';
				e.d(a, { p: () => s });
				function s(l) {
			...
			'./components/src/components/Molecules/List/List.stories.tsx'(M, a, e) {
				'use strict';
				e.r(a),
					e.d(a, {
						Default: () => f,
				...
				const D = [
					...
					y = (u) => (0, s.Y)('div', { style: { maxWidth: u?.horizontal ? '1200px' : '500px' }, children: (0, s.Y)(o.B, { ...u }) });
  ...
  return <div style={{
    maxWidth: args?.horizontal ? '1200px' : '500px'
			...
			'./components/src/components/Molecules/Checkbox/Checkbox.tsx'(M, a, e) {
				'use strict';
				var s = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					T = e.n(u);
				const k = ({ size: C, color: m, theme: i, native: p }) => {
					...
					N = (0, t.PA)((C) => {
						const m = (0, n.u)(),
							p = { size: '12px', startChecked: !1, disableA11y: !1, treePath: (0, D.LU)() },
						...
						const w = isNaN(Number(z)) ? z : `${z}px`,
							ae = {
								icon: {
									...
									icon: 'check-thin',
									...(0, r.s)({ color: F || L || Z?.variables?.colors?.primary, disableStyles: ee, icon: j, size: w && `calc(${w} - 30%)` }),
									theme: _.theme,
									treePath: te,
								},
							};
						...
						return (0, s.Y)(f._, {
							children: q
								...
								: (0, s.Y)('span', {
										...
										...R.checkbox.all,
										children: A
											? (0, s.Y)(y.I, { ...ae.icon, ...(typeof j == 'string' ? { icon: j } : j) })
			...
			'./components/src/components/Molecules/List/List.tsx'(M, a, e) {
				'use strict';
				var s = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					l = e('../../node_modules/preact/hooks/dist/hooks.module.js'),
					o = e('../../node_modules/@emotion/react/dist/emotion-react.browser.esm.js'),
				...
				const C = ({ horizontal: i }) =>
					...
					m = (0, v.PA)((i) => {
						const p = (0, n.u)(),
							...
							{ overrideElement: le, shouldRenderDefault: re } = (0, k._)('list', L);
						if (!re) return le;
						let I = L.selected;
						const X = {
								checkbox: { native: F, ...(0, y.s)({ disableStyles: Z }), theme: L?.theme, treePath: oe },
								icon: { internalClassName: 'ss__list__option__icon', size: '16px', ...(0, y.s)({ disableStyles: Z }), theme: L?.theme, treePath: oe },
							},
							ne = (0, O.Z)(L, C);
						...
						B &&
							t.addEventListener('keydown', function (n) {
								...
								(n.key === 'Tab' || n.keyCode === s) &&
									(n.shiftKey
										? document.activeElement === y && (E.focus(), n.preventDefault())
										: document.activeElement === E && (y.focus(), n.preventDefault()));
							}));
				}
				e.d(a, ['DH', 0, b, 'aZ', 0, o]);
			},
			...
			'./components/src/utilities/snapify.ts'(M, a, e) {
				...
				class T {
					static recommendation(i) {
						const p = i.id;
						if (P[p]) return P[p];
						const _ = (P[p] = N({ client: u, controller: i }));
						return (
							_.on('afterStore', async ({ controller: g }, L) => {
					...
					static autocomplete(i) {
						const p = i.id;
						if (P[p]) return P[p];
						const _ = (P[p] = C({ client: u, controller: i }));
						return (
							_.on('afterStore', async ({ controller: g }, L) => {
								g.log.debug('controller', g), g.log.debug('store', g.store.toJSON()), await L();
							}),
					...
					static search(i) {
						const p = i.id;
						if (P[p]) return P[p];
						const _ = (P[p] = k({ client: u, controller: i }));
						return (
							_.on('afterStore', async ({ controller: g }, L) => {
								g.log.debug('controller', g), g.log.debug('store', g.store.toJSON()), await L();
							}),
				...
				function k(m) {
					const i = new v.V(new n.E({ settings: { coreType: 'query', corePrefix: m.controller.id } }), f.X);
					return new l.Tp(m.controller, {
						client: new c.K(m.client.globals, m.client.config),
						store: new r.U(m.controller, { urlManager: i }),
						urlManager: i,
				...
				function N(m) {
					const i = new v.V(new n.E(), f.X).detach(!0);
					return new b.c(m.controller, {
						client: new c.K(m.client.globals, m.client.config),
						store: new B.t(m.controller, { urlManager: i }),
						urlManager: i,
						eventManager: new D.E(),
						profiler: new y.U(),
						logger: new E.V(),
				...
				function C(m) {
					const i = new v.V(new n.E(), f.X).detach();
					return new o.Z(m.controller, {
						client: new c.K(m.client.globals, m.client.config),
						store: new t.Y(m.controller, { urlManager: i }),
						urlManager: i,
						eventManager: new D.E(),
						profiler: new y.U(),
						logger: new E.V(),
...
//# sourceMappingURL=components-Molecules-List-List-stories.cb88c3ea.iframe.bundle.js.map
