(() => {
  ...
  return inlineBanners && <InlineBanner {...args} banner={inlineBanners} />;
				...
				function t(l, O, P, h) {
					...
					l &&
						...
						l.addEventListener('keydown', (n) => {
							(n.code === 'Space' || n.code === 'Enter') && n.target === l && l.click();
						}),
						P &&
			...
			'./components/src/utilities/createImpressionObserver.ts'(D, a, e) {
				...
				function t(l) {
					const O = (0, s.li)(null),
						{ inViewport: P, updateRef: h } = (0, E.v)(O, { fireOnce: !0, threshold: o, minVisibleTime: f, ...l });
...
//# sourceMappingURL=components-Atoms-InlineBanner-InlineBanner-stories.e2cf80e0.iframe.bundle.js.map
