	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9712],
		{
			...
			'./components/src/components/Molecules/OverlayResult/OverlayResult.tsx'(v, d, t) {
				...
				const H = (R) => {
						const { overlayBackground: M, disableSlide: E } = R;
						return (0, s.AH)({
							position: 'relative',
							overflow: 'hidden',
					...
					Z = (0, l.PA)((R) => {
						...
						const c = m?.display?.mappings.core || m?.mappings?.core,
							...
							u = {
								...
								button: {
									...
									onClick: (b) => {
										I(!0), k && k(b, m), P?.addToCart([m]), setTimeout(() => I(!1), oe);
									},
									...(0, f.s)({ disableStyles: y }),
									theme: _.theme,
									treePath: h,
						...
						const _e = (0, T.Z)(_, H),
							me = { addToCartButtonText: { value: ce ? re : w } },
							fe = Y()(me, _.lang || {}),
							ue = (0, z.u)(fe, { result: m, controller: P }, { activeBreakpoint: M?.activeBreakpoint }),
							S = !!(c?.msrp && c?.price && c?.price < c?.msrp),
							ge = P?.store?.config?.asyncState?.product?.price ? m.state.priceFetched : !0;
						return c
							? (0, a.Y)(g._, {
												...
												children: [
													...
													(0, a.Y)('div', {
														...
														children: (0, a.FD)('div', {
															...
															children: [
																!L && (0, a.Y)(D.W, { ...u.calloutBadge, controller: P }),
																!le && (0, a.Y)(j.G, { ...u.rating }),
																!J && ge && c.price && c.price > 0
																	? (0, a.Y)('div', {
																...
																!ae &&
																	(0, a.Y)('div', {
																		...
																		children: (0, a.Y)(W.$, { ...u.button, content: w, ...ue.addToCartButtonText.all }),
																	}),
															],
														}),
													}),
				...
				function a(n, l) {
					...
					(n.prototype.toName = function (i) {
						...
						if (i?.closest) {
							...
							for (var x in s) {
								var D = ((g = A), (p = r[x]), Math.pow(g.r - p.r, 2) + Math.pow(g.g - p.g, 2) + Math.pow(g.b - p.b, 2));
								D < f && ((f = D), (O = x));
							}
							return O;
						}
