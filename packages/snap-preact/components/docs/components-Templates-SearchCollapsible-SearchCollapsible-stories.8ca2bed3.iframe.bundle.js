(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[5497],
		{
			'./components/src/components/Templates/SearchCollapsible/SearchCollapsible.stories.tsx'(p, n, e) {
				'use strict';
				e.r(n);
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					f = e('./components/src/components/Templates/SearchCollapsible/SearchCollapsible.tsx');
				const O = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, t.FD)('div', {
										children: [(0, t.Y)(c.oz, { options: { overrides: { code: g.Z } }, children: m }), (0, t.Y)(c.uY, { story: c.h1 })],
									}),
							},
						},
					...
					S = s.p.search({ id: 'Search', globals: { siteId: 'atkzs2' } }),
					T = s.p.search({ id: 'Search-noResults', globals: { siteId: 'atkzs2', search: { query: { string: 'eijworhufsbgd' } } } }),
					d = (_, { loaded: { controller: y } }) => (0, t.Y)(f.x, { ..._, controller: y });
				d.loaders = [async () => (await S.search(), { controller: S })];
				const u = (_, { loaded: { controller: y } }) => (0, t.Y)(f.x, { ..._, controller: y });
  ...
  return <SearchCollapsible {...args} controller={controller} />;
				...
				e.d(n, ['Default', 0, d, 'NoResults', 0, u, '__namedExportsOrder', 0, E, 'default', 0, O]);
			},
			'./components/src/components/Templates/SearchCollapsible/SearchCollapsible.tsx'(p, n, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					c = e('../../node_modules/mobx-react-lite/es/index.js'),
					h = e('./components/src/providers/cache.tsx'),
					g = e('./components/src/components/Templates/Search/Search.tsx');
				const s = (0, c.PA)((m) => (0, t.Y)(h._, { children: (0, t.Y)(g.v, { ...m, alias: 'searchCollapsible' }) }));
				e.d(n, ['x', 0, s]);
			},
			...
			'./components/src/utilities/snapify.ts'(p, n, e) {
				...
				class P {
					static recommendation(r) {
						const a = r.id;
						if (b[a]) return b[a];
						const i = (b[a] = D({ client: x, controller: r }));
						return (
							i.on('afterStore', async ({ controller: l }, C) => {
								l.log.debug('controller', l), l.log.debug('store', l.store.toJSON()), await C();
							}),
							i.init(),
							i
						);
					...
					static autocomplete(r) {
						const a = r.id;
						if (b[a]) return b[a];
						const i = (b[a] = v({ client: x, controller: r }));
						return (
							i.on('afterStore', async ({ controller: l }, C) => {
								l.log.debug('controller', l), l.log.debug('store', l.store.toJSON()), await C();
							}),
					...
					static search(r) {
						const a = r.id;
						if (b[a]) return b[a];
						const i = (b[a] = M({ client: x, controller: r }));
						return (
							i.on('afterStore', async ({ controller: l }, C) => {
								l.log.debug('controller', l), l.log.debug('store', l.store.toJSON()), await C();
							}),
				...
				function M(o) {
					const r = new S.V(new d.E({ settings: { coreType: 'query', corePrefix: o.controller.id } }), T.X);
				...
				function D(o) {
					const r = new S.V(new d.E(), T.X).detach(!0);
					return new g.c(o.controller, {
						client: new s.K(o.client.globals, o.client.config),
						store: new O.t(o.controller, { urlManager: r }),
						urlManager: r,
						eventManager: new u.E(),
						profiler: new E.U(),
						logger: new _.V(),
				...
				function v(o) {
					const r = new S.V(new d.E(), T.X).detach();
...
//# sourceMappingURL=components-Templates-SearchCollapsible-SearchCollapsible-stories.8ca2bed3.iframe.bundle.js.map
