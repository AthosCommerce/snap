	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[1840],
		{
			'./components/src/components/Atoms/Button/Button.stories.tsx'(b, r, e) {
				'use strict';
				e.r(r), e.d(r, { Default: () => u, Disabled: () => d, Native: () => o, __namedExportsOrder: () => y, default: () => f });
...
`;
			...
			'./components/src/components/Atoms/Button/Button.tsx'(b, r, e) {
				...
				var s = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					N = e.n(W);
				const Y = ({ native: O, color: v, backgroundColor: T, borderColor: M, theme: E }) =>
						O
							? (0, i.AH)({})
							: (0, i.AH)({
									display: 'inline-flex',
									...
									border: `1px solid ${M || v || E?.variables?.colors?.primary || '#333'}`,
					...
					F = (0, l.PA)((O) => {
						const v = (0, a.u)(),
							T = (0, f.uk)(),
							E = { disableA11y: !1, treePath: (0, u.LU)() },
							x = (0, m.v6)('button', v, E, O),
							{
								content: P,
								children: D,
								disabled: B,
						...
						if (j) {
							const _ = (0, S.x)(T?.templates?.library.import.component.button || {}, j);
							if (_) return (0, s.Y)(_, { ...x });
						}
						const U = { icon: { internalClassName: 'ss__button__icon', ...(0, y.s)({ disableStyles: V }), theme: x?.theme, treePath: g } },
							R = {
								...(0, h.Z)(x, Y),
								className: c()('ss__button', { 'ss__button--native': L, 'ss__button--disabled': B }, H, J),
								disabled: B,
								onClick: (_) => !B && I && I(_),
								...Z,
							},
										...
										? (0, s.FD)('button', {
												...
												children: [
													(0, s.FD)('span', {
														...
														...C.button?.all,
														children: [(0, o.Y)(P, { treePath: g }), (0, o.Y)(D, { treePath: g })],
													}),
						...
						f &&
							t.addEventListener('keydown', function (o) {
								...
								(o.key === 'Tab' || o.keyCode === s) &&
									(o.shiftKey
										? document.activeElement === m && (h.focus(), o.preventDefault())
										: document.activeElement === h && (m.focus(), o.preventDefault()));
							}));
				}
			},
							...
							t &&
								(t?.value &&
									(typeof t.value == 'function'
										? (a.value = { 'ss-lang': l, dangerouslySetInnerHTML: { __html: t.value(n) } })
										: (a.value = { 'ss-lang': l, dangerouslySetInnerHTML: { __html: t.value } })),
								t?.attributes &&
