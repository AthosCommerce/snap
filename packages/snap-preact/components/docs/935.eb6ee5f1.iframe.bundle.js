	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[935],
		{
			'./src/create/createRecommendationController.ts'(D, n, o) {
				o.r(n);
				var t = o('../../node_modules/@athoscommerce/snap-controller/dist/esm/Recommendation/RecommendationController.js'),
				...
				const r = (e, a) => {
					const s = (a?.urlManager || new _.V(new d.E(e.url), c.X)).detach(!0);
					return (
						...
						new t.c(
							e.controller,
							{
								...
								store: a?.store || new l.t(e.controller, { urlManager: s }),
								urlManager: s,
