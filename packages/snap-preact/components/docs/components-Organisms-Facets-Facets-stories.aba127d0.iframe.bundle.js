(() => {
  ...
  return <Facets {...args} controller={controller} />;
			...
			'../../node_modules/colord/plugins/names.mjs'(F, _, e) {
				'use strict';
				e.d(_, { A: () => o }), Object.defineProperty(o, 'name', { value: 'default', configurable: !0 });
				function o(c, b) {
					var O = {
							white: '#ffffff',
							bisque: '#ffe4c4',
...
//# sourceMappingURL=components-Organisms-Facets-Facets-stories.aba127d0.iframe.bundle.js.map
