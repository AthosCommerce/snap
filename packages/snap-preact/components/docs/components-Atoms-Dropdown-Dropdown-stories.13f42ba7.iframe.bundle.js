	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[4578],
		{
			'./components/src/components/Atoms/Dropdown/Dropdown.stories.tsx'(w, a, e) {
				...
				const y = (i) => (0, o.Y)(s.m, { ...i });
				y.args = { button: 'button text', content: 'content text', open: !0 };
				...
				const D = ['Default', 'Hoverable', 'ExternalState', 'JSXContent', 'JSXChildren', 'StringChildren'];
			},
			'./components/src/components/Atoms/Dropdown/Dropdown.tsx'(w, a, e) {
				...
				const G = ({ disableOverlay: E }) =>
					...
					Q = (0, f.PA)((E) => {
						const q = (0, h.u)(),
							ee = { startOpen: !1, disableA11y: !1, treePath: (0, y.LU)() },
							L = (0, D.v6)('dropdown', q, ee, E),
							{
								button: oe,
								content: M,
								children: A,
						...
						re ||
							(F = (0, t.L)((n) => {
								(P && R.current && R.current.contains(n.target)) || (m && (T || (k && _ && _(!1), x && x(n, !1))));
							})),
							(0, s.vJ)(() => {
								if (P && m) {
									const n = () => {
						...
						b &&
							r.addEventListener('keydown', function (t) {
								...
								(t.key === 'Tab' || t.keyCode === o) &&
									(t.shiftKey
										? document.activeElement === d && (D.focus(), t.preventDefault())
										: document.activeElement === D && (d.focus(), t.preventDefault()));
							}));
				}
				e.d(a, ['DH', 0, p, 'aZ', 0, s]);
