	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[8422],
		{
			...
			'./components/src/components/Atoms/FormattedNumber/FormattedNumber.stories.tsx'(p, s, e) {
				'use strict';
				e.r(s), e.d(s, { Default: () => c, Length: () => u, Temperature: () => d, __namedExportsOrder: () => b, default: () => m });
				...
				d.args = { value: 100, symbol: ' \xB0C', decimalPlaces: 2 };
				const u = (i) => (0, o.Y)(r.G, { ...i });
				(u.args = { value: 100, symbol: ' mm', decimalPlaces: 2 }),
					(c.parameters = {
						...c.parameters,
						docs: {
							...c.parameters?.docs,
				...
				const h = () => (0, r.AH)({}),
					_ = (0, n.PA)((g) => {
						const P = (0, c.u)(),
							...
							y = (0, u.v6)('formattedNumber', P, v, g),
							{
								value: E,
								symbol: x,
								decimalPlaces: D,
							...
							{ overrideElement: L, shouldRenderDefault: j } = (0, i._)('formattedNumber', y);
						if (!j) return L;
						const f = l.Z(E, { symbol: x, decimalPlaces: D, padDecimalPlaces: N, thousandsSeparator: F, decimalSeparator: T, symbolAfter: O }),
							S = (0, b.Z)(y, h);
						return M
							? (0, o.Y)(o.FK, { children: f })
							: (0, o.Y)(m._, { children: (0, o.Y)('span', { className: a()('ss__formatted-number', A, C), ...S, children: f }) });
					});
			},
