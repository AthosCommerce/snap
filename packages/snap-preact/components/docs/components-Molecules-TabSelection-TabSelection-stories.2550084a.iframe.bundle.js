(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[2563],
		{
			'./components/src/components/Molecules/TabSelection/TabSelection.stories.tsx'(D, l, t) {
				'use strict';
				t.r(l), t.d(l, { Default: () => g, __namedExportsOrder: () => y, default: () => n });
				var s = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					i = t('./components/src/utilities/snapify.ts'),
				...
				const e =
					...
					a = v.map((E) => i.p.search({ id: E.id, globals: { siteId: E.siteId } })),
					g = (E, { loaded: { tabManager: O } }) => (0, s.Y)(_.E, { ...E, tabManager: O });
				(g.loaders = [async () => (await Promise.all(a.map((E) => E.search())), { tabManager: new h.E(v, a) })]),
					(g.parameters = {
						...g.parameters,
						docs: {
							...g.parameters?.docs,
  ...
  return <TabSelection {...args} tabManager={tabManager} />;
			...
			'./components/src/components/Atoms/Button/Button.tsx'(D, l, t) {
				'use strict';
				var s = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					U = t.n(x);
				const K = ({ native: I, color: r, backgroundColor: o, borderColor: c, theme: m }) =>
						I
							? (0, u.AH)({})
							: (0, u.AH)({
									display: 'inline-flex',
					...
					L = (0, d.PA)((I) => {
						...
						if (!j) return C;
						const Y = { icon: { internalClassName: 'ss__button__icon', ...(0, a.s)({ disableStyles: V }), theme: m?.theme, treePath: S } },
							B = {
								...(0, y.Z)(m, K),
			...
			'./components/src/components/Molecules/TabSelection/TabSelection.tsx'(D, l, t) {
				'use strict';
				var s = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					u = t('../../node_modules/@emotion/react/dist/emotion-react.browser.esm.js'),
					_ = t('../../node_modules/classnames/index.js'),
					p = t.n(_),
					d = t('../../node_modules/mobx-react-lite/es/index.js'),
					i = t('../../node_modules/deepmerge/dist/cjs.js'),
					h = t.n(i),
				...
				const x = () =>
					...
					U = (0, d.PA)((K) => {
						const L = (0, n.u)(),
							...
							{ overrideElement: k, shouldRenderDefault: z } = (0, O._)('tabSelection', o);
						if (!z) return k;
						if (!c || !c.tabs?.length) return null;
						const P = { button: { ...(0, a.s)({ disableStyles: W }), theme: o.theme, treePath: V } };
						function w(f) {
							const C = f.store;
						...
						const S = (0, y.Z)(o, x),
							...
							q = h()(Q, { title: o.lang?.title || {}, tabList: o.lang?.tabList || {} }),
						...
						return (0, s.Y)(e._, {
							children: (0, s.FD)('div', {
								...
								children: [
									m || o.lang?.title?.value ? (0, s.Y)('h4', { className: 'ss__tab-selection__title', ...J.title?.all }) : null,
									(0, s.Y)('div', {
										...
										children: c.tabs.map((f) => {
											const C = c.active?.id === f.id,
												...
												X = h()(Z, { tabButton: o.lang?.tabButton || {} }),
			...
			'./components/src/hooks/useA11y.tsx'(D, l, t) {
				'use strict';
				t.d(l, { iy: () => d });
				const s = 9,
					u = 27,
				...
				function d(i, h, e, n) {
					...
					if (!document.querySelector(`#${v}`)) {
						...
						(a.type = 'text/css'),
							(a.id = v),
							(a.innerHTML = `[${_}]:focus-visible { outline: -webkit-focus-ring-color auto 1px !important; }`),
					...
					i &&
						...
						e &&
							i.addEventListener('keydown', function (a) {
								const g = i.querySelectorAll(p),
									y = g[0],
									E = g[g.length - 1];
								if (a.keyCode == u) {
									i.focus(), n && n(a), a.preventDefault(), a.stopPropagation();
									return;
								}
			...
			'./components/src/hooks/useLang.tsx'(D, l, t) {
				'use strict';
				const s = (u, _, p) => {
					const d = p ? { ..._, ...p } : _,
						i = {};
			...
			'./components/src/utilities/componentArgs.ts'(D, l, t) {
				'use strict';
				const s = {
					className: {
			...
			'./components/src/utilities/defined.ts'(D, l, t) {
				'use strict';
				t.d(l, { s: () => s });
				function s(u) {
					const _ = {};
			...
			'./components/src/utilities/snapify.ts'(D, l, t) {
				'use strict';
				t.d(l, { p: () => U });
				var s = t('../../node_modules/mobx/dist/mobx.esm.js'),
					...
					i = t('../../node_modules/@athoscommerce/snap-store-mobx/dist/esm/Autocomplete/AutocompleteStore.js'),
					...
					a = t('../../node_modules/@athoscommerce/snap-url-manager/dist/esm/Translators/Url/UrlTranslator.js'),
				...
				class U {
					static recommendation(o) {
						const c = o.id;
						if (M[c]) return M[c];
						const m = (M[c] = L({ client: x, controller: o }));
						return (
					...
					static autocomplete(o) {
						const c = o.id;
						if (M[c]) return M[c];
						const m = (M[c] = I({ client: x, controller: o }));
						return (
							m.on('afterStore', async ({ controller: b }, T) => {
								b.log.debug('controller', b), b.log.debug('store', b.store.toJSON()), await T();
							}),
					...
					static search(o) {
						const c = o.id;
						if (M[c]) return M[c];
						const m = (M[c] = K({ client: x, controller: o }));
						return (
							m.on('afterStore', async ({ controller: b }, T) => {
								b.log.debug('controller', b), b.log.debug('store', b.store.toJSON()), await T();
							}),
				...
				function K(r) {
					const o = new n.V(new a.E({ settings: { coreType: 'query', corePrefix: r.controller.id } }), v.X);
					return new u.Tp(r.controller, {
						client: new d.K(r.client.globals, r.client.config),
						store: new h.U(r.controller, { urlManager: o }),
						urlManager: o,
				...
				function L(r) {
					const o = new n.V(new a.E(), v.X).detach(!0);
					return new p.c(r.controller, {
						client: new d.K(r.client.globals, r.client.config),
						store: new e.t(r.controller, { urlManager: o }),
						urlManager: o,
						eventManager: new g.E(),
						profiler: new y.U(),
						logger: new E.V(),
				...
				function I(r) {
					const o = new n.V(new a.E(), v.X).detach();
					return new _.Z(r.controller, {
						client: new d.K(r.client.globals, r.client.config),
						store: new i.Y(r.controller, { urlManager: o }),
						urlManager: o,
						eventManager: new g.E(),
						profiler: new y.U(),
						logger: new E.V(),
			...
			'./components/src/utilities/storybook.tsx'(D, l, t) {
				'use strict';
				var s = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const _ = 'prism-block',
					p = (d) => {
						...
						return (
							(0, u.vJ)(() => {
								i.current && d.className?.includes('lang-') && !d.className?.includes(_) && window?.Prism?.highlightElement(i.current);
							}, [d.className, d.children, i]),
							(0, s.Y)('code', { ...d, ref: i, 'data-prismjs-copy': 'Copy' })
						);
					};
				t.d(l, ['Z', 0, p]);
			},
...
//# sourceMappingURL=components-Molecules-TabSelection-TabSelection-stories.2550084a.iframe.bundle.js.map
