...
`,
			...
			'./components/src/components/Molecules/Grid/Grid.tsx'(y, l, e) {
				...
				(0, K.X$)([W.A]);
				const z = ({ gapSize: T, columns: x, theme: S, disableOverflowAction: j }) =>
						(0, n.AH)({
							'.ss__grid__options': {
								display: 'flex',
								flexFlow: 'row wrap',
								...
								'.ss__grid__option': {
									...
									backgroundSize: `calc(100% / ${x} - ${2 * Math.round((x + 2) / 2)}px)`,
									...
									wordBreak: 'break-all',
									padding: '1em 0',
									width: `calc(100% / ${x} - ${2 * Math.round((x + 2) / 2)}px)`,
									margin: `0 ${T} ${T} 0`,
					...
					Q = (0, u.PA)((T) => {
						const x = (0, a.u)(),
							...
							{ overrideElement: de, shouldRenderDefault: ce } = (0, I._)('grid', P);
						if (!ce) return de;
						...
						const pe = (r, g) => {
							...
							ae = () => {
								const r = te ? C : !0,
									...
									h = i()(g, P.lang || {}),
									w = (0, m.u)(h, { limited: C, remainder: k });
								return r && k > 0 && M.length !== H
									? (0, o.Y)('div', {
											...
											children: V
												? (0, B.Y)(V, { limited: C, remainder: k, treePath: ne })
												: C
						...
						return typeof M == 'object' && M?.length
							? (0, o.Y)(f._, {
									children: (0, o.FD)('div', {
										...fe,
										className: d()('ss__grid', G ? 'ss__grid--disabled' : '', re, ie),
										children: [
											...
											(0, o.FD)('div', {
												...
												children: [
													M.map((r, g) => {
														const h = $.some((L) => L.value == r.value);
														let w = !1;
														const R = r.background?.toLowerCase() || (r.backgroundImageUrl ? null : r.value.toString().toLowerCase());
														if (R)
															try {
																const L = (0, K.Mj)(R);
																L.isValid() && (w = L.isDark());
															} catch {}
