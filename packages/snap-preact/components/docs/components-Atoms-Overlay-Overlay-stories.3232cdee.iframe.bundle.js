	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[8982],
		{
			...
			'./components/src/components/Atoms/Overlay/Overlay.tsx'(d, s, e) {
				...
				const _ = ({ transitionSpeed: v, color: E }) =>
						(0, l.AH)({
							...
							top: '0',
							left: '-100%',
							'&.ss__overlay--active': { transition: `background ${v} ease, left 0s ease`, background: E, left: '0' },
						}),
					f = (0, a.PA)((v) => {
						const E = (0, p.u)(),
							x = { color: 'rgba(0,0,0,0.8)', transitionSpeed: '0.25s', treePath: (0, c.LU)() },
							O = (0, m.v6)('overlay', E, x, v),
						...
						c &&
							o.addEventListener('keydown', function (t) {
								...
								(t.key === 'Tab' || t.keyCode === n) &&
									(t.shiftKey
										? document.activeElement === _ && (f.focus(), t.preventDefault())
										: document.activeElement === f && (_.focus(), t.preventDefault()));
							}));
				}
			},
