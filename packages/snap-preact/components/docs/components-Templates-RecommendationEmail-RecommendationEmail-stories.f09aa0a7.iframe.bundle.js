				...
				const M = () =>
					...
					K = (0, a.PA)((G) => {
						...
						const h = C?.display?.mappings.core || C?.mappings?.core,
							...
							U = {
								...
								button: {
									...
									onClick: (W) => {
										ee(!0), q && q(W, C), k?.addToCart([C]), setTimeout(() => ee(!1), re);
									},
									...(0, d.s)({ disableStyles: O }),
									theme: g.theme,
									treePath: B,
						...
						const ue = (0, P.Z)(g, M),
							...
							ge = u()(fe, g.lang || {}),
							_e = (0, p.u)(ge, { result: C, controller: k }),
							se = !!(h?.msrp && h?.price && h?.price < h?.msrp),
							he = k?.store?.config?.asyncState?.product?.price ? C.state.priceFetched : !0;
						return h
							? (0, s.Y)(v._, {
											...
											!X &&
												(0, s.Y)('div', {
													...
													children: (0, s.Y)('a', {
														...
														children: V
															? (0, s.Y)(n._, { ...U.image })
															: (0, s.Y)(S.Q, { ...U.overlayBadge, controller: k, children: (0, s.Y)(n._, { ...U.image }) }),
													}),
												}),
											(0, s.FD)('div', {
												className: 'ss__result__details',
												children: [
													!V && (0, s.Y)(L.W, { ...U.calloutBadge, controller: k }),
													!F &&
														(0, s.Y)('div', {
				...
				const T = { default: {}, mobile: {}, tablet: {}, desktop: {} },
					...
					S = (0, a.PA)((R) => {
						const j = (0, d.u)(),
							...
							{ ComponentOverride: H, shouldWaitForNamedOverride: X } = (0, y.x)(F, C ? V : void 0),
							w = C ? H : D,
							$ = {
						...
						return N.length > 0
							? (0, s.Y)('div', {
									className: n()('ss__recommendation-email', J, Q),
									...O,
									children: N.map((Y, z) =>
										(0, s.Y)(
											'div',
											{
												...
												children: w
													? (0, v.Y)(w, {
															...
															result: Y,
															email: !0,
															theme: C ? t()(p.theme || {}, { components: { result: { customComponent: D }, image: { lazy: !1 } } }) : p.theme,
															treePath: K,
													  })
													: X
													? null
...
//# sourceMappingURL=components-Templates-RecommendationEmail-RecommendationEmail-stories.f09aa0a7.iframe.bundle.js.map
