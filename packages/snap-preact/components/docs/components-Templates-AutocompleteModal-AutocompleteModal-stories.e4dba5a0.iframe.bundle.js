			...
			'./components/src/components/Templates/AutocompleteModal/AutocompleteModal.stories.tsx'(I, l, e) {
				...
				const x = {
					...
					d = (v, { loaded: { controller: E } }) => {
						const [p, s] = (0, b.J0)(''),
							P = [
								{ active: p === 'dress', preview: () => s('dress'), value: 'dress', type: 'suggested', url: { href: '#' } },
								{ active: p === 'shirt', preview: () => s('shirt'), value: 'shirt', type: 'suggested', url: { href: '#' } },
								{ active: p === 'shoes', preview: () => s('shoes'), value: 'shoes', type: 'suggested', url: { href: '#' } },
								{ active: p === 'hat', preview: () => s('hat'), value: 'hat', type: 'suggested', url: { href: '#' } },
								{ active: p === 'pants', preview: () => s('pants'), value: 'pants', type: 'suggested', url: { href: '#' } },
								{ active: p === 'socks', preview: () => s('socks'), value: 'socks', type: 'suggested', url: { href: '#' } },
							];
						E.store.history = P;
						const [L, w] = (0, b.J0)(!1);
						return (
							(0, b.vJ)(() => {
								document.querySelector('#searchInput') && w(!0);
							}, []),
  ...
  return inputFound ? <AutocompleteModal {...args} controller={controller} input={controller?.config.selector} /> : <></>;
			...
			'./components/src/components/Molecules/Modal/Modal.tsx'(I, l, e) {
				...
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					P = e('./components/src/components/Atoms/Overlay/Overlay.tsx'),
				...
				const w = () =>
					...
					C = (0, f.PA)((R) => {
						const o = (0, b.u)(),
							...
							{ overrideElement: O, shouldRenderDefault: S } = (0, d._)('modal', i);
						if (!S) return O;
						const q = {
							overlay: {
						...
						(0, c.vJ)(
							() => (
								m && V ? (document.body.style.overflow = 'hidden') : (document.body.style.overflow = ''),
								() => {
						...
						return (
							...
							(0, t.Y)(B._, {
								children: (0, t.FD)('div', {
									...ae,
									className: u()('ss__modal', { 'ss__modal--open': m }, { 'ss__modal--disabled': F }, Z, X),
									ref: ee,
									children: [
										!D &&
											n &&
											(0, t.Y)('div', {
												...
												children: (0, g.Y)(n, { open: m, toggleOpen: Y, treePath: K }),
											}),
										(_ || W) &&
											m &&
											(0, t.FD)('div', {
												...
												ref: (h) => (y ? null : (0, s.iy)(h)),
												children: [(0, g.Y)(_, { open: m, toggleOpen: Y, treePath: K }), (0, g.Y)(W, { open: m, toggleOpen: Y, treePath: K })],
											}),
										(0, t.Y)(P.h, { ...q.overlay, active: !!m }),
									],
								}),
							})
						);
			...
			'./components/src/components/Templates/AutocompleteModal/AutocompleteModal.tsx'(I, l, e) {
				...
				const P = ({ width: w, height: C, theme: R }) => {
						const o = R?.variables;
						return (0, T.AH)({
							position: 'fixed',
							left: '0',
					...
					L = (0, M.PA)((w) => {
						const C = (0, x.u)(),
							...
							o = (0, f.v6)('autocompleteModal', C, R, w),
							[r, a] = (0, c.J0)(!1),
							i = '';
						let n = o.input,
							_ = o.buttonSelector;
						...
						let y = o.controller,
							Z = [y];
						U && U.active && ((y = U.active?.controller), (Z = U.tabs.map((S) => S.controller)));
						const X = (0, c.li)(null);
						(0, c.vJ)(() => {
							const S = (q, m) => {
								y.store.state.focusedInput || a(!1), m();
							};
							return (
								y.eventManager.on('focusChange', S),
								() => {
									y.eventManager.events.focusChange?.remove(S);
								}
							);
						}, [y]);
						const j = () => {
							...
							H = {
								autocompleteLayout: { layout: D, onReset: () => j(), tabManager: U, ...(0, u.s)({ disableStyles: W }), theme: o?.theme, treePath: N },
								modal: {
										...
										children: (0, t.Y)('div', {
											...
											children: (0, t.Y)(d.a, {
												...
												children: (0, t.FD)('div', {
													...
													ref: (S) => (0, p.iy)(S, 0, !0, j),
													children: [
														z ? (0, t.Y)(E.D, { ...H.searchInput, value: y.store.state.input || '', inputRef: X }) : (0, t.Y)(t.FK, {}),
														(0, t.Y)(A.h, { ...O, ...H.autocompleteLayout, input: K, controller: y, treePath: `${N} modal` }),
													],
												}),
											}),
										}),
			...
			'./components/src/utilities/snapify.ts'(I, l, e) {
				...
				class L {
					static recommendation(r) {
						const a = r.id;
						if (s[a]) return s[a];
						const i = (s[a] = C({ client: P, controller: r }));
						return (
					...
					static autocomplete(r) {
						const a = r.id;
						if (s[a]) return s[a];
						const i = (s[a] = R({ client: P, controller: r }));
						return (
							i.on('afterStore', async ({ controller: n }, _) => {
								n.log.debug('controller', n), n.log.debug('store', n.store.toJSON()), await _();
							}),
					...
					static search(r) {
						const a = r.id;
						if (s[a]) return s[a];
						const i = (s[a] = w({ client: P, controller: r }));
						return (
							i.on('afterStore', async ({ controller: n }, _) => {
								n.log.debug('controller', n), n.log.debug('store', n.store.toJSON()), await _();
							}),
				...
				function w(o) {
					const r = new x.V(new d.E({ settings: { coreType: 'query', corePrefix: o.controller.id } }), A.X);
					return new c.Tp(o.controller, {
						client: new u.K(o.client.globals, o.client.config),
				...
				function C(o) {
					const r = new x.V(new d.E(), A.X).detach(!0);
				...
				function R(o) {
					const r = new x.V(new d.E(), A.X).detach();
			...
			'./components/src/utilities/storybook.tsx'(I, l, e) {
				...
				const M = 'prism-block',
					T = (u) => {
						...
						return (
							(0, c.vJ)(() => {
								f.current && u.className?.includes('lang-') && !u.className?.includes(M) && window?.Prism?.highlightElement(f.current);
...
//# sourceMappingURL=components-Templates-AutocompleteModal-AutocompleteModal-stories.e4dba5a0.iframe.bundle.js.map
