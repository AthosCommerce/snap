						...
						return (
							(0, o.vJ)(() => {
								...
								return (
									...
									() => {
										a(!1), I(), d.current && window.clearTimeout(d.current), g && t.current && g.unobserve(t.current);
									}
								);
							}, [t, T]),
...
//# sourceMappingURL=components-Templates-RecommendationBundleVertical-RecommendationBundleVertical-stories.d75eb512.iframe.bundle.js.map
