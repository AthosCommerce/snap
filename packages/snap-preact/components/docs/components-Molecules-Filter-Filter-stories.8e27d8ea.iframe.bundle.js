	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[909],
		{
			'./components/src/components/Molecules/Filter/Filter.stories.tsx'(M, l, e) {
				'use strict';
				e.r(l), e.d(l, { Default: () => o, NoFacetLabel: () => b, __namedExportsOrder: () => g, default: () => y });
    ...
    controller: SearchController;
			...
			'./components/src/components/Atoms/Button/Button.tsx'(M, l, e) {
				...
				var s = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					B = e.n(L);
				const R = ({ native: C, color: r, backgroundColor: d, borderColor: c, theme: u }) =>
						C
							? (0, m.AH)({})
							: (0, m.AH)({
									display: 'inline-flex',
									...
									border: `1px solid ${c || r || u?.variables?.colors?.primary || '#333'}`,
					...
					j = (0, i.PA)((C) => {
						const r = (0, n.u)(),
							c = { disableA11y: !1, treePath: (0, O.LU)() },
							u = (0, b.v6)('button', r, c, C),
							{
								content: p,
								children: P,
								disabled: A,
						...
						const H = { icon: { internalClassName: 'ss__button__icon', ...(0, o.s)({ disableStyles: S }), theme: u?.theme, treePath: x } },
							$ = {
								...(0, g.Z)(u, R),
								className: f()('ss__button', { 'ss__button--native': F, 'ss__button--disabled': A }, N, k),
								disabled: A,
								onClick: (w) => !A && K && K(w),
								...T,
							},
				...
				const B = ({}) =>
					...
					R = (0, m.PA)((j) => {
						const C = (0, E.u)(),
							...
							{ overrideElement: x, shouldRenderDefault: X } = (0, v._)('filter', c);
						if (!X) return x;
						const Y = u?.url?.link || A?.link,
							U = u?.value.label || P,
							T = u?.facet.label || p,
							V = {
								button: { internalClassName: 'ss__filter__button', disableA11y: !0, ...(0, t.s)({ disableStyles: N }), theme: c.theme, treePath: W },
								icon: {
									icon: 'close-thin',
			...
			'./components/src/utilities/snapify.ts'(M, l, e) {
				...
				class B {
					static recommendation(d) {
						const c = d.id;
						if (_[c]) return _[c];
						const u = (_[c] = j({ client: L, controller: d }));
						return (
					...
					static autocomplete(d) {
						const c = d.id;
						if (_[c]) return _[c];
						const u = (_[c] = C({ client: L, controller: d }));
						return (
							u.on('afterStore', async ({ controller: p }, P) => {
								p.log.debug('controller', p), p.log.debug('store', p.store.toJSON()), await P();
							}),
					...
					static search(d) {
						const c = d.id;
						if (_[c]) return _[c];
						const u = (_[c] = R({ client: L, controller: d }));
						return (
							u.on('afterStore', async ({ controller: p }, P) => {
								p.log.debug('controller', p), p.log.debug('store', p.store.toJSON()), await P();
							}),
				...
				function R(r) {
					const d = new y.V(new o.E({ settings: { coreType: 'query', corePrefix: r.controller.id } }), E.X);
...
//# sourceMappingURL=components-Molecules-Filter-Filter-stories.8e27d8ea.iframe.bundle.js.map
