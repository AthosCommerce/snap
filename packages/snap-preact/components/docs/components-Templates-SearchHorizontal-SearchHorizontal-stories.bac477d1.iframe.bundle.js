	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[8595],
		{
			'./components/src/components/Templates/SearchHorizontal/SearchHorizontal.stories.tsx'(_, l, e) {
				e.r(l), e.d(l, { Default: () => t, NoResults: () => r, __namedExportsOrder: () => g, default: () => h });
...
//# sourceMappingURL=components-Templates-SearchHorizontal-SearchHorizontal-stories.bac477d1.iframe.bundle.js.map
