					...
					s = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, t.FD)('div', {
										children: [(0, t.Y)(c.oz, { options: { overrides: { code: k.Z } }, children: F }), (0, t.Y)(c.uY, { story: c.h1 })],
									}),
							},
						},
				...
				const z = ({ horizontal: d }) =>
					...
					E = (0, s.PA)((d) => {
						...
						const K = (y, M) => {
							...
							N = {},
							V = R()(N, S.lang || {}),
							re = (0, I.u)(V, { options: J, selectedOptions: P });
										...
										children: [
											...
											(0, t.Y)('ul', {
												...
												children: J.map((y) => {
													...
													return (0, t.FD)('li', {
														className: T()(`ss__list__option ss__list__option--${F.p(y.value?.toString())}`, {
			...
			'./components/src/utilities/snapify.ts'(U, b, e) {
				...
				class I {
					static recommendation(d) {
						const w = d.id;
						if (i[w]) return i[w];
						const A = (i[w] = Z({ client: j, controller: d }));
						return (
					...
					static search(d) {
						const w = d.id;
						if (i[w]) return i[w];
						const A = (i[w] = X({ client: j, controller: d }));
						return (
							A.on('afterStore', async ({ controller: x }, S) => {
								x.log.debug('controller', x), x.log.debug('store', x.store.toJSON()), await S();
							}),
				...
				function Z(E) {
					...
					return new k.c(E.controller, {
						client: new T.K(E.client.globals, E.client.config),
						store: new F.t(E.controller, { urlManager: d }),
						urlManager: d,
						eventManager: new g.E(),
						profiler: new v.U(),
						logger: new h.V(),
				...
				function t(c, C) {
					...
					(c.prototype.toName = function (F) {
						...
						if (F?.closest) {
							...
							for (var i in k) {
								var j = ((s = g), (r = R[i]), Math.pow(s.r - r.r, 2) + Math.pow(s.g - r.g, 2) + Math.pow(s.b - r.b, 2));
								j < v && ((v = j), (h = i));
							}
							return h;
						}
									...
									return {
										...
										getTickProps: function (l) {
											var p = l === void 0 ? {} : l,
												...
												B = D === void 0 ? {} : D,
												K = C(p, ['key', 'style']);
											return c({ key: P, style: c({ position: 'absolute', width: 0, left: H(n) + '%', transform: 'translateX(-50%)' }, B) }, K);
										},
									};
								});
							},
									...
									return {
										...
										getSegmentProps: function (l) {
											var p = l === void 0 ? {} : l,
												...
												N = H(o[f - 1] ? o[f - 1] : _),
												V = H(n) - N;
											return c({ key: P, style: c({ position: 'absolute', left: N + '%', width: V + '%' }, B) }, K);
										},
									};
								});
							},
...
//# sourceMappingURL=components-Organisms-FacetsHorizontal-FacetsHorizontal-stories.ef093d6f.iframe.bundle.js.map
