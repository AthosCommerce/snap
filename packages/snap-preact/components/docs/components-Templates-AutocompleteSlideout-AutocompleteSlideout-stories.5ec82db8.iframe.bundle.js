				...
				const v = {
					...
					m = (h, { loaded: { controller: y } }) => {
						...
						return (
							...
							D ? (0, o.Y)(_.o, { ...h, controller: y, input: y?.config.selector }) : (0, o.Y)(o.FK, {})
						);
					};
				...
				const w = ({}) =>
					...
					D = (0, _.PA)((P) => {
						...
						const F = (0, u.li)(null),
							...
							j = {
								autocompleteLayout: { onReset: () => O(), layout: l, tabManager: I, ...(0, i.s)({ disableStyles: f }), theme: t?.theme, treePath: C },
								slideout: {
									width: z,
									rerender: !1,
									overlayColor: N,
			...
			'./components/src/utilities/snapify.ts'(x, a, e) {
				...
				class D {
					static recommendation(r) {
						...
						return (
							c.on('afterStore', async ({ controller: l }, f) => {
...
//# sourceMappingURL=components-Templates-AutocompleteSlideout-AutocompleteSlideout-stories.5ec82db8.iframe.bundle.js.map
