			...
			'./components/src/components/Molecules/Result/Result.tsx'(O, i, e) {
				...
				const L = () =>
					...
					$ = (0, n.PA)((Z) => {
						...
						if (!I) return ce;
						const b = j?.display?.mappings.core || j?.mappings?.core,
							[me, F] = (0, a.J0)(!1),
							S = {
								variantSelection: {
								...
								button: {
									...
									onClick: (k) => {
										F(!0), V && V(k, j), N?.addToCart([j]), setTimeout(() => F(!1), le);
									},
									...(0, m.s)({ disableStyles: U }),
									theme: T.theme,
									treePath: W,
						...
						const _e = (0, C.Z)(T, L),
							...
							fe = g()(pe, T.lang || {}),
							ge = (0, M.u)(fe, { result: j, controller: N }),
							ue = !!(b?.msrp && b?.price && b?.price < b?.msrp);
						return b
							? (0, s.Y)(d._, {
									children: (0, s.FD)('article', {
										..._e,
										className: r()('ss__result', `ss__result--${oe}`, { 'ss__result--sale': ue }, se, z),
										ref: ie,
										children: [
											!J &&
												(0, s.Y)('div', {
													...
													children: (0, s.Y)('a', {
														...
														children: G
															? (0, s.Y)(l._, { ...S.image })
															: (0, s.Y)(x.Q, { ...S.overlayBadge, controller: N, children: (0, s.Y)(l._, { ...S.image }) }),
													}),
												}),
											(0, s.FD)('div', {
												className: 'ss__result__details',
												children: [
													!G && (0, s.Y)(y.W, { ...S.calloutBadge, controller: N }),
													!q &&
														(0, s.Y)('div', {
													...
													!ae && (0, s.Y)(B.G, { ...S.rating }),
													!ee && b.price && b.price > 0
														? (0, s.Y)('div', {
														...
														: null,
													(0, P.Y)(te, { result: j, treePath: W }),
													!ne && j.variants?.selections.length
														? (0, s.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: j.variants?.selections.map((k) => (0, s.Y)(f.m, { ...S.variantSelection, type: k.type, selection: k })),
														  })
														: null,
													!H &&
														(0, s.Y)('div', {
				...
				const M = ({ gapSize: f, columns: L }) =>
					...
					R = (0, a.PA)((f) => {
						const L = (0, E.u)(),
							...
							Q = { name: f.controller?.store?.profile?.tag?.toLowerCase(), ...f };
						let _ = (0, h.v6)('recommendationGrid', L, Z, Q);
						if (!(f.theme?.type == 'templates' || L?.type == 'templates')) {
							const I = (0, A.X)(_?.breakpoints || {}),
								b = l()(_?.theme || {}, I?.theme || {}, { arrayMerge: (me, F) => F });
							_ = { ..._, ...I, theme: b };
						}
						const {
								disableStyles: X,
							...
							z = typeof U == 'string',
							oe = z ? U : '',
							Y = se?.templates?.library.import.component.result || {},
							{ ComponentOverride: N, shouldWaitForNamedOverride: ne } = (0, g.x)(Y, z ? oe : void 0),
							H = z ? N : U,
							V = { enabled: !0, offset: '10%', ...G },
							re = { result: { internalClassName: 'ss__recommendation-grid__result', ...(0, u.s)({ disableStyles: X }), theme: _?.theme } };
						let D = _.results || w.store.results;
						if (!_.columns && !_.rows) (_.rows = 1), (_.columns = D.length);
						else if (_.columns && !_.rows) {
							if (((_.rows = Math.floor(D.length / _.columns)), j)) {
						...
						const le = (0, P.Z)(_, M),
							[ae, ie] = (0, B.useState)(!1),
							W = (0, K.li)(null);
						return (
							(!V?.enabled || (0, p.v)(W, `${V.offset} 0px ${V.offset} 0px`, !0)) && ie(!0),
							D?.length
								? (0, s.Y)(m._, {
										children: (0, s.Y)('div', {
											...le,
												...
												? (0, s.FD)(y.l, {
														...
														children: [
															...
															(0, s.Y)('div', {
																...
																children: D.map((I) =>
																	H && w
																		? (0, d.Y)(H, { controller: w, result: I, theme: te, treePath: J })
																		: ne
																		? null
																		: (0, s.Y)(x.o, {
																				result: I,
				...
				const d = { ResultTracker: () => (0, a.AH)({}) },
					u = (0, n.PA)((h) => {
						const P = (0, r.u)(),
							...
							{ children: C, result: v, track: A, controller: y, className: x, internalClassName: B, disableStyles: K, style: p } = m,
							g = { ...E, ...A },
						...
						return (
							...
							(0, s.Y)('div', {
								className: t()('ss__result-tracker', `ss__${y?.type}-result-tracker`, x, B),
								onClick: (L) => {
						...
						return (
							(0, s.vJ)(() => {
								...
								return (
									...
									() => {
										P(!1), B(), m.current && window.clearTimeout(m.current), y && t.current && y.unobserve(t.current);
									}
								);
							}, [t, C]),
			...
			'./components/src/utilities/snapify.ts'(O, i, e) {
				...
				class y {
					static recommendation(g) {
						const M = g.id;
						if (v[M]) return v[M];
						const R = (v[M] = B({ client: A, controller: g }));
						return (
...
//# sourceMappingURL=components-Templates-RecommendationGrid-RecommendationGrid-stories.34a4a34d.iframe.bundle.js.map
