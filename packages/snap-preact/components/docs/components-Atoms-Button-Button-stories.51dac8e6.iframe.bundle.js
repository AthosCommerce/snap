(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[1840],
		{
			'./components/src/components/Atoms/Button/Button.stories.tsx'(y, r, t) {
				'use strict';
				t.r(r), t.d(r, { Default: () => o, Disabled: () => d, Native: () => s, __namedExportsOrder: () => f, default: () => e });
				...
				const e = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, n.FD)('div', {
										children: [(0, n.Y)(l.oz, { options: { overrides: { code: u.Z } }, children: a }), (0, n.Y)(l.uY, { story: l.h1 })],
									}),
							},
						},
						argTypes: {
			...
			'./components/src/utilities/storybook.tsx'(y, r, t) {
				...
				const i = 'prism-block',
					u = (c) => {
						...
						return (
							(0, l.vJ)(() => {
								a.current && c.className?.includes('lang-') && !c.className?.includes(i) && window?.Prism?.highlightElement(a.current);
							}, [c.className, c.children, a]),
							(0, n.Y)('code', { ...c, ref: a, 'data-prismjs-copy': 'Copy' })
						);
					};
				t.d(r, ['Z', 0, u]);
			},
