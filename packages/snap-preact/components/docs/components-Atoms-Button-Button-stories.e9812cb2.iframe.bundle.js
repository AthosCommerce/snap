	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[1840],
		{
			'./components/src/components/Atoms/Button/Button.stories.tsx'(b, r, e) {
				'use strict';
				e.r(r), e.d(r, { Default: () => d, Disabled: () => u, Native: () => n, __namedExportsOrder: () => y, default: () => f });
...
`;
			...
			'./components/src/components/Atoms/Button/Button.tsx'(b, r, e) {
				...
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					K = e.n(R);
				const W = ({ native: B, color: v, backgroundColor: T, borderColor: C, theme: _ }) =>
						B
							? (0, l.AH)({})
							: (0, l.AH)({
									display: 'inline-flex',
									...
									padding: '5px 10px',
									position: 'relative',
									color: v || _?.variables?.colors?.primary,
									outline: 0,
									backgroundColor: T || '#fff',
									border: `1px solid ${C || v || _?.variables?.colors?.primary || '#333'}`,
					...
					N = (0, i.PA)((B) => {
						const v = (0, a.u)(),
							C = { disableA11y: !1, treePath: (0, f.LU)() },
							_ = (0, y.v6)('button', v, C, B),
							{
								content: E,
								children: x,
								disabled: D,
						...
						if (!J) return V;
						const k = { icon: { internalClassName: 'ss__button__icon', ...(0, n.s)({ disableStyles: F }), theme: _?.theme, treePath: h } },
							j = {
								...(0, m.Z)(_, W),
								className: c()('ss__button', { 'ss__button--native': A, 'ss__button--disabled': D }, $, H),
								disabled: D,
								onClick: (O) => !D && M && M(O),
								...I,
							},
