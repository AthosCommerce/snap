...
`,
					...
					_ = (v, { loaded: { controller: d } }) => (0, t.Y)(s.A, { ...v, controller: d });
				(_.loaders = [
					async () => (
						m.on('afterStore', async ({ controller: v }, d) => {
							v.store.results.forEach((M) => (M.mappings.core.url = 'javascript:void(0);')), await d();
						}),
						await m.search(),
						{ controller: m }
					),
  ...
  return <Recommendation {...props} controller={controller} />;
			...
			'./components/src/components/Molecules/Carousel/Carousel.tsx'(R, r, e) {
				...
				const D = ({ vertical: T, theme: J }) =>
					...
					E = { 0: { slidesPerView: 1, slidesPerGroup: 1, spaceBetween: 0 } },
					V = (0, c.PA)((T) => {
						const J = (0, K.u)(),
							ne = (0, N.LU)(),
							pe = {
								breakpoints: T.vertical ? JSON.parse(JSON.stringify(E)) : JSON.parse(JSON.stringify(b)),
								pagination: !1,
								navigation: !0,
						...
						(0, n.vJ)(() => {
							if (W.current) {
								const g = W.current.querySelector('.swiper');
						...
						const se = () => {
							if (W.current) {
								const g = W.current?.querySelectorAll('.swiper-slide-visible');
								g.forEach(($, z) => {
								...
								? (0, t.Y)(U._, {
										children: (0, t.FD)('div', {
											...
											children: [
												k !== !1 &&
													(0, t.Y)('div', {
														className: o()('ss__carousel__prev-wrapper', { 'ss__carousel__prev-wrapper--hidden': S }),
														children: (0, t.Y)('div', {
												...
												k !== !1 &&
													(0, t.Y)('div', {
														className: o()('ss__carousel__next-wrapper', { 'ss__carousel__next-wrapper--hidden': S }),
														children: (0, t.Y)('div', {
						...
						const O = A?.display?.mappings.core || A?.mappings?.core,
							...
							L = {
								...
								button: {
									...
									onClick: (z) => {
										_e(!0), Ee && Ee(z, A), G?.addToCart([A]), setTimeout(() => _e(!1), ge);
									},
									...(0, d.s)({ disableStyles: Y }),
									theme: l.theme,
									treePath: I,
											...
											(0, t.FD)('div', {
												...
												children: [
													...
													!j && $ && O.price && O.price > 0
														...
														: null,
													(0, v.Y)(ee, { result: A, treePath: I }),
													!ve && A.variants?.selections.length
														? (0, t.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: A.variants?.selections.map((z) => (0, t.Y)(E.m, { ...L.variantSelection, type: z.type, selection: z })),
														  })
														: null,
													!Pe &&
														(0, t.Y)('div', {
			...
			'./components/src/components/Templates/Recommendation/Recommendation.tsx'(R, r, e) {
				...
				const E = ({ vertical: T }) =>
					...
					V = (0, c.PA)((T) => {
						...
						const W = ae || j.store?.results;
						if (Array.isArray(S) && S.length !== W.length)
							return (
								j.log.error(
						...
						const oe = {
								carousel: {
									...
									...(0, v.s)({ disableStyles: H, vertical: ge }),
									theme: l?.theme,
									treePath: F,
								},
								result: { internalClassName: 'ss__recommendation__result', ...(0, v.s)({ disableStyles: H }), theme: l?.theme, treePath: F },
							},
							se = (0, M.Z)(l, E),
							[a, g] = (0, n.J0)(!1),
							$ = (0, n.li)(null);
						...
						return (Array.isArray(S) && S.length) || W?.length
							? (0, t.Y)(y._, {
									children: (0, t.Y)('div', {
										...se,
										style: H ? B.k : void 0,
										className: o()('ss__recommendation', G, ve),
										ref: $,
										children: a
											? (0, t.FD)(h.l, {
													controller: j,
														...
														(0, t.Y)(m.FN, {
															...
															children:
																Array.isArray(S) && S.length
																	? S.map((Z, ye) => (0, t.Y)(b.o, { controller: j, result: W[ye], children: Z }))
																	: W.map((Z) =>
																			(0, t.Y)(b.o, {
																				controller: j,
																				result: Z,
											...
											: (0, t.Y)(h.l, {
													...
													children:
														Array.isArray(S) && S.length
															? S.map((Z, ye) => (0, t.Y)(b.o, { controller: j, result: W[ye], children: (0, t.Y)(t.FK, {}) }))
															: W.map((Z) => (0, t.Y)(b.o, { controller: j, result: Z, children: (0, t.Y)(t.FK, {}) })),
											  }),
									}),
							  })
							: (0, t.Y)(t.FK, {});
			...
			'./components/src/components/Trackers/Recommendation/ProfileTracker/RecommendationProfileTracker.tsx'(R, r, e) {
				...
				const f = () => (0, s.AH)({}),
					m = (0, i.PA)((_) => {
						const { children: x, className: v, internalClassName: d } = _,
							M = (0, n.v2)(x),
							B = (0, u.Z)(_, f);
						return M.length ? (0, t.Y)('div', { className: c()('ss__recommendation-profile-tracker', v, d), ...B, children: x }) : null;
					});
				e.d(r, ['l', 0, m]);
			},
			'./components/src/components/Trackers/ResultTracker/ResultTracker.tsx'(R, r, e) {
				...
				const m = { ResultTracker: () => (0, n.AH)({}) },
					_ = (0, s.PA)((x) => {
						...
						const E = {};
						return (
							N ? p && (E.css = [p]) : (E.css = [m.ResultTracker(), p]),
							(0, t.Y)('div', {
										...
										_ > 0
											? ((M.current = Date.now()),
											  ...
											  (d.current = window.setTimeout(() => {
													v(!0), f && o.current && y && y.unobserve(o.current);
											  }, _)))
											: (v(!0), f && o.current && y && y.unobserve(o.current));
									},
									p = () => {
										d.current && window.clearTimeout(d.current), (d.current = null), (M.current = null), v(!1);
									};
								return (
									...
									() => {
										v(!1), K(), d.current && window.clearTimeout(d.current), y && o.current && y.unobserve(o.current);
									}
								);
							}, [o, B]),
			...
			'./components/src/utilities/snapify.ts'(R, r, e) {
				...
				class y {
					static recommendation(h) {
						...
						return (
							b.on('afterStore', async ({ controller: E }, V) => {
								E.log.debug('controller', E), E.log.debug('store', E.store.toJSON()), await V();
							}),
							b.init(),
							b
						);
				...
				var t = function (n, s) {
					...
					(n.prototype.toName = function (f) {
						...
						if (f?.closest) {
							...
							for (var P in i) {
								var w = ((m = v), (_ = u[P]), Math.pow(m.r - _.r, 2) + Math.pow(m.g - _.g, 2) + Math.pow(m.b - _.b, 2));
								w < d && ((d = w), (M = P));
							}
							return M;
						}
...
//# sourceMappingURL=components-Templates-Recommendation-Recommendation-stories.9dc2db12.iframe.bundle.js.map
