			...
			'./components/src/components/Molecules/Result/Result.tsx'(E, l, e) {
				...
				const P = () =>
					...
					J = (0, T.PA)((z) => {
						...
						const a = u?.display?.mappings.core || u?.mappings?.core,
							...
							g = {
								...
								button: {
									...
									onClick: (M) => {
										V(!0), w && w(M, u), L?.addToCart([u]), setTimeout(() => V(!1), le);
									},
									...(0, _.s)({ disableStyles: R }),
									theme: c.theme,
									treePath: C,
						...
						let k = a?.name;
						c.truncateTitle && (k = m.x(a?.name || '', c.truncateTitle.limit, c.truncateTitle.append));
						const ue = (0, S.Z)(c, P),
							pe = { addToCartButtonText: { value: _e ? ae : re } },
							he = n()(pe, c.lang || {}),
							ge = (0, r.u)(he, { result: u, controller: L }, { activeBreakpoint: N?.activeBreakpoint }),
									...
									children: (0, t.FD)('article', {
										...
										children: [
											...
											(0, t.FD)('div', {
												...
												children: [
													!Y && (0, t.Y)(A.W, { ...g.calloutBadge, controller: L }),
													!$ &&
														(0, t.Y)('div', {
				...
				const D = { ResultTracker: () => (0, p.AH)({}) },
					b = (0, T.PA)((x) => {
						const f = (0, h.u)(),
							...
							{ children: S, result: m, track: y, controller: A, className: I, internalClassName: K, disableStyles: W, style: o } = _,
							n = { ...B, ...y },
			...
			'./components/src/utilities/snapify.ts'(E, l, e) {
				...
				function I(o) {
					...
					return new p.Tp(o.controller, {
						...
						profiler: new _.U(),
						logger: new B.V(),
						tracker: new S.J(o.client.globals),
					});
				}
				function K(o) {
