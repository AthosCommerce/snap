		...
		[4055],
		{
			...
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/formatNumber.js'(v, i, e) {
				...
				function o(s, r) {
					...
					const n = l(s, t.decimalPlaces).split('.');
			...
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/truncate.js'(v, i, e) {
				...
				e.d(i, { x: () => o });
				function o(l, s, r) {
					if (typeof l != 'string' || l.length <= s) return l;
					const t = l.lastIndexOf(' ', s),
						n = t != -1 ? t : s - 1;
				...
				const b = {
					...
					x = (d, { loaded: { controller: P } }) => {
						...
						return (
							...
							(0, o.Y)('div', { style: { maxWidth: d?.layout == 'list' ? '650px' : '300px' }, children: (0, o.Y)(s.Q, { ...d, result: E }) })
						);
					};
  ...
  return <div style={{
    maxWidth: args?.layout == 'list' ? '650px' : '300px'
			...
			'./components/src/components/Molecules/Result/Result.tsx'(v, i, e) {
				...
				const S = () =>
					...
					H = (0, s.PA)((J) => {
						...
						const g = M?.display?.mappings.core || M?.mappings?.core,
							...
							B = {
								...
								button: {
									...
									onClick: (A) => {
										V(!0), N && N(A, M), w?.addToCart([M]), setTimeout(() => V(!1), le);
									},
									...(0, u.s)({ disableStyles: L }),
									theme: _.theme,
									treePath: D,
						...
						let Y = g?.name;
						_.truncateTitle && (Y = d.x(g?.name || '', _.truncateTitle.limit, _.truncateTitle.append));
						const pe = (0, O.Z)(_, S),
							ge = { addToCartButtonText: { value: me ? ae : ne } },
							fe = p()(ge, _.lang || {}),
							_e = (0, y.u)(fe, { result: M, controller: w }, { activeBreakpoint: W?.activeBreakpoint }),
							z = !!(g?.msrp && g?.price && g?.price < g?.msrp),
							he = w?.store?.config?.asyncState?.product?.price ? M.state.priceFetched : !0;
						return g
							? (0, o.Y)(f._, {
									children: (0, o.FD)('article', {
										...pe,
										className: n()('ss__result', `ss__result--${oe}`, { 'ss__result--sale': z }, ee, te),
										ref: ce,
										children: [
											!X &&
												(0, o.Y)('div', {
											...
											(0, o.FD)('div', {
												...
												children: [
													!K && (0, o.Y)(E.W, { ...B.calloutBadge, controller: w }),
													!G &&
														(0, o.Y)('div', {
			...
			'./components/src/utilities/storybook.tsx'(v, i, e) {
				...
				const s = 'prism-block',
					r = (t) => {
						...
						return (
							(0, l.vJ)(() => {
								n.current && t.className?.includes('lang-') && !t.className?.includes(s) && window?.Prism?.highlightElement(n.current);
					...
					(l.prototype.toName = function (c) {
						...
						if (c?.closest) {
							var x = this.toRgb(),
								u = 1 / 0,
								h = 'black';
							if (!a.length) for (var O in r) a[O] = new l(r[O]).toRgb();
							for (var d in r) {
			...
			'../../node_modules/dequal/dist/index.mjs'(v, i, e) {
				...
				function l(r, t, n) {
					for (n of r.keys()) if (s(n, t)) return n;
				}
				function s(r, t) {
					var n, a, c;
					if (r === t) return !0;
					if (r && t && (n = r.constructor) === t.constructor) {
						...
						if (n === Array) {
							if ((a = r.length) === t.length) for (; a-- && s(r[a], t[a]); );
							return a === -1;
						}
						if (n === Set) {
						...
						if (n === Map) {
							if (r.size !== t.size) return !1;
							for (a of r) if (((c = a[0]), (c && typeof c == 'object' && ((c = l(t, c)), !c)) || !s(a[1], t.get(c)))) return !1;
							return !0;
						}
						...
						if (!n || typeof r == 'object') {
							a = 0;
							for (n in r) if ((o.call(r, n) && ++a && !o.call(t, n)) || !(n in t) || !s(r[n], t[n])) return !1;
...
//# sourceMappingURL=components-Molecules-Result-Result-stories.a9418449.iframe.bundle.js.map
