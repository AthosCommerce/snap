			...
			'./components/src/components/Molecules/Result/Result.tsx'(O, a, e) {
				...
				const N = () =>
					...
					Q = (0, m.PA)(($) => {
						...
						const t = n?.display?.mappings.core || n?.mappings?.core,
							...
							r = {
								...
								button: {
									...
									onClick: (c) => {
										F(!0), V && V(c, n), u?.addToCart([n]), setTimeout(() => F(!1), le);
									},
									...(0, l.s)({ disableStyles: d }),
									theme: o.theme,
									treePath: _,
						...
						let k = t?.name;
						o.truncateTitle && (k = h.x(t?.name || '', o.truncateTitle.limit, o.truncateTitle.append));
						const ue = (0, U.Z)(o, N),
							pe = { addToCartButtonText: { value: de ? re : ae } },
							Ee = v()(pe, o.lang || {}),
							Ce = (0, y.u)(Ee, { result: n, controller: u }, { activeBreakpoint: Y?.activeBreakpoint }),
									...
									children: (0, s.FD)('article', {
										...
										children: [
											...
											(0, s.FD)('div', {
												...
												children: [
													!b && (0, s.Y)(T.W, { ...r.calloutBadge, controller: u }),
													!G &&
														(0, s.Y)('div', {
