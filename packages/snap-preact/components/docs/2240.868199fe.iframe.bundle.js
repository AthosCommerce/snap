	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[2240],
		{
			'../../node_modules/@athoscommerce/snap-controller/dist/esm/Autocomplete/AutocompleteController.js'(z, N, u) {
				...
				class K extends H.r {
					constructor(o, { client: t, store: n, urlManager: a, eventManager: d, profiler: g, logger: v, tracker: E }, W) {
						super(o, { client: t, store: n, urlManager: a, eventManager: d, profiler: g, logger: v, tracker: E }, W),
							...
							(this.search = async () => {
								try {
									...
									if ((T.stop(), this.log.profile(T), this.store.update({ meta: i, search: c }), !A)) {
							...
							this.eventManager.on('beforeSubmit', async (e, s) => {
								...
								if (this.config?.settings?.redirects?.singleResult) {
									const { results: p } = e.controller.store,
										...
										T = A.length === 1 && A[0].mappings.core?.url;
									if (T) return (window.location.href = T), !1;
								}
							}),
