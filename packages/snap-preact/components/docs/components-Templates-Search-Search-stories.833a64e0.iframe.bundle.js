	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[8907],
		{
			'./components/src/components/Templates/Search/Search.stories.tsx'(b, c, e) {
				e.r(c), e.d(c, { Default: () => o, NoResults: () => a, __namedExportsOrder: () => g, default: () => h });
...
//# sourceMappingURL=components-Templates-Search-Search-stories.833a64e0.iframe.bundle.js.map
