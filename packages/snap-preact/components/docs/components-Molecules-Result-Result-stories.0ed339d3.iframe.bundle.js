	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[4055],
		{
			...
			'./components/src/components/Molecules/Result/Result.stories.tsx'(x, i, e) {
				'use strict';
				e.r(i), e.d(i, { Default: () => E, __namedExportsOrder: () => w, default: () => T, hideSections: () => u, truncateTitle: () => h });
  ...
  return <div style={{
    maxWidth: args?.layout == 'list' ? '650px' : '300px'
            ...
            <Result {...args} result={resultToUse} />
				...
				const w = ['Default', 'hideSections', 'truncateTitle'];
			},
				...
				const S = () =>
					...
					F = (0, r.PA)((J) => {
						...
						const f = R?.display?.mappings.core || R?.mappings?.core,
							...
							M = {
								variantSelection: {
									...
									...(0, u.s)({ disableStyles: k }),
									theme: g.theme,
									treePath: D,
								},
								price: { internalClassName: 'ss__result__price', ...(0, u.s)({ disableStyles: k }), theme: g.theme, treePath: D },
								calloutBadge: {
								...
								image: {
									...
									alt: f?.name || '',
									src: f?.imageUrl || '',
									...(0, u.s)({ disableStyles: k, fallback: te }),
									theme: g.theme,
									treePath: D,
								},
								rating: {
								...
								button: {
									...
									onClick: (O) => {
										Y(!0), N && N(O, R), A?.addToCart([R]), setTimeout(() => Y(!1), ce);
									},
									...(0, u.s)({ disableStyles: k }),
									theme: g.theme,
									treePath: D,
						...
						const _e = (0, w.Z)(g, S),
							...
							ye = p()(he, g.lang || {}),
							z = (0, y.u)(ye, { result: R, controller: A }, { activeBreakpoint: W?.activeBreakpoint }),
							H = !!(f?.msrp && f?.price && f?.price < f?.msrp),
							be = A?.store?.config?.asyncState?.product?.price ? R.state.priceFetched : !0;
						return f
							? (0, o.Y)(_._, {
												...
												(0, o.FD)('div', {
													...
													children: [
														(0, o.Y)('a', {
															...
															children: K
																? (0, o.Y)(a._, { ...M.image })
																: (0, o.Y)(U.Q, { ...M.overlayBadge, controller: A, children: (0, o.Y)(a._, { ...M.image }) }),
														}),
														!ue && A?.quickviewManager && (0, o.Y)(L.$, { ...M.quickviewButton, ...z.quickviewButtonText.attributes }),
													],
												}),
											(0, o.FD)('div', {
												className: 'ss__result__details',
												children: [
													!K && (0, o.Y)(C.W, { ...M.calloutBadge, controller: A }),
													!$ &&
														(0, o.Y)('div', {
													...
													!se && R.variants?.selections.length
														? (0, o.Y)('div', {
																...
																children: R.variants?.selections.map((O) => (0, o.Y)(b.m, { ...M.variantSelection, type: O.type, selection: O })),
														  })
														: null,
													!ae &&
														(0, o.Y)('div', {
			...
			'./components/src/utilities/snapify.ts'(x, i, e) {
				...
				function U(m) {
					...
					return new l.Tp(m.controller, {
						...
						profiler: new u.U(),
						logger: new h.V(),
						tracker: new w.J(m.client.globals),
					});
				}
				function j(m) {
					...
					(l.prototype.toName = function (c) {
						...
						if (c?.closest) {
							var E = this.toRgb(),
								u = 1 / 0,
								h = 'black';
							if (!a.length) for (var w in n) a[w] = new l(n[w]).toRgb();
							for (var d in n) {
...
//# sourceMappingURL=components-Molecules-Result-Result-stories.0ed339d3.iframe.bundle.js.map
