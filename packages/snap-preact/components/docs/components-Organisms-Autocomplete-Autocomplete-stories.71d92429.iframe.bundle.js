						...
						(0, C.W)(
							(0, p.PA)((a) => {
								const v = (0, O.u)(),
									...
									n = (0, h.v6)('inlineBanner', v, R, a),
									{ banner: r, className: m, internalClassName: u, disableA11y: g, layout: S, onClick: I } = n,
									{ overrideElement: L, shouldRenderDefault: N } = (0, D._)('inlineBanner', n);
								if (!N) return L;
								const F = (0, E.Z)(n, c);
								return r && r.value
									? (0, t.Y)(o._, {
					...
					I = (0, _.PA)((L) => {
						...
						const b = l?.display?.mappings.core || l?.mappings?.core,
							...
							V = {
								...
								price: { internalClassName: 'ss__result__price', ...(0, s.s)({ disableStyles: K }), theme: A.theme, treePath: w },
								calloutBadge: {
						...
						const pe = (0, D.Z)(A, S),
							...
							he = r()(_e, A.lang || {}),
							Ee = (0, m.u)(he, { result: l, controller: k }),
							de = !!(b?.msrp && b?.price && b?.price < b?.msrp),
							fe = k?.store?.config?.asyncState?.product?.price ? l.state.priceFetched : !0;
						return b
							? (0, t.Y)(P._, {
											...
											!Y &&
												(0, t.Y)('div', {
													...
													children: (0, t.Y)('a', {
														...
														children: j
															? (0, t.Y)(O._, { ...V.image })
															: (0, t.Y)(v.Q, { ...V.overlayBadge, controller: k, children: (0, t.Y)(O._, { ...V.image }) }),
													}),
												}),
											(0, t.FD)('div', {
												className: 'ss__result__details',
												children: [
													!j && (0, t.Y)(a.W, { ...V.calloutBadge, controller: k }),
													!Z &&
														(0, t.Y)('div', {
													...
													!X && (0, t.Y)(x.G, { ...V.rating }),
													!Q && fe && b.price && b.price > 0
														? (0, t.Y)('div', {
																className: 'ss__result__details__pricing',
																children: de
																	? (0, t.FD)(t.FK, {
																			children: [
																				(0, t.Y)(C.g, { ...V.price, value: b.msrp, lineThrough: !0, name: 'msrp' }),
																				'\xA0',
																				(0, t.Y)(C.g, { ...V.price, value: b.price, name: 'price' }),
																			],
																	  })
																	: (0, t.Y)(C.g, { ...V.price, value: b.price }),
														  })
														: null,
													(0, i.Y)($, { result: l, treePath: w }),
													!se && l.variants?.selections.length
														? (0, t.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: l.variants?.selections.map((H) => (0, t.Y)(g.m, { ...V.variantSelection, type: H.type, selection: H })),
														  })
														: null,
													!re &&
														(0, t.Y)('div', {
															className: 'ss__result__add-to-cart-wrapper',
															children: (0, t.Y)(R.$, { ...V.button, ...Ee.addToCartButtonText.all }),
														}),
												],
											}),
										],
				...
				const u = ({ gapSize: I, columns: L }) =>
					...
					S = (0, _.PA)((I) => {
						...
						const k = typeof J == 'string',
							se = k ? J : '',
							re = N?.templates?.library.import.component.result || {},
						...
						const ae = (0, D.Z)({ ...l, columns: Y == E.V.list ? 1 : l.columns }, u),
							w = k ? O()($ || {}, { components: { result: { customComponent: J } } }) : $;
						return X?.length
							? (0, t.Y)(c._, {
									children: (0, t.Y)('div', {
										...ae,
										...
										children: X.map((U) =>
											U.type === C.c.BANNER
												...
												? (0, t.Y)(n.o, {
														result: U,
														controller: K,
														children: (0, i.Y)(ee, { key: U.id, controller: K, result: U, theme: w, treePath: G }),
												  })
				...
				const P = { ResultTracker: () => (0, T.AH)({}) },
					h = (0, _.PA)((E) => {
						const i = (0, y.u)(),
							...
							{ children: D, result: c, track: f, controller: a, className: v, internalClassName: x, disableStyles: R, style: n } = s,
							r = { ...p, ...f },
						...
						return (
							...
							(0, t.Y)('div', {
								className: o()('ss__result-tracker', `ss__${a?.type}-result-tracker`, v, x),
								onClick: (S) => {
			...
			'./components/src/providers/withTracking.tsx'(W, d, e) {
				...
				function o(y) {
					...
					return (P) => {
						...
						const { ref: c, inViewport: f, updateRef: a } = (0, T.Q)(),
							v = (E || i || (s && p?.[s]?.[0]))?.responseId,
							x = (0, _.li)(v),
							R = (0, _.li)(!1);
						x.current !== v && (R.current = !0),
							(0, _.vJ)(() => {
								x.current !== v && ((x.current = v), a(c.current));
							}, [v, a]),
							(0, _.vJ)(() => {
								R.current && !f && (R.current = !1);
							}, [f, v]);
						const n = s && p && !E && ['search', 'autocomplete'].includes(h?.type || '');
						f && !R.current && (n ? h?.track.banner.impression(p[s][0]) : E?.bundleSeed || h?.track.product.impression(E || i));
						const r = (0, _.hb)(
							(u) => {
			...
			'./components/src/utilities/snapify.ts'(W, d, e) {
				...
				class a {
					static recommendation(r) {
						const m = r.id;
						if (c[m]) return c[m];
						const u = (c[m] = x({ client: f, controller: r }));
						return (
					...
					static autocomplete(r) {
						const m = r.id;
						if (c[m]) return c[m];
						const u = (c[m] = R({ client: f, controller: r }));
						return (
							u.on('afterStore', async ({ controller: g }, S) => {
								g.log.debug('controller', g), g.log.debug('store', g.store.toJSON()), await S();
							}),
...
//# sourceMappingURL=components-Organisms-Autocomplete-Autocomplete-stories.71d92429.iframe.bundle.js.map
