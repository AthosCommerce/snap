	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[935],
		{
			'./src/create/createRecommendationController.ts'(D, n, o) {
				o.r(n);
				var m = o('../../node_modules/@athoscommerce/snap-controller/dist/esm/Recommendation/RecommendationController.js'),
					s = o('../../node_modules/@athoscommerce/snap-client/dist/esm/Client/Client.js'),
				...
				const r = (e, a) => {
					const t = (a?.urlManager || new _.V(new d.E(e.url), c.X)).detach(!0);
					return (
						e.mode && e.client && ((e.client.config = e.client.config || {}), (e.client.config.mode = e.mode)),
						new m.c(
							e.controller,
							{
								client: a?.client || new s.K(e.client.globals, e.client.config),
								store: a?.store || new l.t(e.controller, { urlManager: t }),
								urlManager: t,
