		...
		[9354],
		{
			...
			'./components/src/components/Molecules/Result/Result.tsx'(g, d, t) {
				var a = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					S = t('./components/src/components/Molecules/OverlayBadge/OverlayBadge.tsx'),
					U = t('./components/src/components/Molecules/Rating/Rating.tsx'),
				...
				const z = () =>
					...
					V = (0, r.PA)((H) => {
						...
						const c = m?.display?.mappings.core || m?.mappings?.core,
							...
							_ = {
								...
								button: {
									...
									onClick: (E) => {
										R(!0), A && A(E, m), P?.addToCart([m]), setTimeout(() => R(!1), le);
									},
									...(0, u.s)({ disableStyles: v }),
									theme: f.theme,
									treePath: b,
						...
						const ue = (0, T.Z)(f, z),
							...
							ge = w()(_e, f.lang || {}),
							pe = (0, K.u)(ge, { result: m, controller: P }),
											...
											!J &&
												(0, a.Y)('div', {
													...
													children: (0, a.Y)('a', {
														...
														children: x
															? (0, a.Y)(n._, { ..._.image })
															: (0, a.Y)(S.Q, { ..._.overlayBadge, controller: P, children: (0, a.Y)(n._, { ..._.image }) }),
													}),
												}),
											(0, a.FD)('div', {
												...
												children: [
													...
													!ae && m.variants?.selections.length
														? (0, a.Y)('div', {
																...
																children: m.variants?.selections.map((E) => (0, a.Y)(Y.m, { ..._.variantSelection, type: E.type, selection: E })),
														  })
														: null,
													!re &&
														(0, a.Y)('div', {
															className: 'ss__result__add-to-cart-wrapper',
															children: (0, a.Y)(N.$, { ..._.button, ...pe.addToCartButtonText.all }),
														}),
												],
											}),
										],
