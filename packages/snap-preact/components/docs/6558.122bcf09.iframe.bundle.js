...
(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[6558],
		{
			'./src/Templates/Stores/library/languages/es.ts'(l, a, t) {
				t.r(a);
				const r = {
					recommendation: {},
					autocompleteLayout: {
					...
					sidebar: {
						...
						clearButtonText: { value: 'Borrar todo' },
						closeButtonText: {},
					},
					searchInput: {
					...
					result: {
						addToCartButtonText: { value: 'A\xF1adir todo al carrito', attributes: { 'aria-label': 'A\xF1adir todo al carrito' } },
						addToCartButtonSuccessText: { value: '\xA1Agregado!' },
						quickviewButtonText: { value: 'Vista r\xE1pida', attributes: { 'aria-label': 'Vista r\xE1pida' } },
					},
					overlayResult: {
						addToCartButtonText: { value: 'A\xF1adir todo al carrito', attributes: { 'aria-label': 'A\xF1adir todo al carrito' } },
						addToCartButtonSuccessText: { value: '\xA1Agregado!' },
					...
					tabSelection: {
						tabList: { attributes: { 'aria-label': 'Pesta\xF1as de resultados' } },
						tabButton: {
							attributes: {
					...
					quantityPicker: {
						quantityInput: { attributes: { 'aria-label': 'cantidad' } },
						decrementButton: { attributes: { 'aria-label': 'disminuir la cantidad' } },
						incrementButton: { attributes: { 'aria-label': 'aumentar la cantidad' } },
					},
					searchHeader: {
						titleText: {
                ...
                ${e?.search?.query ? `para <span class="ss__search-header__results-query">"${e?.search?.query?.string}"</span>` : ''}`,
                    ...
                    No se encontraron resultados para <span class="ss__search-header__results-query">"${e?.search?.query?.string}"</span>.
						...
						expandedSearchText: {
							value: (e) =>
								`No pudimos encontrar una coincidencia exacta para "<span class="ss__search-header__results-query">${e?.search?.query?.string}</span>", pero aqu\xED hay algo similar:`,
						},
					},
					noResults: {
						...
						suggestionsList: {
							value:
								'<ul class="ss__no-results__suggestions__list"><li class="ss__no-results__suggestions__list__option">Verifica si hay errores de ortograf\xEDa.</li><li class="ss__no-results__suggestions__list__option">Elimina palabras clave redundantes (ej. "productos").</li><li class="ss__no-results__suggestions__list__option">Usa otros t\xE9rminos para describir lo que est\xE1s buscando.</li></ul>',
						},
					},
					gallery: {
						gallery: { attributes: { 'aria-label': 'Galer\xEDa de im\xE1genes' } },
						zoomOutButton: { attributes: { 'aria-label': 'Alejar' } },
						zoomInButton: { attributes: { 'aria-label': 'Acercar' } },
						closeButton: { attributes: { 'aria-label': 'Cerrar galer\xEDa' } },
						prevButton: { attributes: { 'aria-label': 'Imagen anterior' } },
						nextButton: { attributes: { 'aria-label': 'Imagen siguiente' } },
					},
					quickviewLayout: {
						quickview: { attributes: { 'aria-label': 'Vista r\xE1pida' } },
						closeButton: { attributes: { 'aria-label': 'Cerrar vista r\xE1pida' } },
						addToCartButton: { value: 'A\xF1adir al carrito' },
						moreInfoButton: { value: 'M\xE1s informaci\xF3n' },
...
//# sourceMappingURL=6558.122bcf09.iframe.bundle.js.map
