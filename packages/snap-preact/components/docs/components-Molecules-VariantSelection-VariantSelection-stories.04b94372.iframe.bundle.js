(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[2271],
		{
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/fieldNameToComponentName/fieldNameToComponentName.js'(z, i, e) {
				'use strict';
				const r = (m) => m.replace(/_/g, '-').toLowerCase();
				e.d(i, ['P', 0, r]);
			},
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/handleize.js'(z, i, e) {
				'use strict';
				e.d(i, { p: () => r });
				function r(m) {
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.stories.tsx'(z, i, e) {
				'use strict';
				e.r(i), e.d(i, { Dropdown: () => p, List: () => h, Swatches: () => q, __namedExportsOrder: () => x, default: () => g });
				...
				var o = e('./components/src/utilities/snapify.ts');
				const g = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, r.FD)('div', {
										children: [(0, r.Y)(c.oz, { options: { overrides: { code: t.Z } }, children: n }), (0, r.Y)(c.uY, { story: c.h1 })],
									}),
							},
						},
						decorators: [(l) => (0, r.Y)(l, {})],
						argTypes: {
							selection: {
					...
					f = (0, m.PA)(({ args: l }) =>
						(0, r.Y)('div', { style: { maxWidth: l?.type == 'list' ? '500px' : '300px' }, children: (0, r.Y)(a.m, { ...l }) })
					),
					h = (l) => (0, r.Y)(f, { args: l }),
					q = (l) => (0, r.Y)(f, { args: l }),
					y = [
            ...
            rgba(255, 0, 0, 1) 100%
					...
					M = { id: 'searchVariants', globals: { siteId: 'atkzs2' } },
					S = o.p.search(M),
					p = (l, { loaded: {} }) =>
						(0, r.Y)('div', { style: { maxWidth: l?.type == 'list' ? '500px' : '300px' }, children: (0, r.Y)(a.m, { ...l }) });
				(p.loaders = [
					async () => (
						S.on('afterSearch', async ({ response: l }, V) => {
							l.results?.length &&
								(l.results[0].attributes.ss_variants =
  ...
  return <div style={{
    maxWidth: args?.type == 'list' ? '500px' : '300px'
            ...
            <VariantSelection {...args} />
				...
				const x = ['List', 'Swatches', 'Dropdown'];
			},
			'./components/src/utilities/componentArgs.ts'(z, i, e) {
				'use strict';
				const r = {
					className: {
			...
			'./components/src/utilities/snapify.ts'(z, i, e) {
				'use strict';
				e.d(i, { p: () => l });
				var r = e('../../node_modules/mobx/dist/mobx.esm.js'),
					...
					q = e('../../node_modules/@athoscommerce/snap-event-manager/dist/esm/EventManager.js'),
				...
				class l {
					static recommendation(d) {
						const b = d.id;
						if (p[b]) return p[b];
						const T = (p[b] = U({ client: x, controller: d }));
						return (
							T.on('afterStore', async ({ controller: v }, P) => {
								v.log.debug('controller', v), v.log.debug('store', v.store.toJSON()), await P();
							}),
							T.init(),
							T
						);
					...
					static autocomplete(d) {
						const b = d.id;
						if (p[b]) return p[b];
						const T = (p[b] = L({ client: x, controller: d }));
						return (
							T.on('afterStore', async ({ controller: v }, P) => {
								v.log.debug('controller', v), v.log.debug('store', v.store.toJSON()), await P();
							}),
					...
					static search(d) {
						const b = d.id;
						if (p[b]) return p[b];
						const T = (p[b] = V({ client: x, controller: d }));
						return (
							T.on('afterStore', async ({ controller: v }, P) => {
								v.log.debug('controller', v), v.log.debug('store', v.store.toJSON()), await P();
							}),
				...
				function V(u) {
					const d = new g.V(new h.E({ settings: { coreType: 'query', corePrefix: u.controller.id } }), f.X);
					return new m.Tp(u.controller, {
						client: new t.K(u.client.globals, u.client.config),
						store: new n.U(u.controller, { urlManager: d }),
						urlManager: d,
						eventManager: new q.E(),
						profiler: new y.U(),
						logger: new M.V(),
						tracker: new S.J(u.client.globals),
					});
				}
				function U(u) {
					const d = new g.V(new h.E(), f.X).detach(!0);
					return new a.c(u.controller, {
						client: new t.K(u.client.globals, u.client.config),
						store: new o.t(u.controller, { urlManager: d }),
						urlManager: d,
						eventManager: new q.E(),
						profiler: new y.U(),
						logger: new M.V(),
				...
				function L(u) {
					const d = new g.V(new h.E(), f.X).detach();
					return new c.Z(u.controller, {
						client: new t.K(u.client.globals, u.client.config),
						store: new s.Y(u.controller, { urlManager: d }),
						urlManager: d,
						eventManager: new q.E(),
						profiler: new y.U(),
						logger: new M.V(),
			...
			'./components/src/utilities/storybook.tsx'(z, i, e) {
				'use strict';
				var r = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const c = 'prism-block',
					a = (t) => {
						...
						return (
							(0, m.vJ)(() => {
								s.current && t.className?.includes('lang-') && !t.className?.includes(c) && window?.Prism?.highlightElement(s.current);
			...
			'../../node_modules/colord/plugins/names.mjs'(z, i, e) {
				'use strict';
				e.d(i, { A: () => r }), e.dn(r);
				function r(m, c) {
					var a = {
						...
						t = {};
					for (var s in a) t[a[s]] = s;
					var n = {};
					(m.prototype.toName = function (o) {
						...
						if (o?.closest) {
							var q = this.toRgb(),
								y = 1 / 0,
								M = 'black';
							if (!n.length) for (var S in a) n[S] = new m(a[S]).toRgb();
							for (var p in a) {
								var x = ((g = q), (f = n[p]), Math.pow(g.r - f.r, 2) + Math.pow(g.g - f.g, 2) + Math.pow(g.b - f.b, 2));
								x < y && ((y = x), (M = p));
							}
							return M;
						}
						...
						c.string.push([
							function (o) {
								var g = o.toLowerCase(),
									f = g === 'transparent' ? '#0000' : a[g];
								return f ? new m(f).toRgb() : null;
							},
							'name',
						]);
				}
			},
			'../../node_modules/dequal/dist/index.mjs'(z, i, e) {
				'use strict';
				e.d(i, { j: () => c });
				var r = Object.prototype.hasOwnProperty;
				function m(a, t, s) {
					for (s of a.keys()) if (c(s, t)) return s;
				}
				function c(a, t) {
					var s, n, o;
					if (a === t) return !0;
					if (a && t && (s = a.constructor) === t.constructor) {
						if (s === Date) return a.getTime() === t.getTime();
						if (s === RegExp) return a.toString() === t.toString();
						if (s === Array) {
							if ((n = a.length) === t.length) for (; n-- && c(a[n], t[n]); );
							return n === -1;
						}
						if (s === Set) {
							if (a.size !== t.size) return !1;
							for (n of a) if (((o = n), (o && typeof o == 'object' && ((o = m(t, o)), !o)) || !t.has(o))) return !1;
							return !0;
						}
						if (s === Map) {
							if (a.size !== t.size) return !1;
							for (n of a) if (((o = n[0]), (o && typeof o == 'object' && ((o = m(t, o)), !o)) || !c(n[1], t.get(o)))) return !1;
							return !0;
						}
						if (s === ArrayBuffer) (a = new Uint8Array(a)), (t = new Uint8Array(t));
						else if (s === DataView) {
							if ((n = a.byteLength) === t.byteLength) for (; n-- && a.getInt8(n) === t.getInt8(n); );
							return n === -1;
						}
						if (ArrayBuffer.isView(a)) {
							if ((n = a.byteLength) === t.byteLength) for (; n-- && a[n] === t[n]; );
							return n === -1;
						}
						if (!s || typeof a == 'object') {
							n = 0;
							for (s in a) if ((r.call(a, s) && ++n && !r.call(t, s)) || !(s in t) || !c(a[s], t[s])) return !1;
			...
			'../../node_modules/memoizerific sync recursive'(z) {
				...
				(i.keys = () => []), (i.resolve = i), (i.id = '../../node_modules/memoizerific sync recursive'), (z.exports = i);
			},
		},
	]);
})();

//# sourceMappingURL=components-Molecules-VariantSelection-VariantSelection-stories.04b94372.iframe.bundle.js.map
