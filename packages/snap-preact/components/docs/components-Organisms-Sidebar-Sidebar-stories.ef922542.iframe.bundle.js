(() => {
  ...
  return <Sidebar {...args} controller={controller} />;
			...
			'../../node_modules/colord/plugins/names.mjs'(W, y, e) {
				'use strict';
				e.d(y, { A: () => t }), Object.defineProperty(t, 'name', { value: 'default', configurable: !0 });
				function t(c, D) {
					var S = {
							white: '#ffffff',
							bisque: '#ffe4c4',
...
//# sourceMappingURL=components-Organisms-Sidebar-Sidebar-stories.ef922542.iframe.bundle.js.map
