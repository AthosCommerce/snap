(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[2271],
		{
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/fieldNameToComponentName/fieldNameToComponentName.js'(D, c, e) {
				'use strict';
				e.d(c, { P: () => t });
				const t = (u) => u.replace(/_/g, '-').toLowerCase();
			},
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.stories.tsx'(D, c, e) {
				'use strict';
				e.r(c), e.d(c, { Dropdown: () => p, List: () => g, Swatches: () => M, __namedExportsOrder: () => z, default: () => _ });
				...
				const _ = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, t.FD)('div', {
										children: [(0, t.Y)(m.oz, { options: { overrides: { code: s.Z } }, children: o }), (0, t.Y)(m.uY, { story: m.h1 })],
									}),
							},
						},
						decorators: [(d) => (0, t.Y)(d, {})],
						argTypes: {
							selection: {
					...
					h = (0, u.PA)(({ args: d }) =>
						(0, t.Y)('div', { style: { maxWidth: d?.type == 'list' ? '500px' : '300px' }, children: (0, t.Y)(a.m, { ...d }) })
					),
					g = (d) => (0, t.Y)(h, { args: d }),
					M = (d) => (0, t.Y)(h, { args: d }),
					y = [
            ...
            rgba(255, 0, 0, 1) 100%
					...
					L = { id: 'searchVariants', globals: { siteId: 'atkzs2' } },
					x = i.p.search(L),
					p = (d, { loaded: {} }) =>
						(0, t.Y)('div', { style: { maxWidth: d?.type == 'list' ? '500px' : '300px' }, children: (0, t.Y)(a.m, { ...d }) });
				(p.loaders = [
					async () => (
						x.on('afterSearch', async ({ response: d }, V) => {
							d.results?.length &&
								(d.results[0].attributes.ss_variants =
  ...
  return <div style={{
    maxWidth: args?.type == 'list' ? '500px' : '300px'
			...
			'./components/src/components/Molecules/List/List.tsx'(D, c, e) {
				'use strict';
				e.d(c, { B: () => Y });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				function Y(r) {
					const v = (0, h.u)(),
						...
						{ overrideElement: O, shouldRenderDefault: q } = (0, d._)('list', l);
					if (!q) return O;
					let A = l.selected;
					const W = {
							checkbox: { native: R, ...(0, M.s)({ disableStyles: B }), theme: l?.theme, treePath: U },
							icon: { internalClassName: 'ss__list__option__icon', size: '16px', ...(0, M.s)({ disableStyles: B }), theme: l?.theme, treePath: U },
						},
						te = (0, L.Z)(l, I);
					...
					const ae = (b, S) => {
							let T;
							X
								? C.find((F) => F.value === S.value)
									? ((T = [...C]),
									  T.splice(
											T.findIndex((F) => F.value === S.value),
											1
									  ),
									  T.length == 0 && k && (T = [S]))
									: (T = [...C, S])
								: !k && C.find((F) => F.value === S.value)
								? (T = [])
								: (T = [S]),
								Z && Z(b, S, T),
								$(T);
						...
						ne = {},
						ee = o()(ne, l.lang || {}),
						oe = (0, z.u)(ee, { options: N, selectedOptions: C });
					return typeof N == 'object' && N?.length
						? (0, t.Y)(_._, {
								children: (0, t.FD)('div', {
									...te,
									className: s()('ss__list', { 'ss__list--native': R, 'ss__list--disabled': K }, H, Q),
									children: [
										(f || ee?.title?.value) && !j && (0, t.Y)('h5', { className: 'ss__list__title', ...oe.title?.all, children: f }),
										(0, t.Y)('ul', {
											className: 'ss__list__options',
											role: 'listbox',
											'aria-label': f,
											children: N.map((b) => {
												const S = C.some((T) => T.value == b.value);
												return (0, t.FD)('li', {
													className: s()(`ss__list__option ss__list__option--${i.p(b.value?.toString())}`, {
														'ss__list__option--selected': S,
														'ss__list__option--disabled': b?.disabled,
														'ss__list__option--unavailable': b?.available === !1,
													}),
													ref: (T) => (0, p.iy)(T),
													onClick: (T) => !K && !b?.disabled && ae(T, b),
													title: b.label,
													role: 'option',
													'aria-selected': S,
													'aria-disabled': b.disabled || b?.available === !1,
													children: [
														!J && (0, t.Y)(x.S, { ...W.checkbox, checked: S, disableA11y: !0, 'aria-label': b.label }),
														b.icon && !w && (0, t.Y)(V.I, { ...W.icon, ...(typeof b.icon == 'string' ? { icon: b.icon } : b.icon) }),
														!G && (b.label || !b.icon) && (0, t.Y)('label', { className: 'ss__list__option__label', children: b.label || b.value }),
													],
												});
											}),
										}),
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.tsx'(D, c, e) {
				'use strict';
				e.d(c, { m: () => Y });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					u = e('../../node_modules/mobx-react-lite/es/index.js'),
				...
				const V = () =>
					...
					Y = (0, u.PA)((r) => {
						const v = (0, o.u)(),
							P = (0, i.LU)(),
							E = { name: (0, d.P)(r.selection.field), treePath: P },
							l = (0, h.v6)('variantSelection', v, E, r),
							{ selection: f, onSelect: Z, disableStyles: R, className: X, internalClassName: G, treePath: w } = l,
							{ overrideElement: J, shouldRenderDefault: K } = (0, z._)('variantSelection', l);
						if (!K) return J;
						let j = l.type;
						j || (f.type == 'swatch' ? (j = 'swatches') : (j = 'dropdown'));
						const N = (U, O) => {
								Z && Z(U, O), f.select(O.value);
							},
							k = {
								dropdown: {
							...
							H = (0, g.Z)(l, I),
							Q = (U) => {
								const { toggleOpen: O } = U;
								return (0, t.Y)('ul', {
									...H,
									className: 'ss__variant-selection__options',
									ref: (q) => (0, p.iy)(q, -1, !0, () => O()),
									children: f.values.map((q) => {
										const A = f.selected?.value == q.value;
										return (0, t.Y)('li', {
											className: s()('ss__variant-selection__option', {
												'ss__variant-selection__option--selected': A,
												'ss__variant-selection__option--disabled': q.disabled,
												'ss__variant-selection__option--unavailable': q.available === !1,
											}),
											onClick: (W) => !q.disabled && N(W, q),
											ref: (W) => (0, p.iy)(W),
											'aria-selected': A,
											'aria-disabled': q.disabled || q.available === !1,
											children: q.label,
										});
									}),
								});
						...
						return f.values.length
							? (0, t.Y)(n._, {
									children: (0, t.Y)('div', {
										...B,
										className: s()('ss__variant-selection', `ss__variant-selection--${j}`, `ss__variant-selection--${f.field}`, X, G),
										children: (() => {
											switch (j) {
												case 'dropdown':
													return (0, t.Y)(t.FK, {
																...
																return (0, t.FD)(t.FK, {
																	children: [
																		(0, t.FD)('div', {
																			...
																			children: [
																				(0, t.Y)('span', { className: 'ss__dropdown__button-wrapper__label', children: f.label }),
																				f.selected
																					? (0, t.FD)('span', {
																							className: 'ss__dropdown__button-wrapper__selection',
																							children: ['(', f.selected.value, ')'],
																					  })
																					: null,
																			],
																		}),
																		(0, t.Y)(x.I, { icon: q ? 'angle-up' : 'angle-down', ...k.icon, treePath: O.treePath }),
																	],
																});
															};
															return (0, t.Y)(L.m, { button: (0, t.Y)(U, { treePath: w }), ...k.dropdown, content: (0, t.Y)(Q, {}) });
														})(),
													});
												case 'list':
													return (0, t.Y)(t.FK, { children: (0, t.Y)(M.B, { ...k.list, options: f.values }) });
												case 'swatches':
													return (0, t.Y)(t.FK, { children: (0, t.Y)(y.l, { ...k.swatches, options: f.values }) });
											}
										})(),
									}),
							  })
			...
			'./components/src/utilities/snapify.ts'(D, c, e) {
				...
				var t = e('../../node_modules/mobx/dist/mobx.esm.js'),
					...
					L = e('../../node_modules/@athoscommerce/snap-logger/dist/esm/Logger.js'),
				...
				class d {
					static recommendation(v) {
						const P = v.id;
						if (p[P]) return p[P];
						const E = (p[P] = I({ client: z, controller: v }));
						return (
							E.on('afterStore', async ({ controller: l }, f) => {
								l.log.debug('controller', l), l.log.debug('store', l.store.toJSON()), await f();
							}),
							E.init(),
							E
						);
					...
					static autocomplete(v) {
						const P = v.id;
						if (p[P]) return p[P];
						const E = (p[P] = Y({ client: z, controller: v }));
						return (
							E.on('afterStore', async ({ controller: l }, f) => {
								l.log.debug('controller', l), l.log.debug('store', l.store.toJSON()), await f();
							}),
					...
					static search(v) {
						const P = v.id;
						if (p[P]) return p[P];
						const E = (p[P] = V({ client: z, controller: v }));
						return (
							E.on('afterStore', async ({ controller: l }, f) => {
								l.log.debug('controller', l), l.log.debug('store', l.store.toJSON()), await f();
							}),
				...
				function V(r) {
					const v = new _.V(new g.E({ settings: { coreType: 'query', corePrefix: r.controller.id } }), h.X);
					return new u.Tp(r.controller, {
						client: new s.K(r.client.globals, r.client.config),
						store: new o.U(r.controller, { urlManager: v }),
						urlManager: v,
				...
				function I(r) {
					const v = new _.V(new g.E(), h.X).detach(!0);
					return new a.c(r.controller, {
						client: new s.K(r.client.globals, r.client.config),
						store: new i.t(r.controller, { urlManager: v }),
						urlManager: v,
						eventManager: new M.E(),
						profiler: new y.U(),
						logger: new L.V(),
				...
				function Y(r) {
					const v = new _.V(new g.E(), h.X).detach();
					return new m.Z(r.controller, {
						client: new s.K(r.client.globals, r.client.config),
						store: new n.Y(r.controller, { urlManager: v }),
						urlManager: v,
						eventManager: new M.E(),
						profiler: new y.U(),
						logger: new L.V(),
			...
			'./components/src/utilities/storybook.tsx'(D, c, e) {
				...
				const m = 'prism-block',
					a = (s) => {
						...
						return (
							(0, u.vJ)(() => {
								n.current && s.className?.includes('lang-') && !s.className?.includes(m) && window?.Prism?.highlightElement(n.current);
			...
			'../../node_modules/colord/plugins/names.mjs'(D, c, e) {
				'use strict';
				e.d(c, { A: () => t }), Object.defineProperty(t, 'name', { value: 'default', configurable: !0 });
				function t(u, m) {
					var a = {
							white: '#ffffff',
							bisque: '#ffe4c4',
					...
					(u.prototype.toName = function (i) {
						...
						if (i?.closest) {
							var M = this.toRgb(),
								y = 1 / 0,
								L = 'black';
							if (!o.length) for (var x in a) o[x] = new u(a[x]).toRgb();
							for (var p in a) {
								var z = ((_ = M), (h = o[p]), Math.pow(_.r - h.r, 2) + Math.pow(_.g - h.g, 2) + Math.pow(_.b - h.b, 2));
								z < y && ((y = z), (L = p));
							}
							return L;
						}
						...
						m.string.push([
							function (i) {
								...
								return h ? new u(h).toRgb() : null;
							},
							'name',
						]);
				}
			},
			'../../node_modules/dequal/dist/index.mjs'(D, c, e) {
				'use strict';
				e.d(c, { j: () => m });
				var t = Object.prototype.hasOwnProperty;
				function u(a, s, n) {
					for (n of a.keys()) if (m(n, s)) return n;
				}
				function m(a, s) {
					var n, o, i;
					if (a === s) return !0;
					if (a && s && (n = a.constructor) === s.constructor) {
						...
						if (n === Array) {
							if ((o = a.length) === s.length) for (; o-- && m(a[o], s[o]); );
							return o === -1;
						}
						if (n === Set) {
							if (a.size !== s.size) return !1;
							for (o of a) if (((i = o), (i && typeof i == 'object' && ((i = u(s, i)), !i)) || !s.has(i))) return !1;
							return !0;
						}
						if (n === Map) {
							if (a.size !== s.size) return !1;
							for (o of a) if (((i = o[0]), (i && typeof i == 'object' && ((i = u(s, i)), !i)) || !m(o[1], s.get(i)))) return !1;
							return !0;
						}
						...
						if (!n || typeof a == 'object') {
							o = 0;
							for (n in a) if ((t.call(a, n) && ++o && !t.call(s, n)) || !(n in s) || !m(a[n], s[n])) return !1;
...
//# sourceMappingURL=components-Molecules-VariantSelection-VariantSelection-stories.0b6ebb85.iframe.bundle.js.map
