(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[5497],
		{
			'./components/src/components/Templates/SearchCollapsible/SearchCollapsible.stories.tsx'(g, n, e) {
				'use strict';
				e.r(n), e.d(n, { Default: () => d, NoResults: () => u, __namedExportsOrder: () => S, default: () => C });
				...
				const C = {
					...
					E = l.p.search({ id: 'Search', globals: { siteId: 'atkzs2' } }),
					T = l.p.search({ id: 'Search-noResults', globals: { siteId: 'atkzs2', search: { query: { string: 'eijworhufsbgd' } } } }),
					d = (h, { loaded: { controller: y } }) => (0, t.Y)(f.x, { ...h, controller: y });
				d.loaders = [async () => (await E.search(), { controller: E })];
				const u = (h, { loaded: { controller: y } }) => (0, t.Y)(f.x, { ...h, controller: y });
  ...
  return <SearchCollapsible {...args} controller={controller} />;
			...
			'./components/src/components/Templates/SearchCollapsible/SearchCollapsible.tsx'(g, n, e) {
				'use strict';
				e.d(n, { x: () => l });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const l = (0, c.PA)((m) => (0, t.Y)(_._, { children: (0, t.Y)(b.v, { ...m, alias: 'searchCollapsible' }) }));
			},
				...
				const E = { ResultTracker: () => (0, c.AH)({}) },
					T = (0, _.PA)((d) => {
						const u = (0, m.u)(),
							...
							{ children: y, result: p, track: M, controller: P, className: D, internalClassName: v, disableStyles: x, style: o } = S,
							r = { ...h, ...M },
							{ ref: a, inViewport: i } = (0, C.Q)();
						i && r.impression && P?.track.product.impression(p);
						const s = {};
						return (
							x ? o && (s.css = [o]) : (s.css = [E.ResultTracker(), o]),
							(0, t.Y)('div', {
								className: l()('ss__result-tracker', `ss__${P?.type}-result-tracker`, D, v),
								onClick: (O) => {
									r.click && P?.track.product.click(O, p);
								},
								ref: a,
								...s,
								children: y,
			...
			'./components/src/utilities/snapify.ts'(g, n, e) {
				...
				class P {
					static recommendation(r) {
						const a = r.id;
						if (p[a]) return p[a];
						const i = (p[a] = v({ client: M, controller: r }));
						return (
					...
					static autocomplete(r) {
						const a = r.id;
						if (p[a]) return p[a];
						const i = (p[a] = x({ client: M, controller: r }));
						return (
							i.on('afterStore', async ({ controller: s }, O) => {
								s.log.debug('controller', s), s.log.debug('store', s.store.toJSON()), await O();
							}),
					...
					static search(r) {
						const a = r.id;
						if (p[a]) return p[a];
						const i = (p[a] = D({ client: M, controller: r }));
						return (
							i.on('afterStore', async ({ controller: s }, O) => {
								s.log.debug('controller', s), s.log.debug('store', s.store.toJSON()), await O();
							}),
				...
				function v(o) {
					...
					return new b.c(o.controller, {
						client: new l.K(o.client.globals, o.client.config),
						store: new C.t(o.controller, { urlManager: r }),
						urlManager: r,
						eventManager: new u.E(),
						profiler: new S.U(),
						logger: new h.V(),
			...
			'./components/src/utilities/storybook.tsx'(g, n, e) {
				...
				const _ = 'prism-block',
					b = (l) => {
						...
						return (
							(0, c.vJ)(() => {
								m.current && l.className?.includes('lang-') && !l.className?.includes(_) && window?.Prism?.highlightElement(m.current);
...
//# sourceMappingURL=components-Templates-SearchCollapsible-SearchCollapsible-stories.800eb11d.iframe.bundle.js.map
