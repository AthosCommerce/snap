				...
				const K = ({ native: D, color: P, backgroundColor: B, borderColor: S, theme: v }) =>
					...
					T = (0, a.PA)((D) => {
						...
						const H = { icon: { internalClassName: 'ss__button__icon', ...(0, i.s)({ disableStyles: G }), theme: v?.theme, treePath: O } },
							$ = {
								...(0, b.Z)(v, K),
								className: n()('ss__button', { 'ss__button--native': A, 'ss__button--disabled': k }, Y, N),
								disabled: k,
								onClick: (V) => !k && L && L(V),
								...R,
							},
				...
				function o(l, r) {
					...
					(l.prototype.toName = function (c) {
						...
						if (c?.closest) {
							...
							for (var f in n) {
								var x = ((p = g), (u = s[f]), Math.pow(p.r - u.r, 2) + Math.pow(p.g - u.g, 2) + Math.pow(p.b - u.b, 2));
								x < b && ((b = x), (m = f));
							}
							return m;
						}
...
//# sourceMappingURL=components-Molecules-Swatches-Swatches-stories.6f93ba18.iframe.bundle.js.map
