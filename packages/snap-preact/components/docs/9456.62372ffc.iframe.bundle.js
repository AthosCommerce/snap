...
(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9456],
		{
			'../../node_modules/@athoscommerce/snap-controller/dist/esm/Recommendation/RecommendationController.js'(M, u, i) {
				i.d(u, { c: () => w });
				var n = i('../../node_modules/deepmerge/dist/cjs.js'),
					...
					y = i('../../node_modules/@athoscommerce/snap-controller/dist/esm/types.js'),
					I = i('../../node_modules/@athoscommerce/snap-controller/dist/esm/utils/isClickWithinProductLink.js');
						...
						if (
								...
								try {
									...
									try {
										await this.eventManager.fire('afterStore', {
											controller: this,
											request: e,
											response: { meta: o, profile: d, results: p, responseId: l },
										});
									} catch (m) {
										if (m?.message == 'cancelled') {
							...
							(this.addToCart = async (e) => {
								...
								t.forEach((o) => {
									...
									t.length > 0 && (await this.eventManager.fire('addToCart', { controller: this, products: t }));
							}),
							!c.tag)
						)
			...
			'../../node_modules/@athoscommerce/snap-store-mobx/dist/esm/Recommendation/RecommendationStore.js'(M, u, i) {
				i.d(u, { t: () => c });
				var n = i('../../node_modules/mobx/dist/mobx.esm.js'),
					v = i('../../node_modules/deepmerge/dist/cjs.js'),
					g = i.n(v),
					b = i('../../node_modules/@athoscommerce/snap-store-mobx/dist/esm/Abstract/AbstractStore.js'),
					y = i('../../node_modules/@athoscommerce/snap-store-mobx/dist/esm/Search/Stores/SearchResultStore.js'),
					I = i('../../node_modules/@athoscommerce/snap-event-manager/dist/esm/EventManager.js');
				class k {
					constructor() {
						(this.items = []), (0, n.Gn)(this, { items: n.sH, price: n.EW, count: n.EW, msrp: n.EW }), (this.eventManager = new I.E());
					}
					on(r, ...s) {
