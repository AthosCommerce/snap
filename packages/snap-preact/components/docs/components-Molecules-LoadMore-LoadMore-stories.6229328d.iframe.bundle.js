	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9983],
		{
			'./components/src/components/Molecules/LoadMore/LoadMore.stories.tsx'(v, l, e) {
				'use strict';
				e.r(l), e.d(l, { Default: () => s, __namedExportsOrder: () => E, default: () => n });
			...
			'./components/src/hooks/useA11y.tsx'(v, l, e) {
				...
				function a(i, f, o, n) {
					...
					i &&
						!i.attributes?.[r] &&
						(i.setAttribute(r, !0),
						i.setAttribute('tabIndex', `${f || 0}`),
						i.addEventListener('keydown', (s) => {
							(s.code === 'Space' || s.code === 'Enter') && s.target === i && i.click();
						}),
						o &&
							i.addEventListener('keydown', function (s) {
								const E = i.querySelectorAll(m),
									P = E[0],
									M = E[E.length - 1];
								if (s.keyCode == c) {
									i.focus(), n && n(s), s.preventDefault(), s.stopPropagation();
									return;
								}
			...
			'./components/src/utilities/snapify.ts'(v, l, e) {
				...
				function B(d) {
					...
					return new r.Z(d.controller, {
						client: new a.K(d.client.globals, d.client.config),
						store: new i.Y(d.controller, { urlManager: u }),
						urlManager: u,
						eventManager: new E.E(),
						profiler: new P.U(),
						logger: new M.V(),
			...
			'./components/src/utilities/storybook.tsx'(v, l, e) {
				...
				const r = 'prism-block',
					m = (a) => {
						...
						return (
							(0, c.vJ)(() => {
								i.current && a.className?.includes('lang-') && !a.className?.includes(r) && window?.Prism?.highlightElement(i.current);
							}, [a.className, a.children, i]),
							(0, t.Y)('code', { ...a, ref: i, 'data-prismjs-copy': 'Copy' })
						);
					};
				e.d(l, ['Z', 0, m]);
			},
...
//# sourceMappingURL=components-Molecules-LoadMore-LoadMore-stories.6229328d.iframe.bundle.js.map
