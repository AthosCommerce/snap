		...
		[1116],
		{
			'./components/src/components/Organisms/BranchOverride/BranchOverride.tsx'(m, i, o) {
				var e = o('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					l = o.n(d),
					f = o('../../node_modules/preact/hooks/dist/hooks.module.js'),
					p = o('./components/src/components/Atoms/Icon/Icon.tsx'),
					...
					C = o('./components/src/hooks/useCustomComponentOverride.tsx');
				const I = ({ componentTheme: t }) =>
					...
					B = (t) => {
						const R = (0, D.u)(),
							...
							{ overrideElement: k, shouldRenderDefault: L } = (0, C._)('branchOverride', _);
						if (!L) return k;
						const u = {
								icon: {
							...
							[n, K] = (0, f.J0)(w ? 'darkTheme' : 'lightTheme'),
							[N, x] = (0, f.J0)(0);
						a && K('failureTheme');
						const U = (0, P.Z)({ ..._, componentTheme: s[n] }, I);
						return (b || a) && h
							? (0, e.FD)('div', {
									className: l()('ss__branch-override', s[n].class, { 'ss__branch-override--collapsed': N }, A, S),
									...U,
									onClick: (r) => {
										...
										(0, e.FD)('div', {
											...
											children: [
												...
												(0, e.Y)('div', {
													...
													children: (0, e.Y)(p.I, { size: '18px', color: s[n].top.close.fill, ...u.icon, icon: 'close-thin' }),
												}),
												(0, e.Y)('div', {
											...
											children: [
												(0, e.Y)('span', {
													...
													children: a
														? (0, e.FD)(e.FK, {
																children: [
																	(0, e.Y)(p.I, { size: '12px', color: s[n].bottom.branch.color, ...u.icon, icon: 'warn' }),
