	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[4055],
		{
			...
			'./components/src/components/Molecules/Result/Result.stories.tsx'(v, i, e) {
				'use strict';
				e.r(i), e.d(i, { Default: () => x, __namedExportsOrder: () => R, default: () => b, hideSections: () => u, truncateTitle: () => h });
				...
				const b = {
					...
					x = (d, { loaded: { controller: P } }) => {
						...
						return (
							...
							(0, s.Y)('div', { style: { maxWidth: d?.layout == 'list' ? '650px' : '300px' }, children: (0, s.Y)(o.Q, { ...d, result: C }) })
						);
					};
									...
									children: (0, s.FD)('article', {
										...
										children: [
											...
											(0, s.FD)('div', {
												...
												children: [
													!W && (0, s.Y)(C.W, { ...D.calloutBadge, controller: w }),
													!G &&
														(0, s.Y)('div', {
													...
													!re && O.variants?.selections.length
														? (0, s.Y)('div', {
																...
																children: O.variants?.selections.map((A) => (0, s.Y)(T.m, { ...D.variantSelection, type: A.type, selection: A })),
														  })
														: null,
													!oe &&
														(0, s.Y)('div', {
			...
			'./components/src/utilities/snapify.ts'(v, i, e) {
				...
				class C {
					static recommendation(p) {
						...
						return (
							M.on('afterStore', async ({ controller: T }, S) => {
				...
				function I(m) {
					const p = new g.V(new E.E({ settings: { coreType: 'query', corePrefix: m.controller.id } }), b.X);
				...
				function j(m) {
					const p = new g.V(new E.E(), b.X).detach(!0);
				...
				function k(m) {
					const p = new g.V(new E.E(), b.X).detach();
				...
				function s(l, o) {
					...
					(l.prototype.toName = function (c) {
						...
						if (c?.closest) {
							...
							for (var d in r) {
								var P = ((g = x), (b = a[d]), Math.pow(g.r - b.r, 2) + Math.pow(g.g - b.g, 2) + Math.pow(g.b - b.b, 2));
								P < u && ((u = P), (h = d));
							}
							return h;
						}
...
//# sourceMappingURL=components-Molecules-Result-Result-stories.53ce8365.iframe.bundle.js.map
