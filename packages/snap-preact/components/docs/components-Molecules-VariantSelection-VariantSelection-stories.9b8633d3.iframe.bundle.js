	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[2271],
		{
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.stories.tsx'(A, i, e) {
				'use strict';
				e.r(i), e.d(i, { Dropdown: () => u, List: () => T, Swatches: () => P, __namedExportsOrder: () => U, default: () => _ });
				...
				const I = ({ horizontal: d }) =>
					...
					b = (0, _.PA)((d) => {
						...
						const ne = (v, O) => {
							...
							oe = {},
							te = o()(oe, l.lang || {}),
							le = (0, m.u)(te, { options: N, selectedOptions: k }, { activeBreakpoint: h?.activeBreakpoint });
									...
									children: (0, t.FD)('div', {
										...
										children: [
											...
											(0, t.Y)('ul', {
												...
												'aria-label': C,
												children: N.map((v) => {
													const O = k.some((M) => M.value == v.value);
													return (0, t.FD)('li', {
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.tsx'(A, i, e) {
				...
				const R = () =>
					...
					I = (0, f.PA)((b) => {
						const d = (0, o.u)(),
							h = (0, r.LU)(),
							x = { name: (0, m.P)(b.selection.field), treePath: h },
							p = (0, g.v6)('variantSelection', d, x, b),
									...
									children: (0, t.Y)('div', {
										...
										children: (() => {
											switch (V) {
												...
												case 'list':
													return (0, t.Y)(t.FK, { children: (0, t.Y)(P.B, { ...N.list, options: l.values }) });
												case 'swatches':
			...
			'./components/src/utilities/snapify.ts'(A, i, e) {
				...
				class m {
					static recommendation(d) {
						const h = d.id;
						if (u[h]) return u[h];
						const x = (u[h] = W({ client: U, controller: d }));
						return (
					...
					static autocomplete(d) {
						const h = d.id;
						if (u[h]) return u[h];
						const x = (u[h] = I({ client: U, controller: d }));
						return (
							x.on('afterStore', async ({ controller: p }, l) => {
								p.log.debug('controller', p), p.log.debug('store', p.store.toJSON()), await l();
							}),
					...
					static search(d) {
						const h = d.id;
						if (u[h]) return u[h];
						const x = (u[h] = R({ client: U, controller: d }));
						return (
							x.on('afterStore', async ({ controller: p }, l) => {
								p.log.debug('controller', p), p.log.debug('store', p.store.toJSON()), await l();
							}),
				...
				function R(b) {
					const d = new _.V(new T.E({ settings: { coreType: 'query', corePrefix: b.controller.id } }), g.X);
				...
				function W(b) {
					const d = new _.V(new T.E(), g.X).detach(!0);
				...
				function I(b) {
					const d = new _.V(new T.E(), g.X).detach();
				...
				function t(f, c) {
					...
					(f.prototype.toName = function (r) {
						...
						if (r?.closest) {
							...
							for (var u in a) {
								var U = ((_ = P), (g = o[u]), Math.pow(_.r - g.r, 2) + Math.pow(_.g - g.g, 2) + Math.pow(_.b - g.b, 2));
								U < E && ((E = U), (z = u));
							}
							return z;
						}
						...
						c.string.push([
							function (r) {
								var _ = r.toLowerCase(),
									g = _ === 'transparent' ? '#0000' : a[_];
								return g ? new f(g).toRgb() : null;
							},
							'name',
						]);
				}
...
//# sourceMappingURL=components-Molecules-VariantSelection-VariantSelection-stories.9b8633d3.iframe.bundle.js.map
