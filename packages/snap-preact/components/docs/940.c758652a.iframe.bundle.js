		...
		[940],
		{
			...
			'./components/src/components/Molecules/Result/Result.tsx'(g, d, e) {
				var s = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					k = e('./components/src/components/Molecules/CalloutBadge/CalloutBadge.tsx'),
				...
				const G = () =>
					...
					L = (0, n.PA)(($) => {
						...
						const ue = (0, D.Z)(m, G),
							...
							pe = V()(fe, m.lang || {}),
							ge = (0, P.u)(pe, { result: _, controller: R }, { activeBreakpoint: I?.activeBreakpoint }),
						...
						return c
							? (0, s.Y)(f._, {
									children: (0, s.FD)('article', {
										...ue,
										className: r()('ss__result', `ss__result--${j}`, { 'ss__result--sale': se }, K, N),
										ref: de,
										children: [
											!J &&
												(0, s.Y)('div', {
											...
											(0, s.FD)('div', {
												...
												children: [
													!W && (0, s.Y)(k.W, { ...h.calloutBadge, controller: R }),
													!Q &&
														(0, s.Y)('div', {
													...
													!Z && he && c.price && c.price > 0
														...
														: null,
													(0, B.Y)(U, { result: _, treePath: v }),
													!oe && _.variants?.selections.length
														? (0, s.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: _.variants?.selections.map((C) => (0, s.Y)(H.m, { ...h.variantSelection, type: C.type, selection: C })),
														  })
														: null,
													!ne &&
														(0, s.Y)('div', {
															className: 'ss__result__add-to-cart-wrapper',
															children: (0, s.Y)(w.$, { ...h.button, ...ge.addToCartButtonText.all }),
														}),
												],
											}),
										],
			...
			'./components/src/components/Templates/RecommendationEmail/RecommendationEmail.tsx'(g, d, e) {
				...
				const T = { default: {}, mobile: {}, tablet: {}, desktop: {} },
					...
					Y = (0, n.PA)((A) => {
						const w = (0, u.u)(),
							z = (0, D.LU)(),
							V = { resultWidth: '240px', name: A.controller?.store?.profile?.tag?.toLowerCase(), treePath: z },
							P = (0, O.v6)('recommendationEmail', w, V, A),
							{ controller: x, results: H, resultWidth: G, treePath: L, disableStyles: $, internalClassName: I, className: F } = P,
							y = P.resultComponent,
							m = (0, M.uk)(),
							_ = typeof y == 'string',
							W = _ ? y : '',
							Q = m?.templates?.library.import.component.result || {},
							{ ComponentOverride: Z, shouldWaitForNamedOverride: J } = (0, b.x)(Q, _ ? W : void 0),
							U = _ ? Z : y,
							X = {
								result: { internalClassName: 'ss__recommendation-email__result', ...(0, p.s)({ disableStyles: $ }), theme: P?.theme, treePath: L },
							},
							E = (0, B.Z)(P, k),
							K = H || x?.store?.results || [];
						return K.length > 0
							? (0, s.Y)('div', {
									className: a()('ss__recommendation-email', F, I),
									...E,
									children: K.map((N, j) =>
										(0, s.Y)(
											'div',
				...
				function s(l, n) {
					...
					(l.prototype.toName = function (i) {
						...
						if (i?.closest) {
							...
							for (var b in o) {
								var T = ((f = B), (p = a[b]), Math.pow(f.r - p.r, 2) + Math.pow(f.g - p.g, 2) + Math.pow(f.b - p.b, 2));
								T < u && ((u = T), (M = b));
							}
							return M;
						}
