	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[1663],
		{
			...
			'./components/src/components/Molecules/OverlayResult/OverlayResult.stories.tsx'(E, i, e) {
				'use strict';
				e.r(i), e.d(i, { Default: () => C, __namedExportsOrder: () => B, default: () => T, hideSections: () => x, truncateTitle: () => c });
				var r = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					a = e('./components/src/components/Molecules/OverlayResult/OverlayResult.tsx'),
...
`,
					...
					m = n.p.search({ id: 'Result', globals: { siteId: 'atkzs2' } }),
					C = (h, { loaded: { controller: p } }) => {
						const _ = p?.store?.results[7];
						return (
							(_.display.mappings.core = { ..._.display.mappings.core, rating: 4.5 }),
							(0, r.Y)('div', { style: { maxWidth: '300px' }, children: (0, r.Y)(a.O, { ...h, result: _ }) })
						);
					};
				C.loaders = [async () => (await m.search(), { controller: m })];
				const x = (h, { loaded: { controller: p } }) => {
					const _ = p?.store?.results[7];
					return (
						(_.display.mappings.core = { ..._.display.mappings.core, rating: 4.5 }),
						(0, r.Y)('div', { style: { maxWidth: '300px' }, children: (0, r.Y)(a.O, { ...h, result: _ }) })
				...
				(x.loaders = [async () => (await m.search(), { controller: m })]), (x.args = { hideBadge: !0, hideTitle: !0, hidePricing: !0 });
  ...
  return <div style={{
    maxWidth: '300px'
			...
			'./components/src/components/Molecules/OverlayResult/OverlayResult.tsx'(E, i, e) {
				...
				const b = (N) => {
						const { overlayBackground: U, disableSlide: S } = N;
						return (0, o.AH)({
							position: 'relative',
							overflow: 'hidden',
					...
					M = (0, a.PA)((N) => {
						...
						const g = P?.display?.mappings.core || P?.mappings?.core,
							...
							R = {
								...
								button: {
									...
									onClick: (w) => {
										F(!0), V && V(w, P), L?.addToCart([P]), setTimeout(() => F(!1), ne);
									},
									...(0, c.s)({ disableStyles: A }),
									theme: y.theme,
									treePath: D,
						...
						const ue = (0, h.Z)(y, b),
							...
							pe = u()(me, y.lang || {}),
							_e = (0, f.u)(pe, { result: P, controller: L }, { activeBreakpoint: U?.activeBreakpoint }),
											...
											!G &&
												(0, r.Y)('div', {
													...
													children: (0, r.Y)('a', {
														...
														children: Y
															? (0, r.Y)(n._, { ...R.image })
															: (0, r.Y)(j.Q, { ...R.overlayBadge, controller: L, children: (0, r.Y)(n._, { ...R.image }) }),
													}),
												}),
											(0, r.FD)('div', {
															...
															children: [
																...
																!oe &&
																	(0, r.Y)('div', {
																		...
																		children: (0, r.Y)(W.$, { ...R.button, content: z, ..._e.addToCartButtonText.all }),
																	}),
															],
														}),
													}),
			...
			'./components/src/utilities/snapify.ts'(E, i, e) {
				...
				function k(u) {
					const f = new T.V(new C.E({ settings: { coreType: 'query', corePrefix: u.controller.id } }), m.X);
					return new l.Tp(u.controller, {
						client: new t.K(u.client.globals, u.client.config),
						store: new n.U(u.controller, { urlManager: f }),
						urlManager: f,
				...
				function W(u) {
					const f = new T.V(new C.E(), m.X).detach(!0);
				...
				function K(u) {
					const f = new T.V(new C.E(), m.X).detach();
			...
			'./components/src/utilities/storybook.tsx'(E, i, e) {
				...
				const a = 'prism-block',
					o = (t) => {
						...
						return (
							(0, l.vJ)(() => {
								s.current && t.className?.includes('lang-') && !t.className?.includes(a) && window?.Prism?.highlightElement(s.current);
					...
					(l.prototype.toName = function (d) {
						...
						if (d?.closest) {
							var x = this.toRgb(),
								c = 1 / 0,
								B = 'black';
							if (!n.length) for (var h in o) n[h] = new l(o[h]).toRgb();
							for (var p in o) {
								var _ = ((T = x), (m = n[p]), Math.pow(T.r - m.r, 2) + Math.pow(T.g - m.g, 2) + Math.pow(T.b - m.b, 2));
								_ < c && ((c = _), (B = p));
							}
							return B;
						}
			...
			'../../node_modules/dequal/dist/index.mjs'(E, i, e) {
				...
				function l(o, t, s) {
					for (s of o.keys()) if (a(s, t)) return s;
				}
				function a(o, t) {
					var s, n, d;
					if (o === t) return !0;
					if (o && t && (s = o.constructor) === t.constructor) {
						...
						if (s === Set) {
							...
							for (n of o) if (((d = n), (d && typeof d == 'object' && ((d = l(t, d)), !d)) || !t.has(d))) return !1;
							return !0;
						}
						if (s === Map) {
							if (o.size !== t.size) return !1;
							for (n of o) if (((d = n[0]), (d && typeof d == 'object' && ((d = l(t, d)), !d)) || !a(n[1], t.get(d)))) return !1;
							return !0;
						}
						...
						if (!s || typeof o == 'object') {
							n = 0;
							for (s in o) if ((r.call(o, s) && ++n && !r.call(t, s)) || !(s in t) || !a(o[s], t[s])) return !1;
...
//# sourceMappingURL=components-Molecules-OverlayResult-OverlayResult-stories.4e936989.iframe.bundle.js.map
