			...
			'./components/src/components/Organisms/Results/Results.tsx'(L, h, e) {
				...
				const O = ({ gapSize: M, columns: B }) =>
					...
					f = (0, i.PA)((M) => {
						...
						if (!(M.theme?.type == 'templates' || B?.type == 'templates')) {
...
//# sourceMappingURL=components-Organisms-Results-Results-stories.45c5d967.iframe.bundle.js.map
