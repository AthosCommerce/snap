...
(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[3475],
		{
			'./src/create/createFinderController.ts'(_, j, l) {
				l.r(j), l.d(j, { default: () => R });
				var L = l('../../node_modules/deepmerge/dist/cjs.js'),
					x = l.n(L),
					b = l('../../node_modules/@athoscommerce/snap-store-mobx/dist/esm/types.js'),
					F = l('../../node_modules/@athoscommerce/snap-controller/dist/esm/Abstract/AbstractController.js'),
					U = l('../../node_modules/@athoscommerce/snap-controller/dist/esm/utils/getParams.js'),
					T = l('../../node_modules/@athoscommerce/snap-controller/dist/esm/types.js');
				const B = {
					id: 'finder',
					beacon: { enabled: !0 },
				...
				class H extends F.r {
					...
					get params() {
						...
						return x()({ ...(0, U.j)(e) }, x()(d, this.config.globals));
					}
				}
				var O = l('../../node_modules/@athoscommerce/snap-client/dist/esm/Client/Client.js'),
					$ = l('../../node_modules/mobx/dist/mobx.esm.js'),
					C = l('../../node_modules/@athoscommerce/snap-toolbox/dist/esm/StorageStore/StorageStore.js'),
					K = l('../../node_modules/@athoscommerce/snap-store-mobx/dist/esm/Abstract/AbstractStore.js'),
					N = l('../../node_modules/@athoscommerce/snap-store-mobx/dist/esm/Search/Stores/SearchPaginationStore.js');
										...
										if (h?.hierarchyDelimiter)
											r.forEach((v, S) => {
												const w = f?.levels || h?.values[h?.values.length - 1]?.value.split(h.hierarchyDelimiter),
													...
													I = P(t.id, h.field);
												p.set(`${I}.${M.key}.values`, v.data), p.set(`${I}.${M.key}.selected`, v.selected);
												const A = new E({ config: M, services: i, stores: s, state: d, data: { id: t.id, facet: h } });
				...
				function P(n, e) {
					return `ss-finder-${n}.${e}`;
				}
				var z = l('../../node_modules/@athoscommerce/snap-store-mobx/dist/esm/Meta/MetaStore.js');
				class G extends K.K {
					constructor(e, t) {
						if (
							(super(e),
				...
				var V = l('../../node_modules/@athoscommerce/snap-url-manager/dist/esm/UrlManager/UrlManager.js'),
					W = l('../../node_modules/@athoscommerce/snap-url-manager/dist/esm/Translators/Url/UrlTranslator.js'),
					X = l('../../node_modules/@athoscommerce/snap-url-manager/dist/esm/linkers/react/react.js'),
					Q = l('../../node_modules/@athoscommerce/snap-event-manager/dist/esm/EventManager.js'),
					Y = l('../../node_modules/@athoscommerce/snap-profiler/dist/esm/Profiler.js'),
					Z = l('../../node_modules/@athoscommerce/snap-logger/dist/esm/Logger.js'),
					q = l('../../node_modules/@athoscommerce/snap-tracker/dist/esm/Tracker.js');
				const R = (n, e) => {
					const t = (e?.urlManager || new V.V(new W.E(n.url), X.X)).detach(!0);
					return (
						n.mode && n.client && ((n.client.config = n.client.config || {}), (n.client.config.mode = n.mode)),
						new H(
							n.controller,
							{
								client: e?.client || new O.K(n.client.globals, n.client.config),
								store: e?.store || new G(n.controller, { urlManager: t }),
								urlManager: t,
								eventManager: e?.eventManager || new Q.E(),
								profiler: e?.profiler || new Y.U(),
								logger: e?.logger || new Z.V({ mode: n.mode }),
								tracker: e?.tracker || new q.J(n.client.globals),
							},
							n.context
						)
					);
