					...
					R = (0, l.Bk)(
						(0, m.W)(
							(0, g.PA)((v) => {
								const M = (0, r.u)(),
									b = (0, E.LU)(),
									B = { layout: c.V.grid, width: 'auto', treePath: b },
									d = (0, u.v6)('inlineBanner', M, B, v),
									{ banner: _, className: D, internalClassName: y, disableA11y: T, layout: W, onClick: L } = d,
									{ overrideElement: K, shouldRenderDefault: V } = (0, O._)('inlineBanner', d);
								if (!V) return K;
								const J = (0, p.Z)(d, P);
								return _ && _.value
									? (0, s.Y)(t._, {
											children: (0, s.Y)('div', {
												...
												className: o()('ss__inline-banner', `ss__inline-banner--${W}`, D, y),
												...J,
				...
				const W = () =>
					...
					L = (0, n.PA)((K) => {
						const V = (0, u.u)(),
							...
							{ overrideElement: U, shouldRenderDefault: ie } = (0, y._)('result', {
								...x,
								customComponent: x.customComponent && x.customComponent !== 'Result' ? x.customComponent : void 0,
							});
						if (!ie) return U;
						const A = h?.display?.mappings.core || h?.mappings?.core,
							[ce, me] = (0, a.J0)(!1),
							k = {
								variantSelection: {
									internalClassName: 'ss__result__variant-selection',
									...(0, c.s)({ disableStyles: I }),
									theme: x.theme,
									treePath: S,
								},
								price: { internalClassName: 'ss__result__price', ...(0, c.s)({ disableStyles: I }), theme: x.theme, treePath: S },
								calloutBadge: {
								...
								image: {
									...
									alt: A?.name || '',
									src: A?.imageUrl || '',
									...(0, c.s)({ disableStyles: I, fallback: se }),
									theme: x.theme,
									treePath: S,
								},
								rating: {
								...
								button: {
									...
									onClick: (N) => {
										me(!0), Z && Z(N, h), j?.addToCart([h]), setTimeout(() => me(!1), X);
									},
									...(0, c.s)({ disableStyles: I }),
									theme: x.theme,
									treePath: S,
						...
						let de = A?.name;
						x.truncateTitle && (de = P.x(A?.name || '', x.truncateTitle.limit, x.truncateTitle.append));
						const _e = (0, O.Z)(x, W),
							pe = { addToCartButtonText: { value: ce ? Q : le } },
							fe = _()(pe, x.lang || {}),
							ge = (0, D.u)(fe, { result: h, controller: j }, { activeBreakpoint: V?.activeBreakpoint }),
							ue = !!(A?.msrp && A?.price && A?.price < A?.msrp),
							he = j?.store?.config?.asyncState?.product?.price ? h.state.priceFetched : !0;
						return A
							? (0, s.Y)(E._, {
									children: (0, s.FD)('article', {
										..._e,
										className: l()('ss__result', `ss__result--${ne}`, { 'ss__result--sale': ue }, G, Y),
										ref: ae,
										children: [
											!te &&
												(0, s.Y)('div', {
													...
													children: (0, s.Y)('a', {
														...
														children: H
															? (0, s.Y)(r._, { ...k.image })
															: (0, s.Y)(M.Q, { ...k.overlayBadge, controller: j, children: (0, s.Y)(r._, { ...k.image }) }),
													}),
												}),
											(0, s.FD)('div', {
												className: 'ss__result__details',
												children: [
													!H && (0, s.Y)(v.W, { ...k.calloutBadge, controller: j }),
													!q &&
														(0, s.Y)('div', {
													...
													!ee && he && A.price && A.price > 0
														? (0, s.Y)('div', {
																className: 'ss__result__details__pricing',
																children: ue
																	? (0, s.FD)(s.FK, {
																			children: [
																				(0, s.Y)(m.g, { ...k.price, value: A.msrp, lineThrough: !0, name: 'msrp' }),
																				'\xA0',
																				(0, s.Y)(m.g, { ...k.price, value: A.price, name: 'price' }),
																			],
																	  })
																	: (0, s.Y)(m.g, { ...k.price, value: A.price }),
														  })
														: null,
				...
				const y = ({ gapSize: L, columns: K }) =>
						(0, a.AH)({
							...
							'& .ss__result, & .ss__result-layout': {
								...
								flex: '0 1 auto',
								width: `calc(${100 / K}% - (${K - 1} * ${L} / ${K} ) )`,
								marginRight: L,
								marginBottom: L,
								[`&:nth-of-type(${K}n)`]: { marginRight: '0' },
								[`&:nth-last-of-type(-n+${K})`]: { marginBottom: '0' },
							},
					...
					W = (0, n.PA)((L) => {
						const K = (0, R.u)(),
							...
							x = { results: L.controller?.store?.results, columns: 4, gapSize: '20px', layout: p.V.grid, breakpoints: w, treePath: J };
						let h = (0, g.v6)('results', K, x, L);
						if (!(L.theme?.type == 'templates' || K?.type == 'templates')) {
							const U = (0, B.X)(h?.breakpoints || {}),
								ie = r()(h?.theme || {}, U?.theme || {}, { arrayMerge: (A, ce) => ce });
							h = { ...h, ...U, theme: ie };
						}
						const { disableStyles: H, className: q, internalClassName: ee, layout: te, theme: F, excludeBanners: se, controller: I, treePath: G } = h,
							Y = h.resultComponent,
							{ overrideElement: ne, shouldRenderDefault: $ } = (0, D._)('results', h);
						if (!$) return ne;
						const j = typeof Y == 'string',
							oe = j ? Y : '',
							re = V?.templates?.library.import.component.result || {},
							{ ComponentOverride: Z, shouldWaitForNamedOverride: le } = (0, _.x)(re, j ? oe : void 0),
							Q = j ? Z : Y,
							X = {
						...
						return z?.length
							? (0, s.Y)(P._, {
									children: (0, s.Y)('div', {
										...
										children: z.map((U) =>
											U.type === m.c.BANNER
												? (0, a.n)(E._, { ...X.inlineBanner, key: `${I?.id ? `${I?.id}-` : ''}${U.id}`, banner: U, layout: h.layout })
												: le
												? null
												: Q && I
												? (0, s.Y)(d.o, {
														result: U,
														controller: I,
														children: (0, f.Y)(Q, { key: `${I?.id ? `${I?.id}-` : ''}${U.id}`, controller: I, result: U, theme: S, treePath: G }),
												  })
												: (0, s.Y)(T, { ...X.result, result: U, layout: h.layout, controller: I }, `${I?.id ? `${I?.id}-` : ''}${U.id}`)
										),
									}),
							  })
							: null;
				...
				const E = { ResultTracker: () => (0, a.AH)({}) },
					u = (0, n.PA)((p) => {
						const f = (0, l.u)(),
							...
							{ children: O, result: P, track: R, controller: v, className: M, internalClassName: b, disableStyles: B, style: d } = c,
							_ = { ...g, ...R },
						...
						return (
							...
							(0, s.Y)('div', {
								...
								onClick: (W) => {
									_.click && v?.track.product.click(W, P);
								},
								ref: D,
								...T,
								children: O,
				...
				function t(l) {
					...
					return (E) => {
						...
						const { ref: P, inViewport: R, updateRef: v } = (0, a.Q)(),
							...
							b = (0, n.li)(M),
							B = (0, n.li)(!1);
						b.current !== M && (B.current = !0),
							(0, n.vJ)(() => {
								b.current !== M && ((b.current = M), v(P.current));
							}, [M, v]),
							(0, n.vJ)(() => {
								B.current && !R && (B.current = !1);
							}, [R, M]);
						const d = c && g && !p && ['search', 'autocomplete'].includes(u?.type || '');
						R && !B.current && (d ? u?.track.banner.impression(g[c][0]) : p?.bundleSeed || u?.track.product.impression(p || f));
						const _ = (0, n.hb)(
							(y) => {
			...
			'./components/src/utilities/snapify.ts'(C, i, e) {
				...
				class v {
					static recommendation(_) {
						...
						return (
							y.on('afterStore', async ({ controller: T }, W) => {
								T.log.debug('controller', T), T.log.debug('store', T.store.toJSON()), await W();
							}),
							y.init(),
							y
						);
...
//# sourceMappingURL=components-Organisms-Results-Results-stories.5402ec4f.iframe.bundle.js.map
