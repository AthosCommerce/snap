				...
				const _ = '//cdn.athoscommerce.net/snap/images/fallback.png',
					...
					B = (0, c.PA)((O) => {
						const I = (0, o.u)(),
							...
							{ overrideElement: ne, shouldRenderDefault: M } = (0, g._)('image', R);
						if (!M) return ne;
						const [Q, E] = (0, n.J0)(!1),
							[ae, $] = (0, n.J0)(!1),
							z = (0, n.li)('');
				...
				const se = ({ gapSize: C, columns: v, theme: j, disableOverflowAction: U }) =>
					...
					W = (0, s.PA)((C) => {
						...
						const ge = (i, y) => {
								if (H) {
									let w;
									q.find((x) => x.value === y.value)
										? ((w = [...q]),
										  w.splice(
												w.findIndex((x) => x.value === y.value),
												1
										  ))
										: (w = [...q, y]),
										A && A(i, y, w),
							...
							ee = X && Z ? Z * X : E.length,
							L = Math.max(0, E.length - (ee - (M ? 1 : 0))),
							[k, _e] = (0, a.J0)(!!L),
							le = () => {
								const i = ne ? k : !0,
									y = { showMoreText: { value: M ? `+ ${L}` : 'Show More' }, showLessText: { value: M ? `- ${L}` : 'Show Less' } },
									w = b()(y, P.lang || {}),
									x = (0, m.u)(w, { limited: k, remainder: L }, { activeBreakpoint: v?.activeBreakpoint });
								return i && L > 0 && E.length !== ee
									? (0, t.Y)('div', {
											...
											role: 'button',
											ref: (G) => (!de && !N ? (0, _.iy)(G) : null),
											...(k ? x.showMoreText.attributes : x.showLessText.attributes),
											children: J
											...
											(0, t.FD)('div', {
												...
												children: [
													E.map((i, y) => {
														...
														let x = !1;
														const G = i.background?.toLowerCase() || (i.backgroundImageUrl ? null : i.value.toString().toLowerCase());
														if (G)
															try {
																const D = (0, S.Mj)(G);
																D.isValid() && (x = D.isDark());
															} catch {}
														if (!k || E.length == ee || y < ee - (M ? 1 : 0))
															return (0, t.Y)('div', {
