			...
			'./components/src/components/Molecules/Result/Result.tsx'(P, c, e) {
				...
				const k = () =>
					...
					H = (0, o.PA)((J) => {
						...
						const T = I?.display?.mappings.core || I?.mappings?.core,
							...
							A = {
								...
								button: {
									...
									onClick: (w) => {
										Y(!0), N && N(w, I), U?.addToCart([I]), setTimeout(() => Y(!1), le);
									},
									...(0, d.s)({ disableStyles: j }),
									theme: y.theme,
									treePath: L,
						...
						let V = T?.name;
						y.truncateTitle && (V = h.x(T?.name || '', y.truncateTitle.limit, y.truncateTitle.append));
						const _e = (0, M.Z)(y, k),
							fe = { addToCartButtonText: { value: ue ? ae : ne } },
							pe = u()(fe, y.lang || {}),
							ge = (0, v.u)(pe, { result: I, controller: U }, { activeBreakpoint: K?.activeBreakpoint }),
							z = !!(T?.msrp && T?.price && T?.price < T?.msrp),
							he = U?.store?.config?.asyncState?.product?.price ? I.state.priceFetched : !0;
						return T
							? (0, s.Y)(_._, {
									children: (0, s.FD)('article', {
										..._e,
										className: n()('ss__result', `ss__result--${se}`, { 'ss__result--sale': z }, ee, te),
										ref: ie,
										children: [
											!F &&
												(0, s.Y)('div', {
											...
											(0, s.FD)('div', {
												...
												children: [
													!W && (0, s.Y)(E.W, { ...A.calloutBadge, controller: U }),
													!Z &&
														(0, s.Y)('div', {
...
//# sourceMappingURL=components-Trackers-ResultTracker-ResultTracker-stories.aed89802.iframe.bundle.js.map
