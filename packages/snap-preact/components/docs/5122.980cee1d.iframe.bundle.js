				...
				const D = ({ vertical: d, theme: L }) =>
					...
					M = (0, O.PA)((d) => {
						...
						let r = (0, h.v6)('carousel', L, A, d),
							g;
						if (
							!(d.theme?.type == 'templates' || L?.type == 'templates') &&
							r.breakpoints &&
							(Object.keys(r.breakpoints).forEach((t) => {
								const n = r.breakpoints[t];
								n.slidesPerView && (n.slidesPerView = Number(n.slidesPerView) || 1),
									n.slidesPerGroup && (n.slidesPerGroup = Number(n.slidesPerGroup) || 1);
							}),
							(g = (0, R.X)(r.breakpoints)),
							g && Object.keys(g).length)
						) {
							const t = u()(r?.theme || {}, g?.theme || {}, { arrayMerge: (n, ie) => ie });
							r.autoAdjustSlides &&
						...
						const te = { icon: { internalClassName: 'ss__carousel__icon', ...(0, y.s)({ disableStyles: de }), theme: r.theme, treePath: se } },
							oe = Array.isArray(q) ? [c.Vx, c.dK, c.Ze, c.Jq].concat(q) : [c.Vx, c.dK, c.Ze, c.Jq],
							ne = oe.filter((t, n) => oe.indexOf(t) === n),
							re = (0, l.li)(null),
							H = (0, l.li)(null),
							N = (0, l.li)(null),
							ue = (0, p.Z)(r, D);
						(0, l.vJ)(() => {
							if (N.current) {
								const n = N.current.querySelector('.swiper');
								n?.classList.add('swiper-container', 'swiper-container-pointer-events'),
									n?.classList.contains('swiper-vertical') && n.classList.add('swiper-container-vertical'),
									n?.classList.contains('swiper-horizontal') && n.classList.add('swiper-container-horizontal');
							}
							T();
						}, [d]),
						...
						const T = () => {
							if (N.current) {
								const n = N.current?.querySelectorAll('.swiper-slide-visible');
								n.forEach((ie, ve) => {
									ie.classList.remove('swiper-last-visible-slide'), ve == n.length - 1 && ie.classList.add('swiper-last-visible-slide');
								});
							}
						};
						return (
							...
							J?.length
								? (0, s.Y)(W._, {
										children: (0, s.FD)('div', {
											ref: N,
											...ue,
											className: o()('ss__carousel', Y ? 'ss__carousel-vertical' : '', me, ee),
											children: [
												(0, s.Y)('div', {
													className: o()('ss__carousel__prev-wrapper', { 'ss__carousel__prev-wrapper--hidden': F }),
													children: (0, s.Y)('div', {
												...
												(0, s.Y)(a.RC, {
													...
													onAfterInit: (t) => {
														(t.navigation.onPrevClick = (n) => {
															n.preventDefault(), !(t.isBeginning && !t.params.loop && !t.params.rewind) && (t.slidePrev(), t.emit('navigationPrev'));
														}),
															(t.navigation.onNextClick = (n) => {
																n.preventDefault(), !(t.isEnd && !t.params.loop && !t.params.rewind) && (t.slideNext(), t.emit('navigationNext'));
															}),
															Q && Q(t);
													},
													onClick: (t, n) => {
												...
												(0, s.Y)('div', {
													className: o()('ss__carousel__next-wrapper', { 'ss__carousel__next-wrapper--hidden': F }),
													children: (0, s.Y)('div', {
				...
				const U = ({ vertical: M }) => (0, m.AH)({ height: M ? '100%' : void 0, '.ss__result__image-wrapper': { height: M ? '85%' : void 0 } }),
					V = (0, O.PA)((M) => {
						...
						let A = (0, p.v6)('recommendation', d, le, ae),
							r;
						!(M.theme?.type == 'templates' || d?.type == 'templates') &&
							A.breakpoints &&
							((r = (0, f.X)(A.breakpoints)), r && Object.keys(r).length && (A = { ...A, ...r }));
						const {
								title: g,
								description: J,
								controller: E,
						...
						const b = {
							...
							[te, oe] = (0, l.J0)(!1),
							ne = (0, l.li)(null);
						(!K?.enabled || (0, B.v)(ne, `${K.offset} 0px ${K.offset} 0px`, !0)) && oe(!0);
						...
						return (Array.isArray(C) && C.length) || I?.length
							? (0, s.Y)(W._, {
									children: (0, s.Y)('div', {
										...k,
										className: o()('ss__recommendation', X, de),
										ref: ne,
										children: te
											? (0, s.FD)(R.l, {
													controller: E,
				...
				const a = { ResultTracker: () => (0, l.AH)({}) },
					x = (0, m.PA)((y) => {
						...
						return (
							...
							(0, s.Y)('div', {
								className: o()('ss__result-tracker', `ss__${i?.type}-result-tracker`, f, R),
								onClick: (L) => {
					...
					return (
						(0, s.vJ)(() => {
							const u = new IntersectionObserver(
								([a]) => {
									v(a.isIntersecting), o && a.isIntersecting && u.unobserve(m.current);
								},
								{ rootMargin: P }
							);
							return (
						...
						return (
							(0, s.vJ)(() => {
										...
										x > 0
											? ((c.current = Date.now()),
											  ...
											  (p.current = window.setTimeout(() => {
													h(!0), u && o.current && i && i.unobserve(o.current);
											  }, x)))
											: (h(!0), u && o.current && i && i.unobserve(o.current));
									},
									D = () => {
								...
								return (
									...
									() => {
										h(!1), R(), p.current && window.clearTimeout(p.current), i && o.current && i.unobserve(o.current);
									}
								);
							}, [o, B]),
