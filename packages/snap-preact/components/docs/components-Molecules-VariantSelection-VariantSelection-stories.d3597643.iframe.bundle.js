	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[2271],
		{
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.stories.tsx'(A, i, e) {
				'use strict';
				e.r(i), e.d(i, { Dropdown: () => u, List: () => g, Swatches: () => P, __namedExportsOrder: () => U, default: () => _ });
				...
				const I = ({ horizontal: d }) =>
					...
					b = (0, _.PA)((d) => {
						...
						const ne = (v, O) => {
							...
							oe = {},
							te = o()(oe, l.lang || {}),
							le = (0, m.u)(te, { options: N, selectedOptions: C });
						return typeof N == 'object' && N?.length
							? (0, t.Y)(h._, {
									children: (0, t.FD)('div', {
										...
										children: [
											(k || te?.title?.value) && !Y && (0, t.Y)('h5', { className: 'ss__list__title', ...le.title?.all, children: k }),
											(0, t.Y)('ul', {
												className: 'ss__list__options',
												role: 'listbox',
												'aria-label': k,
												children: N.map((v) => {
													const O = C.some((M) => M.value == v.value);
													return (0, t.FD)('li', {
				...
				const R = () =>
					...
					I = (0, f.PA)((b) => {
						const d = (0, o.u)(),
							...
							{ selection: l, onSelect: k, disableStyles: w, className: K, internalClassName: G, treePath: j } = p,
							{ overrideElement: J, shouldRenderDefault: H } = (0, U._)('variantSelection', p);
						if (!H) return J;
						let V = p.type;
						V || (l.type == 'swatch' ? (V = 'swatches') : (V = 'dropdown'));
						const Y = (D, q) => {
								k && k(D, q), l.select(q.value);
							},
							N = {
								dropdown: {
				...
				function t(f, c) {
					...
					(f.prototype.toName = function (r) {
						...
						if (r?.closest) {
							...
							for (var u in a) {
								var U = ((_ = P), (h = o[u]), Math.pow(_.r - h.r, 2) + Math.pow(_.g - h.g, 2) + Math.pow(_.b - h.b, 2));
								U < E && ((E = U), (z = u));
							}
							return z;
						}
...
//# sourceMappingURL=components-Molecules-VariantSelection-VariantSelection-stories.d3597643.iframe.bundle.js.map
