	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[6356],
		{
					...
					S = (0, o.PA)((q) => {
						const $ = (0, f.u)(),
							...
							u = (0, C.v6)('result', $, d, q),
							{
								...
								addToCartButtonSuccessTimeout: h,
								hideRating: ie,
							...
							{ overrideElement: O, shouldRenderDefault: de } = (0, z._)('result', {
								...u,
						...
						const p = P?.display?.mappings.core || P?.mappings?.core,
							...
							x = {
								variantSelection: {
									...
									...(0, m.s)({ disableStyles: E }),
									theme: u.theme,
									treePath: k,
								},
								price: { internalClassName: 'ss__result__price', ...(0, m.s)({ disableStyles: E }), theme: u.theme, treePath: k },
								calloutBadge: {
								...
								image: {
									...
									alt: p?.name || '',
									src: p?.imageUrl || '',
									...(0, m.s)({ disableStyles: E, fallback: J }),
									theme: u.theme,
									treePath: k,
								},
								rating: {
								...
								button: {
									...
									onClick: (W) => {
										_e(!0), H && H(W, P), L?.addToCart([P]), setTimeout(() => _e(!1), h);
									},
									...(0, m.s)({ disableStyles: E }),
									theme: u.theme,
									treePath: k,
						...
						const ge = (0, R.Z)(u, y),
							he = { addToCartButtonText: { value: me ? le : Q }, quickviewButtonText: { attributes: { 'aria-label': 'Quick View' } } },
							Ee = K()(he, u.lang || {}),
							fe = (0, V.u)(Ee, { result: P, controller: L }, { activeBreakpoint: $?.activeBreakpoint }),
				...
				const z = ({ gapSize: y, columns: S }) =>
					...
					j = (0, l.PA)((y) => {
						...
						if (!(y.theme?.type == 'templates' || S?.type == 'templates')) {
							const O = (0, g.X)(d?.breakpoints || {}),
								de = r()(d?.theme || {}, O?.theme || {}, { arrayMerge: (p, me) => me });
							d = { ...d, ...O, theme: de };
						}
						const {
								disableStyles: u,
						...
						let h = d.results || E.store.results;
						if (!d.columns && !d.rows) (d.rows = 1), (d.columns = h.length);
						else if (d.columns && !d.rows) {
							if (((d.rows = Math.floor(h.length / d.columns)), G)) {
								const O = h.length % d.columns;
								h = h.slice(0, h.length - O);
							}
						} else if (d.rows && !d.columns) {
							if (G) {
								const O = h.length % d.rows;
								h = h.slice(0, h.length - O);
							}
								...
								? (0, s.Y)(C._, {
										children: (0, s.Y)('div', {
											...
											children: ce
																...
																children: h.map((O) =>
																	H && E
																		...
																		: (0, s.Y)(I.o, {
																				result: O,
																				controller: E,
																				children: (0, s.Y)(i.Q, { ...le.result, result: O, controller: E, treePath: F }, O.id),
																		  })
																),
															}),
														],
												...
												: (0, s.Y)(T.l, {
														controller: E,
														children: h.map((O) => (0, s.Y)(I.o, { controller: E, result: O, children: (0, s.Y)(s.FK, {}) })),
												  }),
										}),
								  })
								: null
			...
			'./components/src/components/Trackers/Recommendation/ProfileTracker/RecommendationProfileTracker.tsx'(v, c, e) {
				...
				const i = () => (0, o.AH)({}),
					_ = (0, n.PA)((f) => {
						const { children: D, className: M, internalClassName: m } = f,
							C = (0, l.v2)(D),
							R = (0, r.Z)(f, i);
						return C.length ? (0, s.Y)('div', { className: a()('ss__recommendation-profile-tracker', M, m), ...R, children: D }) : null;
					});
				e.d(c, ['l', 0, _]);
			},
			'./components/src/components/Trackers/ResultTracker/ResultTracker.tsx'(v, c, e) {
				...
				const _ = { ResultTracker: () => (0, l.AH)({}) },
					f = (0, o.PA)((D) => {
						const M = (0, a.u)(),
							m = (0, r.v6)('resultTracker', M, {}, D),
							C = { impression: !0, click: !0 },
							{ children: R, result: b, track: B, controller: g, className: T, internalClassName: I, disableStyles: U, style: A } = m,
							K = { ...C, ...B },
							{ ref: V, inViewport: z } = (0, i.Q)();
						z && K.impression && g?.track.product.impression(b);
						const j = {};
						return (
							U ? A && (j.css = [A]) : (j.css = [_.ResultTracker(), A]),
							(0, s.Y)('div', {
						...
						return (
							(0, s.vJ)(() => {
								...
								const I = () => {
									...
									A = () => {
										m.current && window.clearTimeout(m.current), (m.current = null), (C.current = null), M(!1);
									};
								return (
									...
									() => {
										M(!1), I(), m.current && window.clearTimeout(m.current), g && t.current && g.unobserve(t.current);
									}
								);
							}, [t, R]),
							{ inViewport: D, updateRef: B }
						);
					};
				function n(t) {
				...
				var s = function (l, o) {
					...
					(l.prototype.toName = function (i) {
						...
						if (i?.closest) {
							...
							for (var b in n) {
								var B = ((_ = M), (f = r[b]), Math.pow(_.r - f.r, 2) + Math.pow(_.g - f.g, 2) + Math.pow(_.b - f.b, 2));
								B < m && ((m = B), (C = b));
							}
							return C;
						}
