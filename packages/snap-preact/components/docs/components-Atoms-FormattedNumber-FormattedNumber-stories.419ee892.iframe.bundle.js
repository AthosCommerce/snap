			...
			'./components/src/components/Atoms/FormattedNumber/FormattedNumber.tsx'(p, s, e) {
				...
				function h(g) {
					const _ = (0, m.u)(),
						...
						y = (0, u.v6)('formattedNumber', _, P, g),
						{
							value: v,
							symbol: E,
							decimalPlaces: N,
						...
						{ overrideElement: M, shouldRenderDefault: L } = (0, b._)('formattedNumber', y);
					if (!L) return M;
					const f = r.Z(v, { symbol: E, decimalPlaces: N, padDecimalPlaces: D, thousandsSeparator: x, decimalSeparator: F, symbolAfter: T }),
						S = (0, d.Z)(y, i);
					return C
						? (0, o.Y)(o.FK, { children: f })
						: (0, o.Y)(a._, { children: (0, o.Y)('span', { className: t()('ss__formatted-number', O, A), ...S, children: f }) });
				}
			},
