						...
						const b = B?.display?.mappings.core || B?.mappings?.core,
							...
							S = {
								...
								button: {
									...
									onClick: (N) => {
										$(!0), z && z(N, B), k?.addToCart([B]), setTimeout(() => $(!1), ae);
									},
									...(0, m.s)({ disableStyles: U }),
									theme: T.theme,
									treePath: W,
					...
					R = (0, l.PA)((f) => {
						...
						if (!(f.theme?.type == 'templates' || L?.type == 'templates')) {
							const I = (0, A.X)(_?.breakpoints || {}),
								b = a()(_?.theme || {}, I?.theme || {}, { arrayMerge: (me, $) => $ });
							_ = { ..._, ...I, theme: b };
						}
						const {
								disableStyles: q,
																...
																children: D.map((I) =>
																	F && w
																		? (0, d.Y)(F, {
																				controller: w,
																				result: I,
																				theme: Y ? a()(H || {}, { components: { result: { customComponent: U } } }) : H,
																				treePath: J,
																		  })
																		: ne
																		? null
...
//# sourceMappingURL=components-Templates-RecommendationGrid-RecommendationGrid-stories.d8581262.iframe.bundle.js.map
