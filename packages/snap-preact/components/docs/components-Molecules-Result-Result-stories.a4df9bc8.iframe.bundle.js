	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[4055],
		{
			...
			'./components/src/components/Molecules/Result/Result.stories.tsx'(C, i, e) {
				'use strict';
				e.r(i), e.d(i, { Default: () => x, __namedExportsOrder: () => O, default: () => T, hideSections: () => u, truncateTitle: () => h });
					...
					z = (0, o.PA)((H) => {
						...
						const f = R?.display?.mappings.core || R?.mappings?.core,
							...
							D = {
								...
								price: { internalClassName: 'ss__result__price', ...(0, u.s)({ disableStyles: S }), theme: _.theme, treePath: B },
								calloutBadge: {
								...
								image: {
									...
									alt: f?.name || '',
									src: f?.imageUrl || '',
									...(0, u.s)({ disableStyles: S, fallback: q }),
									theme: _.theme,
									treePath: B,
								},
								rating: {
								...
								button: {
									...
									onClick: (A) => {
										N(!0), K && K(A, R), w?.addToCart([R]), setTimeout(() => N(!1), le);
									},
									...(0, u.s)({ disableStyles: S }),
									theme: _.theme,
									treePath: B,
						...
						const pe = (0, O.Z)(_, L),
							...
							ge = p()(fe, _.lang || {}),
							_e = (0, y.u)(ge, { result: R, controller: w }),
											...
											(0, s.FD)('div', {
												...
												children: [
													...
													!Z && f.price && f.price > 0
														...
														: null,
													(0, x.Y)($, { result: R, treePath: B }),
													!re && R.variants?.selections.length
														? (0, s.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: R.variants?.selections.map((A) => (0, s.Y)(b.m, { ...D.variantSelection, type: A.type, selection: A })),
														  })
														: null,
													!oe &&
														(0, s.Y)('div', {
			...
			'./components/src/utilities/snapify.ts'(C, i, e) {
				...
				class v {
					static recommendation(p) {
						...
						return (
							M.on('afterStore', async ({ controller: b }, L) => {
								b.log.debug('controller', b), b.log.debug('store', b.store.toJSON()), await L();
							}),
							M.init(),
							M
						);
...
//# sourceMappingURL=components-Molecules-Result-Result-stories.a4df9bc8.iframe.bundle.js.map
