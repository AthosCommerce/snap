(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9885],
		{
			'./components/src/components/Organisms/Autocomplete/Autocomplete.stories.tsx'(K, d, e) {
				'use strict';
				...
				const h = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, t.FD)('div', {
										children: [(0, t.Y)(T.oz, { options: { overrides: { code: M.Z } }, children: O }), (0, t.Y)(T.uY, { story: T.h1 })],
									}),
							},
						},
						decorators: [
					...
					i = (p, { loaded: { controller: D } }) => {
						const [c, v] = (0, P.J0)(!1),
							a = [
								{ active: c === 'dress', preview: () => v('dress'), value: 'dress', url: { href: '#' } },
								{ active: c === 'shirt', preview: () => v('shirt'), value: 'shirt', url: { href: '#' } },
								{ active: c === 'shoes', preview: () => v('shoes'), value: 'shoes', url: { href: '#' } },
								{ active: c === 'hat', preview: () => v('hat'), value: 'hat', url: { href: '#' } },
								{ active: c === 'pants', preview: () => v('pants'), value: 'pants', url: { href: '#' } },
								{ active: c === 'socks', preview: () => v('socks'), value: 'socks', url: { href: '#' } },
							];
						return (
							(D.store.history = a),
							setTimeout(() => {
  ...
  return <Autocomplete {...args} controller={controller} input={controller?.config.selector} />;
			...
			'./components/src/components/Atoms/Banner/Banner.tsx'(K, d, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const c = () => (0, _.AH)({ ' *': { boxSizing: 'border-box' }, '& iframe, img': { maxWidth: '100%', height: 'auto' } }),
					v = (0, O.Bk)(
						(0, T.PA)((a) => {
							const f = (0, C.u)(),
								R = { treePath: (0, h.LU)() },
								n = (0, E.v6)('banner', f, R, a),
								{ controller: r, type: m, className: u, internalClassName: g } = n,
								L = n.content || r?.store?.merchandising.content,
							...
							return (0, t.Y)(y._, { children: (0, t.Y)(A, { ...n }) });
						})
					);
				e.d(d, ['l', 0, v]);
			},
			'./components/src/components/Atoms/InlineBanner/InlineBanner.tsx'(K, d, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					v = (0, y.Bk)(
						(0, C.W)(
							(0, p.PA)((a) => {
								const f = (0, O.u)(),
									x = (0, P.LU)(),
									R = { layout: s.V.grid, width: 'auto', treePath: x },
									n = (0, h.v6)('inlineBanner', f, R, a),
									{ banner: r, className: m, internalClassName: u, disableA11y: g, layout: L, onClick: I } = n,
									{ overrideElement: U, shouldRenderDefault: w } = (0, D._)('inlineBanner', n);
								if (!w) return U;
								const F = (0, E.Z)(n, c);
								return r && r.value
									? (0, t.Y)(o._, {
											children: (0, t.Y)('div', {
												...
												role: 'article',
												ref: (B) => {
													g || (0, i.iy)(B), a.trackingRef(B);
												},
												className: M()('ss__inline-banner', `ss__inline-banner--${L}`, m, u),
												...F,
			...
			'./components/src/components/Molecules/Result/Result.tsx'(K, d, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					I = (0, _.PA)((U) => {
						const w = (0, h.u)(),
							...
							A = (0, p.v6)('result', w, B, U),
							{
								...
								addToCartButtonSuccessTimeout: te,
								hideRating: X,
								trackingRef: ae,
								treePath: V,
							} = A,
							{ overrideElement: W, shouldRenderDefault: ie } = (0, u._)('result', {
								...A,
								customComponent: A.customComponent && A.customComponent !== 'Result' ? A.customComponent : void 0,
							});
						if (!ie) return W;
						const S = l?.display?.mappings.core || l?.mappings?.core,
							[ce, me] = (0, T.J0)(!1),
							N = {
								variantSelection: {
									internalClassName: 'ss__result__variant-selection',
									...(0, s.s)({ disableStyles: b }),
									theme: A.theme,
									treePath: V,
								},
								price: { internalClassName: 'ss__result__price', ...(0, s.s)({ disableStyles: b }), theme: A.theme, treePath: V },
								calloutBadge: {
								...
								image: {
									...
									alt: S?.name || '',
									src: S?.imageUrl || '',
									...(0, s.s)({ disableStyles: b, fallback: ne }),
									theme: A.theme,
									treePath: V,
								},
								rating: {
								...
								button: {
									...
									onClick: ($) => {
										me(!0), q && q($, l), k?.addToCart([l]), setTimeout(() => me(!1), te);
									},
									...(0, s.s)({ disableStyles: b }),
									theme: A.theme,
									treePath: V,
						...
						let ue = S?.name;
						A.truncateTitle && (ue = c.x(S?.name || '', A.truncateTitle.limit, A.truncateTitle.append));
						const pe = (0, D.Z)(A, L),
							_e = { addToCartButtonText: { value: ce ? ee : le } },
							he = r()(_e, A.lang || {}),
							Ee = (0, m.u)(he, { result: l, controller: k }, { activeBreakpoint: w?.activeBreakpoint }),
							de = !!(S?.msrp && S?.price && S?.price < S?.msrp),
							ve = k?.store?.config?.asyncState?.product?.price ? l.state.priceFetched : !0;
						return S
							? (0, t.Y)(P._, {
									children: (0, t.FD)('article', {
										...pe,
										className: y()('ss__result', `ss__result--${oe}`, { 'ss__result--sale': de }, G, J),
										ref: ae,
										children: [
											!Y &&
												(0, t.Y)('div', {
													...
													children: (0, t.Y)('a', {
														...
														children: j
															? (0, t.Y)(O._, { ...N.image })
															: (0, t.Y)(f.Q, { ...N.overlayBadge, controller: k, children: (0, t.Y)(O._, { ...N.image }) }),
													}),
												}),
											(0, t.FD)('div', {
												className: 'ss__result__details',
												children: [
													!j && (0, t.Y)(a.W, { ...N.calloutBadge, controller: k }),
													!Z &&
														(0, t.Y)('div', {
													...
													!X && (0, t.Y)(x.G, { ...N.rating }),
													!Q && ve && S.price && S.price > 0
														? (0, t.Y)('div', {
																className: 'ss__result__details__pricing',
																children: de
																	? (0, t.FD)(t.FK, {
																			children: [
																				(0, t.Y)(C.g, { ...N.price, value: S.msrp, lineThrough: !0, name: 'msrp' }),
																				'\xA0',
																				(0, t.Y)(C.g, { ...N.price, value: S.price, name: 'price' }),
																			],
																	  })
																	: (0, t.Y)(C.g, { ...N.price, value: S.price }),
														  })
														: null,
													(0, i.Y)(H, { result: l, treePath: V }),
													!se && l.variants?.selections.length
														? (0, t.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: l.variants?.selections.map(($) => (0, t.Y)(g.m, { ...N.variantSelection, type: $.type, selection: $ })),
														  })
														: null,
													!re &&
														(0, t.Y)('div', {
															className: 'ss__result__add-to-cart-wrapper',
															children: (0, t.Y)(R.$, { ...N.button, ...Ee.addToCartButtonText.all }),
														}),
												],
											}),
										],
			...
			'./components/src/components/Organisms/Facets/Facets.tsx'(K, d, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					T = e('../../node_modules/@emotion/react/dist/emotion-react.browser.esm.js'),
					_ = e('../../node_modules/classnames/index.js'),
				...
				const c = () => (0, T.AH)({}),
					v = (0, O.PA)((a) => {
						const f = (0, h.u)(),
							x = (0, E.LU)(),
							R = { facets: a.controller?.store?.facets, treePath: x };
						let n = (0, p.v6)('facets', f, R, a);
						const { limit: r, onFacetOptionClick: m, disableStyles: u, className: g, internalClassName: L, controller: I, treePath: U } = n,
							{ overrideElement: w, shouldRenderDefault: F } = (0, i._)('facets', n);
						if (!F) return w;
						const B = (Y) => {
								m && m(Y), I?.setFocused && I?.setFocused();
							},
							A = {
								components: {
							...
							l = y()(A, n?.theme || {}, { arrayMerge: (Y, H) => H });
						n = { ...n, theme: l };
						let { facets: j } = n;
						r && j && r > 0 && (j = j.slice(0, +r));
						const Z = { facet: { internalClassName: 'ss__facets__facet', ...(0, s.s)({ disableStyles: u }), theme: n.theme, treePath: U } },
							Q = (0, D.Z)(n, c);
						return j && j?.length > 0
							? (0, t.Y)(P._, {
									children: (0, t.Y)('div', {
										className: M()('ss__facets', g, L),
										...Q,
										children: j.map((Y) => (0, t.Y)(C.s, { ...Z.facet, facet: Y }, Y.field)),
									}),
							  })
							: null;
					});
			...
			'./components/src/components/Organisms/Results/Results.tsx'(K, d, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					T = e('../../node_modules/@emotion/react/dist/emotion-react.browser.esm.js'),
					_ = e('../../node_modules/mobx-react-lite/es/index.js'),
				...
				const u = ({ gapSize: I, columns: U }) =>
					...
					L = (0, _.PA)((I) => {
						const U = (0, v.u)(),
							...
							A = { results: I.controller?.store?.results, columns: 4, gapSize: '20px', layout: E.V.grid, breakpoints: B, treePath: F };
						let l = (0, p.v6)('results', U, A, I);
						if (!(I.theme?.type == 'templates' || U?.type == 'templates')) {
							const W = (0, R.X)(l?.breakpoints || {}),
								ie = O()(l?.theme || {}, W?.theme || {}, { arrayMerge: (S, ce) => ce });
							l = { ...l, ...W, theme: ie };
						}
						const { disableStyles: j, className: Z, internalClassName: Q, layout: Y, theme: H, excludeBanners: ne, controller: b, treePath: G } = l,
							J = l.resultComponent,
							{ overrideElement: oe, shouldRenderDefault: z } = (0, m._)('results', l);
						if (!z) return oe;
						const k = typeof J == 'string',
							se = k ? J : '',
							re = w?.templates?.library.import.component.result || {},
							{ ComponentOverride: q, shouldWaitForNamedOverride: le } = (0, r.x)(re, k ? se : void 0),
							ee = k ? q : J,
							te = {
								result: { internalClassName: 'ss__results__result', ...(0, s.s)({ disableStyles: j }), theme: l?.theme, treePath: G },
								inlineBanner: {
									controller: b,
						...
						let X = ne ? l.results?.filter((W) => W.type !== C.c.BANNER) : l.results;
						l?.columns && l?.rows && l.columns > 0 && l.rows > 0 && (X = X?.slice(0, l.columns * l.rows));
						const ae = (0, D.Z)({ ...l, columns: Y == E.V.list ? 1 : l.columns }, u),
							V = k ? O()(H || {}, { components: { result: { customComponent: J } } }) : H;
						return X?.length
							? (0, t.Y)(c._, {
									children: (0, t.Y)('div', {
										...ae,
										className: o()('ss__results', `ss__results-${l.layout}`, Z, Q),
										children: X.map((W) =>
											W.type === C.c.BANNER
												? (0, T.n)(P._, { ...te.inlineBanner, key: `${b?.id ? `${b?.id}-` : ''}${W.id}`, banner: W, layout: l.layout })
												: le
												? null
												: ee && b
												? (0, t.Y)(n.o, {
														result: W,
														controller: b,
														children: (0, i.Y)(ee, { key: `${b?.id ? `${b?.id}-` : ''}${W.id}`, controller: b, result: W, theme: V, treePath: G }),
												  })
												: (0, t.Y)(g, { ...te.result, result: W, layout: l.layout, controller: b }, `${b?.id ? `${b?.id}-` : ''}${W.id}`)
										),
									}),
							  })
							: null;
			...
			'./components/src/components/Trackers/ResultTracker/ResultTracker.tsx'(K, d, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					T = e('../../node_modules/@emotion/react/dist/emotion-react.browser.esm.js'),
					_ = e('../../node_modules/mobx-react-lite/es/index.js'),
				...
				const P = { ResultTracker: () => (0, T.AH)({}) },
					h = (0, _.PA)((E) => {
						const i = (0, y.u)(),
							s = (0, O.v6)('resultTracker', i, {}, E),
							p = { impression: !0, click: !0 },
							{ children: D, result: c, track: v, controller: a, className: f, internalClassName: x, disableStyles: R, style: n } = s,
							r = { ...p, ...v },
							{ ref: m, inViewport: u } = (0, C.Q)();
						u && r.impression && a?.track.product.impression(c);
						const g = {};
						return (
							R ? n && (g.css = [n]) : (g.css = [P.ResultTracker(), n]),
							(0, t.Y)('div', {
								className: o()('ss__result-tracker', `ss__${a?.type}-result-tracker`, f, x),
								onClick: (L) => {
									r.click && a?.track.product.click(L, c);
								},
								ref: m,
								...g,
								children: D,
			...
			'./components/src/hooks/useIntersectionAdvanced.tsx'(K, d, e) {
				'use strict';
				var t = e('../../node_modules/preact/hooks/dist/hooks.module.js');
				const T = 250,
					_ = (o, y = {}) => {
						const { rootMargin: O = '0px', fireOnce: C = !1, threshold: P = 0, minVisibleTime: h = 0 } = y,
							[E, i] = (0, t.J0)(!1),
							s = (0, t.li)(null),
							p = (0, t.li)(null),
							[D, c] = (0, t.J0)(0),
						...
						return (
							(0, t.vJ)(() => {
										...
										h > 0
											? ((p.current = Date.now()),
											  ...
											  (s.current = window.setTimeout(() => {
													i(!0), C && o.current && a && a.unobserve(o.current);
											  }, h)))
											: (i(!0), C && o.current && a && a.unobserve(o.current));
									},
									n = () => {
								...
								return (
									...
									() => {
										i(!1), x(), s.current && window.clearTimeout(s.current), a && o.current && a.unobserve(o.current);
									}
								);
							}, [o, D]),
							{ inViewport: E, updateRef: v }
						);
					};
				function M(o) {
			...
			'./components/src/providers/withTracking.tsx'(K, d, e) {
				'use strict';
				e.d(d, { N: () => M, W: () => o });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				function o(y) {
					...
					return (P) => {
						...
						if (P.trackingRef) return (0, t.Y)(O, { ...P });
						...
						const { ref: c, inViewport: v, updateRef: a } = (0, T.Q)(),
							f = (E || i || (s && p?.[s]?.[0]))?.responseId,
							x = (0, _.li)(f),
							R = (0, _.li)(!1);
						x.current !== f && (R.current = !0),
							(0, _.vJ)(() => {
								x.current !== f && ((x.current = f), a(c.current));
							}, [f, a]),
							(0, _.vJ)(() => {
								R.current && !v && (R.current = !1);
							}, [v, f]);
						const n = s && p && !E && ['search', 'autocomplete'].includes(h?.type || '');
						v && !R.current && (n ? h?.track.banner.impression(p[s][0]) : E?.bundleSeed || h?.track.product.impression(E || i));
						const r = (0, _.hb)(
							(u) => {
			...
			'./components/src/utilities/createImpressionObserver.ts'(K, d, e) {
				'use strict';
				e.d(d, { Q: () => o });
				var t = e('../../node_modules/preact/hooks/dist/hooks.module.js'),
				...
				function o(y) {
					const O = (0, t.li)(null),
						{ inViewport: C, updateRef: P } = (0, T.v)(O, { ...y, fireOnce: !0, threshold: _, minVisibleTime: M });
					return { ref: O, inViewport: C, updateRef: P };
				}
			},
			'./components/src/utilities/snapify.ts'(K, d, e) {
				'use strict';
				e.d(d, { p: () => a });
				...
				class a {
					static recommendation(r) {
						const m = r.id;
						if (c[m]) return c[m];
						const u = (c[m] = x({ client: v, controller: r }));
						return (
							u.on('afterStore', async ({ controller: g }, L) => {
					...
					static autocomplete(r) {
						const m = r.id;
						if (c[m]) return c[m];
						const u = (c[m] = R({ client: v, controller: r }));
						return (
							u.on('afterStore', async ({ controller: g }, L) => {
								g.log.debug('controller', g), g.log.debug('store', g.store.toJSON()), await L();
							}),
					...
					static search(r) {
						const m = r.id;
						if (c[m]) return c[m];
						const u = (c[m] = f({ client: v, controller: r }));
						return (
							u.on('afterStore', async ({ controller: g }, L) => {
								g.log.debug('controller', g), g.log.debug('store', g.store.toJSON()), await L();
							}),
				...
				function f(n) {
					...
					return new T.Tp(n.controller, {
						...
						store: new O.U(n.controller, { urlManager: r }),
						urlManager: r,
...
//# sourceMappingURL=components-Organisms-Autocomplete-Autocomplete-stories.408b51e4.iframe.bundle.js.map
