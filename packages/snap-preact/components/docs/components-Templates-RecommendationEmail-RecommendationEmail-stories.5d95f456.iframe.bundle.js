(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[8241],
		{
			...
			'./components/src/components/Templates/RecommendationEmail/RecommendationEmail.stories.tsx'(C, i, e) {
				'use strict';
				...
				const r =
					...
					b = (m, { loaded: { controller: x } }) => (0, s.Y)(a.i, { ...m, controller: x });
				(b.loaders = [
					async () => (
						f.on('init', async ({ controller: m }, x) => {
							(m.store.results = v), m.store.results.forEach((A) => (A.mappings.core.url = 'javascript:void(0);')), await x();
						}),
						await f.init(),
						{ controller: f }
					),
  ...
  return <RecommendationEmail {...props} controller={controller} />;
			...
			'./components/src/components/Molecules/Result/Result.tsx'(C, i, e) {
				...
				const U = () =>
					...
					Z = (0, a.PA)((z) => {
						...
						if (!me) return de;
						const h = P?.display?.mappings.core || P?.mappings?.core,
							[pe, q] = (0, n.J0)(!1),
							O = {
								variantSelection: {
									internalClassName: 'ss__result__variant-selection',
									...(0, m.s)({ disableStyles: M }),
									theme: u.theme,
									treePath: B,
								},
								price: { internalClassName: 'ss__result__price', ...(0, m.s)({ disableStyles: M }), theme: u.theme, treePath: B },
								calloutBadge: {
								...
								image: {
									...
									alt: h?.name || '',
									src: h?.imageUrl || '',
									...(0, m.s)({ disableStyles: M, fallback: X }),
									theme: u.theme,
									treePath: B,
								},
								rating: {
								...
								button: {
									...
									onClick: (W) => {
										q(!0), $ && $(W, P), j?.addToCart([P]), setTimeout(() => q(!1), ne);
									},
									...(0, m.s)({ disableStyles: M }),
									theme: u.theme,
									treePath: B,
						...
						let ee = h?.name;
						u.truncateTitle && (ee = y.x(h?.name || '', u.truncateTitle.limit, u.truncateTitle.append));
						const ue = (0, A.Z)(u, U),
							fe = { addToCartButtonText: { value: pe ? re : le } },
							ge = p()(fe, u.lang || {}),
							_e = (0, g.u)(ge, { result: P, controller: j }),
							te = !!(h?.msrp && h?.price && h?.price < h?.msrp);
						return h
							? (0, s.Y)(v._, {
									children: (0, s.FD)('article', {
										...ue,
										className: l()('ss__result', `ss__result--${se}`, { 'ss__result--sale': te }, K, N),
										ref: ce,
										children: [
											!V &&
												(0, s.Y)('div', {
													...
													children: (0, s.Y)('a', {
														...
														children: w
															? (0, s.Y)(r._, { ...O.image })
															: (0, s.Y)(k.Q, { ...O.overlayBadge, controller: j, children: (0, s.Y)(r._, { ...O.image }) }),
													}),
												}),
											(0, s.FD)('div', {
												className: 'ss__result__details',
												children: [
													!w && (0, s.Y)(R.W, { ...O.calloutBadge, controller: j }),
													!J &&
														(0, s.Y)('div', {
													...
													!F && h.price && h.price > 0
														? (0, s.Y)('div', {
																...
																children: te
																	? (0, s.FD)(s.FK, {
																			children: [
																				(0, s.Y)(c.g, { ...O.price, value: h.msrp, lineThrough: !0, name: 'msrp' }),
																				'\xA0',
																				(0, s.Y)(c.g, { ...O.price, value: h.price, name: 'price' }),
																			],
																	  })
																	: (0, s.Y)(c.g, { ...O.price, value: h.price }),
														  })
														: null,
													(0, I.Y)(H, { result: P, treePath: B }),
													!oe && P.variants?.selections.length
														? (0, s.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: P.variants?.selections.map((W) => (0, s.Y)(_.m, { ...O.variantSelection, type: W.type, selection: W })),
														  })
														: null,
													!ae &&
														(0, s.Y)('div', {
															className: 'ss__result__add-to-cart-wrapper',
															children: (0, s.Y)(L.$, { ...O.button, ..._e.addToCartButtonText.all }),
														}),
												],
											}),
										],
			...
			'./components/src/components/Templates/RecommendationEmail/RecommendationEmail.tsx'(C, i, e) {
				'use strict';
				e.d(i, { O: () => A, i: () => T });
				var s = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const A = { default: {}, mobile: {}, tablet: {}, desktop: {} },
					...
					T = (0, a.PA)((R) => {
						const k = (0, b.u)(),
							D = (0, m.LU)(),
							L = { resultWidth: '240px', name: R.controller?.store?.profile?.tag?.toLowerCase(), treePath: D },
							d = (0, v.v6)('recommendationEmail', k, L, R),
							{ controller: p, results: g, resultProps: E, resultWidth: _, treePath: U, disableStyles: Z, internalClassName: z, className: G } = d,
							S = d.resultComponent,
							Q = (0, I.uk)(),
							u = typeof S == 'string',
							P = u ? S : '',
							w = Q?.templates?.library.import.component.result || {},
							{ ComponentOverride: J, shouldWaitForNamedOverride: F } = (0, x.x)(w, u ? P : void 0),
							V = u ? J : S,
							H = {
								result: { internalClassName: 'ss__recommendation-email__result', ...(0, c.s)({ disableStyles: Z }), theme: d?.theme, treePath: U },
							},
							X = (0, f.Z)(d, y),
							M = g || p?.store?.results || [];
						return M.length > 0
							? (0, s.Y)('div', {
									className: t()('ss__recommendation-email', G, z),
									...X,
									children: M.map((K, N) =>
										(0, s.Y)(
											'div',
											{
												...
												style: { display: 'block', width: _ },
												children: V
													? (0, r.Y)(V, { controller: p, result: K, ...E, email: !0, treePath: U })
													: F
													? null
													: (0, s.Y)(l.Q, { result: K, hideBadge: !0, theme: { components: { image: { lazy: !1 } } }, ...H.result, ...E }),
											},
											N
										)
									),
			...
			'./components/src/utilities/snapify.ts'(C, i, e) {
				...
				class R {
					static recommendation(p) {
						const g = p.id;
						if (y[g]) return y[g];
						const E = (y[g] = D({ client: T, controller: p }));
						return (
							E.on('afterStore', async ({ controller: _ }, U) => {
					...
					static autocomplete(p) {
						const g = p.id;
						if (y[g]) return y[g];
						const E = (y[g] = L({ client: T, controller: p }));
						return (
							E.on('afterStore', async ({ controller: _ }, U) => {
								_.log.debug('controller', _), _.log.debug('store', _.store.toJSON()), await U();
							}),
					...
					static search(p) {
						const g = p.id;
						if (y[g]) return y[g];
						const E = (y[g] = k({ client: T, controller: p }));
						return (
							E.on('afterStore', async ({ controller: _ }, U) => {
								_.log.debug('controller', _), _.log.debug('store', _.store.toJSON()), await U();
							}),
				...
				function k(d) {
					const p = new v.V(new b.E({ settings: { coreType: 'query', corePrefix: d.controller.id } }), f.X);
					return new n.Tp(d.controller, {
						client: new t.K(d.client.globals, d.client.config),
						store: new r.U(d.controller, { urlManager: p }),
						urlManager: p,
				...
				function D(d) {
					const p = new v.V(new b.E(), f.X).detach(!0);
				...
				function L(d) {
					const p = new v.V(new b.E(), f.X).detach();
					return new a.Z(d.controller, {
						client: new t.K(d.client.globals, d.client.config),
						store: new l.Y(d.controller, { urlManager: p }),
						urlManager: p,
						eventManager: new I.E(),
						profiler: new m.U(),
						logger: new x.V(),
					...
					(n.prototype.toName = function (c) {
						...
						if (c?.closest) {
							var I = this.toRgb(),
								m = 1 / 0,
								x = 'black';
							if (!r.length) for (var A in o) r[A] = new n(o[A]).toRgb();
							for (var y in o) {
...
//# sourceMappingURL=components-Templates-RecommendationEmail-RecommendationEmail-stories.5d95f456.iframe.bundle.js.map
