...
`,
					...
					c = (0, n.PA)(({ args: v, controller: u }) => {
						const T = u?.store?.facets.filter((U) => U.field == 'color').pop();
						return (0, o.Y)(r.P, { ...v, values: T.values });
					}),
					y = (v, { loaded: { controller: u } }) =>
						(0, o.Y)('div', { style: { maxWidth: v?.horizontal ? '1200px' : '500px' }, children: (0, o.Y)(c, { args: v, controller: u }) });
    ...
    maxWidth: args?.horizontal ? '1200px' : '500px'
				...
				const h = '//cdn.athoscommerce.net/snap/images/fallback.png',
					...
					v = (0, t.PA)((u) => {
						const T = (0, M.u)(),
							...
							{ overrideElement: $, shouldRenderDefault: S } = (0, y._)('image', w);
						if (!S) return $;
						const [V, K] = (0, n.J0)(!1),
							[z, N] = (0, n.J0)(!1),
							R = (0, n.li)('');
			...
			'./components/src/components/Molecules/FacetPaletteOptions/FacetPaletteOptions.tsx'(D, d, e) {
				...
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					W = e.n(U),
					w = e('../../node_modules/colord/index.mjs'),
							...
							? (0, o.Y)(c._, {
									children: (0, o.Y)('div', {
										...
										children: te.map((a) => {
											...
											if (G)
												try {
													se = (0, w.Mj)(G.toLowerCase()).isDark();
												} catch {}
											return (0, o.FD)(
												'a',
												{
						...
						M &&
							t.addEventListener('keydown', function (c) {
								const y = t.querySelectorAll(r),
									...
									O = y[y.length - 1];
								if (c.keyCode == n) {
									t.focus(), g && g(c), c.preventDefault(), c.stopPropagation();
									return;
								}
			...
			'./components/src/utilities/snapify.ts'(D, d, e) {
				...
				function W(m) {
					const f = new g.V(new c.E({ settings: { coreType: 'query', corePrefix: m.controller.id } }), _.X);
				...
				function w(m) {
					const f = new g.V(new c.E(), _.X).detach(!0);
				...
				function L(m) {
					const f = new g.V(new c.E(), _.X).detach();
			...
			'../../node_modules/colord/plugins/names.mjs'(D, d, e) {
				'use strict';
				e.d(d, { A: () => o }), Object.defineProperty(o, 'name', { value: 'default', configurable: !0 });
				function o(n, s) {
					var r = {
							white: '#ffffff',
							bisque: '#ffe4c4',
...
//# sourceMappingURL=components-Molecules-FacetPaletteOptions-FacetPaletteOptions-stories.9437020e.iframe.bundle.js.map
