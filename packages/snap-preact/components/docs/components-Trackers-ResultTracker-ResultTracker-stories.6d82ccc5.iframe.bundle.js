(() => {
  ...
  return <ResultTracker {...props} controller={controller} result={firstResult}>
						...
						return b
							? (0, s.Y)(_._, {
									children: (0, s.FD)('article', {
										...he,
										className: n()('ss__result', `ss__result--${oe}`, { 'ss__result--sale': J }, se, re),
										ref: me,
										children: [
											!q &&
												(0, s.FD)('div', {
											...
											(0, s.FD)('div', {
												...
												children: [
													...
													!ne && D.variants?.selections.length
														? (0, s.Y)('div', {
			...
			'./components/src/utilities/createImpressionObserver.ts'(P, c, e) {
				...
				function t(n) {
					const a = (0, s.li)(null),
						{ inViewport: i, updateRef: _ } = (0, l.v)(a, { fireOnce: !0, threshold: o, minVisibleTime: r, ...n });
...
//# sourceMappingURL=components-Trackers-ResultTracker-ResultTracker-stories.6d82ccc5.iframe.bundle.js.map
