(() => {
				...
				const x = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, t.FD)('div', {
										children: [(0, t.Y)(m.oz, { options: { overrides: { code: T.Z } }, children: B }), (0, t.Y)(m.uY, { story: m.h1 })],
									}),
							},
						},
						decorators: [
  ...
  return inputFound ? <AutocompleteModal {...args} controller={controller} input={controller?.config.selector} /> : <></>;
				...
				const w = () =>
					...
					C = (0, f.PA)((U) => {
						const o = (0, b.u)(),
							...
							{ overrideElement: O, shouldRenderDefault: I } = (0, d._)('modal', c);
						if (!I) return O;
						const Q = {
							overlay: {
						...
						return (
							(0, m.vJ)(
								() => (
									u && z ? (document.body.style.overflow = 'hidden') : (document.body.style.overflow = ''),
									() => {
							...
							(0, m.vJ)(() => {
								...
								return (
									h && (F || h.addEventListener('click', te)),
									window.addEventListener('resize', ee),
									() => {
										window.removeEventListener('resize', ee), h && h.removeEventListener('click', te);
									}
								);
							}, []),
							(0, t.Y)(B._, {
								children: (0, t.FD)('div', {
									...oe,
									className: i()('ss__modal', { 'ss__modal--open': u }, { 'ss__modal--disabled': F }, Z, X),
									ref: q,
									children: [
										!D &&
											n &&
											(0, t.Y)('div', {
												...
												children: (0, g.Y)(n, { open: u, toggleOpen: N, treePath: K }),
											}),
										(_ || W) &&
											u &&
											(0, t.FD)('div', {
												...
												ref: (h) => (y ? null : (0, s.iy)(h)),
												children: [(0, g.Y)(_, { open: u, toggleOpen: N, treePath: K }), (0, g.Y)(W, { open: u, toggleOpen: N, treePath: K })],
											}),
										(0, t.Y)(A.h, { ...Q.overlay, active: !!u }),
									],
								}),
							})
						);
			...
			'./components/src/components/Templates/AutocompleteModal/AutocompleteModal.tsx'(S, l, e) {
				...
				const A = ({ width: w, height: C, theme: U }) => {
						const o = U?.variables;
						return (0, T.AH)({
							position: 'fixed',
							left: '0',
					...
					L = (0, M.PA)((w) => {
						const C = (0, x.u)(),
							...
							o = (0, f.v6)('autocompleteModal', C, U, w),
							[r, a] = (0, m.J0)(!1),
							c = '';
						let n = o.input,
							_ = o.buttonSelector;
						...
						let y = o.controller,
							Z = [y];
						R && R.active && ((y = R.active?.controller), (Z = R.tabs.map((I) => I.controller)));
						const X = (0, m.li)(null);
						(0, m.vJ)(() => {
							const I = (Q, u) => {
						...
						const j = () => {
							...
							H = {
								autocompleteLayout: { layout: D, onReset: () => j(), tabManager: R, ...(0, i.s)({ disableStyles: W }), theme: o?.theme, treePath: V },
								modal: {
							...
							$ = (0, B.Z)(o, A);
						let K;
						n && (K = (0, s.x)({ input: n, controllers: Z, renderedInputRef: X, renderInput: !!Y, buttonSelector: _, setActive: a }));
						const O = { ...o };
						return (
							delete O.width,
							delete O.className,
							...
							D?.length && r
								? (0, t.Y)(b._, {
										children: (0, t.Y)('div', {
											...$,
											className: v()('ss__autocomplete-modal', k, z),
											children: (0, t.Y)(d.a, {
												...H.modal,
												children: (0, t.FD)('div', {
													...
													children: [
														Y ? (0, t.Y)(E.D, { ...H.searchInput, value: y.store.state.input || '', inputRef: X }) : (0, t.Y)(t.FK, {}),
														(0, t.Y)(P.h, { ...O, ...H.autocompleteLayout, input: K, controller: y, treePath: `${V} modal` }),
													],
												}),
											}),
										}),
			...
			'./components/src/utilities/snapify.ts'(S, l, e) {
				...
				class L {
					static recommendation(r) {
						const a = r.id;
						if (s[a]) return s[a];
						const c = (s[a] = C({ client: A, controller: r }));
						return (
							c.on('afterStore', async ({ controller: n }, _) => {
					...
					static autocomplete(r) {
						const a = r.id;
						if (s[a]) return s[a];
						const c = (s[a] = U({ client: A, controller: r }));
						return (
							c.on('afterStore', async ({ controller: n }, _) => {
								n.log.debug('controller', n), n.log.debug('store', n.store.toJSON()), await _();
							}),
					...
					static search(r) {
						const a = r.id;
						if (s[a]) return s[a];
						const c = (s[a] = w({ client: A, controller: r }));
						return (
							c.on('afterStore', async ({ controller: n }, _) => {
								n.log.debug('controller', n), n.log.debug('store', n.store.toJSON()), await _();
							}),
			...
			'./components/src/utilities/storybook.tsx'(S, l, e) {
				...
				const M = 'prism-block',
					T = (i) => {
						...
						return (
							(0, m.vJ)(() => {
								f.current && i.className?.includes('lang-') && !i.className?.includes(M) && window?.Prism?.highlightElement(f.current);
...
//# sourceMappingURL=components-Templates-AutocompleteModal-AutocompleteModal-stories.83d9a805.iframe.bundle.js.map
