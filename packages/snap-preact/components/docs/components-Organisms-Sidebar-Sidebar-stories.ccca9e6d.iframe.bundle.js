				...
				const W = ({ horizontal: d }) =>
					...
					x = (0, a.PA)((d) => {
						...
						const K = (b, S) => {
								let m;
								ee
									? O.find((q) => q.value === S.value)
										? ((m = [...O]),
										  m.splice(
												m.findIndex((q) => q.value === S.value),
												1
										  ),
										  m.length == 0 && ne && (m = [S]))
										: (m = [...O, S])
									: !ne && O.find((q) => q.value === S.value)
									? (m = [])
									: (m = [S]),
									G && G(b, S, m),
									B(m);
							...
							z = {},
							F = U()(z, k.lang || {}),
							se = (0, A.u)(F, { options: J, selectedOptions: O }, { activeBreakpoint: C?.activeBreakpoint });
									...
									children: (0, t.FD)('div', {
										...
										children: [
											...
											(0, t.Y)('ul', {
												...
												'aria-label': N,
												children: J.map((b) => {
													const S = O.some((m) => m.value == b.value);
													return (0, t.FD)('li', {
														...
														children: [
															!oe && (0, t.Y)(i.S, { ...p.checkbox, checked: S, disableA11y: !0, 'aria-label': b.label }),
					...
					var s = a.interpolator,
						...
						H = t.default.useCallback(
							function (o) {
								var n = N(),
									...
									p = Q(l),
									D = te(p),
									O = [].concat(y.slice(0, f), [D], y.slice(f + 1));
								u ? u(O) : k(O);
							},
							[N, Q, te, y]
						),
							...
							function (o, n) {
								...
								if (o.keyCode === 37 || o.keyCode === 39) {
									...
									var D = o.keyCode === 37 ? -1 : 1,
										O = ee(u[n], D),
										B = [].concat(u.slice(0, n), [O], u.slice(n + 1)),
										j = P(B);
									p(j);
								}
							},
						...
						ae = function (n) {
							...
							return c(
								{
									ref: function (B) {
										(G.current = B), p && (typeof p == 'function' ? p(B) : (p.current = B));
									},
...
//# sourceMappingURL=components-Organisms-Sidebar-Sidebar-stories.ccca9e6d.iframe.bundle.js.map
