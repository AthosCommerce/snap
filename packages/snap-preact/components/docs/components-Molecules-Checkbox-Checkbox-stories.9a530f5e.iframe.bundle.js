		...
		[9143],
		{
			...
			'./components/src/components/Molecules/Checkbox/Checkbox.tsx'(b, c, t) {
				...
				var s = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					N = t.n(K);
				const W = ({ size: y, color: E, theme: D, native: v }) => {
						...
						return v
							...
							: (0, n.AH)({
									...
									height: f,
									width: f,
									border: `1px solid ${E || D?.variables?.colors?.primary || '#333'}`,
					...
					Y = (0, e.PA)((y) => {
						const E = (0, o.u)(),
							v = { size: '12px', startChecked: !1, disableA11y: !1, treePath: (0, h.LU)() },
							f = (0, k.v6)('checkbox', E, v, y),
							{
								checked: T,
								color: V,
								disabled: x,
						...
						const I = isNaN(Number(P)) ? P : `${P}px`,
							ee = {
								icon: {
									...
									icon: 'check-thin',
									...(0, a.s)({ color: z || V || Z?.variables?.colors?.primary, disableStyles: H, icon: C, size: I && `calc(${I} - 30%)` }),
									theme: f.theme,
									treePath: J,
								},
							};
						...
						const S = (_) => {
							...
							te = { checkbox: {} },
							oe = N()(te, G || {}),
							se = (0, R.u)(oe, { checkedState: p, disabled: x });
						return (0, s.Y)(d._, {
							children: w
								? (0, s.Y)('input', {
										...U,
