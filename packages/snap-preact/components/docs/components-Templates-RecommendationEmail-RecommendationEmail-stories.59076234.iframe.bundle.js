			...
			'./components/src/components/Molecules/Result/Result.tsx'(x, i, e) {
				...
				const M = () =>
					...
					K = (0, a.PA)((Q) => {
						...
						const h = C?.display?.mappings.core || C?.mappings?.core,
							...
							U = {
								...
								button: {
									...
									onClick: (W) => {
										ee(!0), q && q(W, C), D?.addToCart([C]), setTimeout(() => ee(!1), re);
									},
									...(0, d.s)({ disableStyles: O }),
									theme: g.theme,
									treePath: B,
						...
						const ue = (0, P.Z)(g, M),
							fe = { addToCartButtonText: { value: pe ? ne : le } },
							ge = u()(fe, g.lang || {}),
							_e = (0, p.u)(ge, { result: C, controller: D }, { activeBreakpoint: V?.activeBreakpoint }),
						...
						return h
							? (0, s.Y)(v._, {
									children: (0, s.FD)('article', {
										...ue,
										className: l()('ss__result', `ss__result--${Z}`, { 'ss__result--sale': se }, Y, z),
										ref: ce,
										children: [
											!X &&
												(0, s.Y)('div', {
													...
													children: (0, s.Y)('a', {
														...
														children: w
															? (0, s.Y)(n._, { ...U.image })
															: (0, s.Y)(S.Q, { ...U.overlayBadge, controller: D, children: (0, s.Y)(n._, { ...U.image }) }),
													}),
												}),
											(0, s.FD)('div', {
			...
			'./components/src/components/Templates/RecommendationEmail/RecommendationEmail.tsx'(x, i, e) {
				...
				const T = { default: {}, mobile: {}, tablet: {}, desktop: {} },
					...
					S = (0, a.PA)((k) => {
						const j = (0, d.u)(),
							m = (0, P.LU)(),
							u = { resultWidth: '240px', name: k.controller?.store?.profile?.tag?.toLowerCase(), treePath: m },
							p = (0, b.v6)('recommendationEmail', j, u, k),
							{ controller: E, results: _, resultWidth: M, treePath: K, disableStyles: Q, internalClassName: V, className: J } = p,
							R = p.resultComponent,
							g = (0, A.uk)(),
							C = typeof R == 'string',
							w = C ? R : '',
							...
							N = C ? H : R,
							$ = {
								result: { internalClassName: 'ss__recommendation-email__result', ...(0, f.s)({ disableStyles: Q }), theme: p?.theme, treePath: K },
							},
							O = (0, I.Z)(p, L),
							Y = _ || E?.store?.results || [];
						return Y.length > 0
							? (0, s.Y)('div', {
									className: n()('ss__recommendation-email', J, V),
									...O,
									children: Y.map((z, Z) =>
										(0, s.Y)(
											'div',
											{
												...
												children: N
													? (0, v.Y)(N, {
															...
															result: z,
															email: !0,
															theme: C ? t()(p.theme || {}, { components: { result: { customComponent: R }, image: { lazy: !1 } } }) : p.theme,
															treePath: K,
													  })
													: X
													? null
													: (0, s.Y)(c.Q, { result: z, hideBadge: !0, theme: { components: { image: { lazy: !1 } } }, ...$.result }),
											},
											Z
										)
									),
			...
			'./components/src/utilities/snapify.ts'(x, i, e) {
				...
				class L {
					static recommendation(u) {
						const p = u.id;
						if (y[p]) return y[p];
						const E = (y[p] = k({ client: T, controller: u }));
						return (
				...
				function s(r, a) {
					...
					(r.prototype.toName = function (c) {
						...
						if (c?.closest) {
							...
							for (var y in o) {
								var T = ((v = I), (f = n[y]), Math.pow(v.r - f.r, 2) + Math.pow(v.g - f.g, 2) + Math.pow(v.b - f.b, 2));
								T < d && ((d = T), (A = y));
							}
							return A;
						}
...
//# sourceMappingURL=components-Templates-RecommendationEmail-RecommendationEmail-stories.59076234.iframe.bundle.js.map
