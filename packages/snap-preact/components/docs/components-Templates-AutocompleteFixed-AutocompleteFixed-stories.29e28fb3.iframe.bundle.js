(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[4785],
		{
			'./components/src/components/Templates/AutocompleteFixed/AutocompleteFixed.stories.tsx'(F, u, e) {
				'use strict';
				...
				const C = {
					...
					_ = (x, { loaded: { controller: E } }) => {
						const [y, s] = (0, O.J0)(''),
							I = [
								{ active: y === 'dress', preview: () => s('dress'), value: 'dress', type: 'suggested', url: { href: '#' } },
								{ active: y === 'shirt', preview: () => s('shirt'), value: 'shirt', type: 'suggested', url: { href: '#' } },
								{ active: y === 'shoes', preview: () => s('shoes'), value: 'shoes', type: 'suggested', url: { href: '#' } },
								{ active: y === 'hat', preview: () => s('hat'), value: 'hat', type: 'suggested', url: { href: '#' } },
								{ active: y === 'pants', preview: () => s('pants'), value: 'pants', type: 'suggested', url: { href: '#' } },
								{ active: y === 'socks', preview: () => s('socks'), value: 'socks', type: 'suggested', url: { href: '#' } },
							];
						E.store.history = I;
						const [j, K] = (0, O.J0)(!1);
						return (
  ...
  return inputFound ? <AutocompleteFixed {...args} controller={controller} input={controller?.config.selector} /> : <></>;
			...
			'./components/src/components/Molecules/Modal/Modal.tsx'(F, u, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
						...
						return (
							...
							(0, r.vJ)(() => {
								...
								const re = (0, j.s)(() => {
										clearTimeout(ne),
											(ne = setTimeout(() => {
												se || (m.current && R.current ? (document.body.style.overflow = 'hidden') : (document.body.style.overflow = ''));
											}, 100));
									}, 10),
									le = (ae) => {
										S(), k && k(ae);
			...
			'./components/src/components/Templates/AutocompleteFixed/AutocompleteFixed.tsx'(F, u, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					r = e('../../node_modules/preact/hooks/dist/hooks.module.js'),
						...
						const A = () => {
							...
							oe = (m) => {
								if (m) {
									...
									return {
										top: R.top + window.scrollY + ($?.top || 0),
										left: R.left + window.scrollX + ($?.left || 0),
										width: R.width,
										height: R.height,
									};
			...
			'./components/src/utilities/componentArgs.ts'(F, u, e) {
				'use strict';
				const t = {
					className: {
			...
			'./components/src/utilities/snapify.ts'(F, u, e) {
				'use strict';
				e.d(u, { p: () => j });
			...
			'./components/src/utilities/storybook.tsx'(F, u, e) {
				'use strict';
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					r = e('../../node_modules/preact/hooks/dist/hooks.module.js');
				const b = 'prism-block',
			...
			'../../node_modules/memoizerific sync recursive'(F) {
				...
				(u.keys = () => []), (u.resolve = u), (u.id = '../../node_modules/memoizerific sync recursive'), (F.exports = u);
			},
		},
	]);
})();

//# sourceMappingURL=components-Templates-AutocompleteFixed-AutocompleteFixed-stories.29e28fb3.iframe.bundle.js.map
