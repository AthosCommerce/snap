			...
			'./components/src/components/Molecules/Result/Result.tsx'(g, d, e) {
				...
				const H = () =>
					...
					L = (0, n.PA)((G) => {
						...
						let te = c?.name;
						m.truncateTitle && (te = D.x(c?.name || '', m.truncateTitle.limit, m.truncateTitle.append));
						const ue = (0, b.Z)(m, H),
											...
											!J &&
												(0, s.Y)('div', {
													...
													children: (0, s.Y)('a', {
														...
														children: I
															? (0, s.Y)(a._, { ...h.image })
															: (0, s.Y)(k.Q, { ...h.overlayBadge, controller: R, children: (0, s.Y)(a._, { ...h.image }) }),
													}),
												}),
											(0, s.FD)('div', {
												...
												children: [
													...
													!ne &&
														(0, s.Y)('div', {
															...
															children: (0, s.Y)(Y.$, { ...h.button, ...ge.addToCartButtonText.all }),
														}),
												],
											}),
										],
				...
				const T = { default: {}, mobile: {}, tablet: {}, desktop: {} },
					...
					k = (0, n.PA)((B) => {
						const Y = (0, u.u)(),
							...
							P = (0, O.v6)('recommendationEmail', Y, z, B),
							...
							{ ComponentOverride: Z, shouldWaitForNamedOverride: J } = (0, D.x)(Q, _ ? I : void 0),
							W = _ ? Z : y,
							X = {
				...
				function s(l, n) {
					...
					(l.prototype.toName = function (i) {
						...
						if (i?.closest) {
							...
							for (var D in o) {
								var T = ((f = A), (p = a[D]), Math.pow(f.r - p.r, 2) + Math.pow(f.g - p.g, 2) + Math.pow(f.b - p.b, 2));
								T < u && ((u = T), (M = D));
							}
							return M;
						}
