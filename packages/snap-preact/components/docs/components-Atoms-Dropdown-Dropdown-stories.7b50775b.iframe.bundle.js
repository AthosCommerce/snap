(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[4578],
		{
			'./components/src/components/Atoms/Dropdown/Dropdown.stories.tsx'(v, a, e) {
				'use strict';
				e.r(a),
					e.d(a, {
						Default: () => b,
			...
			'./components/src/components/Atoms/Dropdown/Dropdown.tsx'(v, a, e) {
				'use strict';
				e.d(a, { m: () => ee });
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					ee = (0, f.PA)((E) => {
						...
						const _ = (t, w) => {
							...
							Z = (0, o.FD)('div', {
								...
								children: [(0, g.Y)(M, { open: u, toggleOpen: _, treePath: I }), (0, g.Y)(A, { open: u, toggleOpen: _, treePath: I })],
							});
						return (0, o.Y)(b._, {
							children: (0, o.FD)('div', {
								...$,
								...
								children: [
									(0, o.Y)('div', {
										...
										children: (0, g.Y)(se, { open: u, toggleOpen: _, treePath: I }),
									}),
									P
										? (M || A) &&
										  (0, d.createPortal)(
												(0, o.Y)('div', {
													...
													css: $.css,
													style: { position: 'absolute', top: R.top, left: R.left, width: R.width, zIndex: 9999, pointerEvents: u ? 'auto' : 'none' },
													children: Z,
												}),
												document.body
										  )
			...
			'./components/src/hooks/useClickOutside.tsx'(v, a, e) {
				'use strict';
				e.d(a, { L: () => d });
