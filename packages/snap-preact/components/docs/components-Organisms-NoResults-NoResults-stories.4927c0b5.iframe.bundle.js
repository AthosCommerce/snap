	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[3471],
		{
			...
			'./components/src/components/Organisms/NoResults/NoResults.stories.tsx'(u, a, t) {
				'use strict';
				t.r(a), t.d(a, { Default: () => r, WithRecommendations: () => d, __namedExportsOrder: () => v, default: () => o });
					...
					B = (0, i.PA)((K) => {
						const Y = (0, e.u)(),
							...
							T = (0, v.v6)('noResults', Y, w, K),
							{
								...
								hideSuggestionsTitleText: F,
								hideContactsTitleText: H,
								suggestionsList: _,
								hideContact: V,
								contactsTitleText: E,
								hideSuggestions: z,
						...
						const Q = (0, g.Z)(T, I),
							...
							{ ComponentOverride: ot, shouldWaitForNamedOverride: nt } = (0, O.x)(et, q),
							{ ComponentOverride: at, shouldWaitForNamedOverride: lt } = (0, O.x)(st, tt),
							it = ot,
							rt = at;
						let p;
						if (R && y?.templates) {
							...
							children: [
								f &&
									(typeof f == 'string'
										...
										: (0, s.Y)('div', { className: 'ss__no-results__slot', children: (0, d.Y)(f, { controller: L, treePath: Z }) })),
								!z &&
									(C || P) &&
									(0, s.FD)('div', {
										className: 'ss__no-results__suggestions',
										children: [
											C && !F && (0, s.Y)('h3', { className: 'ss__no-results__suggestions__title', ...x.suggestionsTitleText?.all }),
								...
								!V &&
									...
									(0, s.FD)('div', {
										...
										children: [
											E && !H && (0, s.Y)('h3', { className: 'ss__no-results__contact__title', ...x.contactsTitleText?.all }),
...
//# sourceMappingURL=components-Organisms-NoResults-NoResults-stories.4927c0b5.iframe.bundle.js.map
