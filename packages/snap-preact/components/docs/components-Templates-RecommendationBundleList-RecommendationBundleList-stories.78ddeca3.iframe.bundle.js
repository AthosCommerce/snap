				...
				const B = () =>
					...
					l = (0, p.PA)((o) => {
						const i = (0, r.u)(),
							...
							{ treePath: v, disableStyles: D, controller: A, style: S, styleScript: w, themeStyleScript: L, ...M } = s,
							j = {
								recommendationBundle: {
									seedText: '',
									ctaInline: !1,
							...
							U = (0, u.v6)(O, i, {}, s),
							K = (0, f.Z)(U, B);
						return (0, t.Y)(g.g, { controller: A, ...K, ...j.recommendationBundle, ...M });
					}),
					c = (0, p.PA)((o) => {
						const i = o.cartStore,
							s = `ss__${(0, _.b)(O)}`;
						o.onAddToCart = (L) => {
							D(!0), o.onAddToCart(L), setTimeout(() => D(!1), o.ctaButtonSuccessTimeout);
						};
						const [v, D] = (0, b.J0)(!1);
						o.addedToCart = v;
						const A = {
							...
							S = T()({}, o.lang || {}),
							w = (0, x.u)(S, {}, { activeBreakpoint: o?.theme?.activeBreakpoint });
						return (0, t.FD)(t.FK, {
							children: [
								(0, t.FD)('div', {
									...
									children: [
										(0, t.Y)('div', {
											...
											children: i.items.map((L) => {
												const M = L.display.mappings.core;
												return (0, t.FD)('div', {
													...
													children: [
														i.msrp && i.msrp !== i.price
															? (0, t.FD)('label', {
																	...
																	children: ['Was ', (0, t.Y)(h.g, { ...A.subtotalStrike, lineThrough: !0, value: i.msrp })],
															  })
															: (0, t.Y)(t.FK, {}),
														(0, t.Y)('label', {
															className: `${s}__wrapper__cta__subtotal__price`,
															children: (0, t.Y)(h.g, { ...A.subtotalPrice, value: i.price }),
														}),
													],
												}),
											],
						...
						return (
							(0, t.vJ)(() => {
								...
								return (
									...
									() => {
										m(!1), B(), _.current && window.clearTimeout(_.current), T && n.current && T.unobserve(n.current);
									}
								);
							}, [n, P]),
			...
			'./components/src/utilities/snapify.ts'(I, a, e) {
				...
				class T {
					static recommendation(c) {
						const o = c.id;
						if (b[o]) return b[o];
						const i = (b[o] = B({ client: R, controller: c }));
						return (
					...
					static autocomplete(c) {
						const o = c.id;
						if (b[o]) return b[o];
						const i = (b[o] = O({ client: R, controller: c }));
						return (
							i.on('afterStore', async ({ controller: s }, v) => {
								s.log.debug('controller', s), s.log.debug('store', s.store.toJSON()), await v();
							}),
					...
					static search(c) {
						const o = c.id;
						if (b[o]) return b[o];
						const i = (b[o] = x({ client: R, controller: c }));
						return (
							i.on('afterStore', async ({ controller: s }, v) => {
								s.log.debug('controller', s), s.log.debug('store', s.store.toJSON()), await v();
							}),
...
//# sourceMappingURL=components-Templates-RecommendationBundleList-RecommendationBundleList-stories.78ddeca3.iframe.bundle.js.map
