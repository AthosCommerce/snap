						...
						(0, m.W)(
							(0, g.PA)((y) => {
								const M = (0, r.u)(),
									...
									d = (0, u.v6)('inlineBanner', M, A, y),
									{ banner: _, className: D, internalClassName: v, disableA11y: T, layout: U, onClick: B } = d,
								...
								return _ && _.value
									? (0, s.Y)(t._, {
											children: (0, s.Y)('div', {
												...
												role: 'article',
												ref: (w) => {
													T || (0, f.iy)(w), y.trackingRef(w);
												},
												className: o()('ss__inline-banner', `ss__inline-banner--${U}`, D, v),
												...J,
				...
				const U = () =>
					...
					B = (0, n.PA)((W) => {
						const $ = (0, u.u)(),
							...
							{ overrideElement: L, shouldRenderDefault: ie } = (0, v._)('result', {
								...x,
						...
						const I = h?.display?.mappings.core || h?.mappings?.core,
							...
							k = {
								...
								price: { internalClassName: 'ss__result__price', ...(0, c.s)({ disableStyles: K }), theme: x.theme, treePath: S },
								calloutBadge: {
								...
								image: {
									...
									alt: I?.name || '',
									src: I?.imageUrl || '',
									...(0, c.s)({ disableStyles: K, fallback: se }),
									theme: x.theme,
									treePath: S,
								},
								rating: {
						...
						const _e = (0, O.Z)(x, U),
							...
							fe = _()(pe, x.lang || {}),
							ge = (0, D.u)(fe, { result: h, controller: j }),
									...
									children: (0, s.FD)('article', {
										...
										children: [
											...
											(0, s.FD)('div', {
												...
												children: [
													!H && (0, s.Y)(y.W, { ...k.calloutBadge, controller: j }),
													!q &&
														(0, s.Y)('div', {
			...
			'./components/src/components/Organisms/Results/Results.tsx'(C, i, e) {
				...
				const v = ({ gapSize: B, columns: W }) =>
					...
					U = (0, n.PA)((B) => {
						...
						const { disableStyles: H, className: q, internalClassName: ee, layout: te, theme: F, excludeBanners: se, controller: K, treePath: G } = h,
							V = h.resultComponent,
							{ overrideElement: ne, shouldRenderDefault: Y } = (0, D._)('results', h);
						if (!Y) return ne;
						const j = typeof V == 'string',
							oe = j ? V : '',
						...
						const ae = (0, O.Z)({ ...h, columns: te == p.V.list ? 1 : h.columns }, v),
							S = j ? r()(F || {}, { components: { result: { customComponent: V } } }) : F;
						return z?.length
							? (0, s.Y)(P._, {
									children: (0, s.Y)('div', {
										...ae,
										...
										children: z.map((L) =>
											L.type === m.c.BANNER
												...
												? (0, s.Y)(d.o, {
														result: L,
														controller: K,
														children: (0, f.Y)(Q, { key: L.id, controller: K, result: L, theme: S, treePath: G }),
												  })
												: (0, s.Y)(T, { ...X.result, result: L, layout: h.layout, controller: K }, L.id)
										),
									}),
							  })
							: null;
				...
				const E = { ResultTracker: () => (0, a.AH)({}) },
					u = (0, n.PA)((p) => {
						const f = (0, l.u)(),
							...
							{ children: O, result: P, track: R, controller: y, className: M, internalClassName: b, disableStyles: A, style: d } = c,
							_ = { ...g, ...R },
							{ ref: D, inViewport: v } = (0, m.Q)();
						v && _.impression && y?.track.product.impression(P);
						const T = {};
						return (
							A ? d && (T.css = [d]) : (T.css = [E.ResultTracker(), d]),
							(0, s.Y)('div', {
								className: t()('ss__result-tracker', `ss__${y?.type}-result-tracker`, M, b),
								onClick: (U) => {
									_.click && y?.track.product.click(U, P);
								},
								ref: D,
								...T,
								children: O,
						...
						return (
							(0, s.vJ)(() => {
										...
										u > 0
											? ((g.current = Date.now()),
											  ...
											  (c.current = window.setTimeout(() => {
													f(!0), m && t.current && y && y.unobserve(t.current);
											  }, u)))
											: (f(!0), m && t.current && y && y.unobserve(t.current));
									},
									d = () => {
								...
								return (
									...
									() => {
										f(!1), b(), c.current && window.clearTimeout(c.current), y && t.current && y.unobserve(t.current);
									}
								);
							}, [t, O]),
			...
			'./components/src/providers/withTracking.tsx'(C, i, e) {
				...
				function t(l) {
					...
					return (E) => {
						...
						const { ref: P, inViewport: R, updateRef: y } = (0, a.Q)(),
							M = (p || f || (c && g?.[c]?.[0]))?.responseId,
							b = (0, n.li)(M),
							A = (0, n.li)(!1);
						b.current !== M && (A.current = !0),
							(0, n.vJ)(() => {
								b.current !== M && ((b.current = M), y(P.current));
							}, [M, y]),
							(0, n.vJ)(() => {
						...
						const _ = (0, n.hb)(
							(v) => {
								d ? u?.track.banner.click(v, g[c][0]) : u?.track.product.click(v, p || f);
							},
							[u, p, f, c, g]
						);
						(0, n.vJ)(() => {
			...
			'./components/src/utilities/snapify.ts'(C, i, e) {
				...
				class y {
					static recommendation(_) {
						const D = _.id;
						if (P[D]) return P[D];
						const v = (P[D] = b({ client: R, controller: _ }));
						return (
							v.on('afterStore', async ({ controller: T }, U) => {
					...
					static autocomplete(_) {
						const D = _.id;
						if (P[D]) return P[D];
						const v = (P[D] = A({ client: R, controller: _ }));
						return (
							v.on('afterStore', async ({ controller: T }, U) => {
								T.log.debug('controller', T), T.log.debug('store', T.store.toJSON()), await U();
							}),
					...
					static search(_) {
						const D = _.id;
						if (P[D]) return P[D];
						const v = (P[D] = M({ client: R, controller: _ }));
						return (
							v.on('afterStore', async ({ controller: T }, U) => {
								T.log.debug('controller', T), T.log.debug('store', T.store.toJSON()), await U();
							}),
...
//# sourceMappingURL=components-Organisms-Results-Results-stories.daaa123a.iframe.bundle.js.map
