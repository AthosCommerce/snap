...
(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[5759],
		{
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/fieldNameToComponentName/fieldNameToComponentName.js'(C, l, e) {
				const t = (r) => r.replace(/_/g, '-').toLowerCase();
				e.d(l, ['P', 0, t]);
			},
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/currency.js'(C, l, e) {
				e.d(l, { G: () => r });
			...
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/formatNumber.js'(C, l, e) {
				e.d(l, { Z: () => t });
				function t(o, c) {
			...
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/handleize.js'(C, l, e) {
				e.d(l, { p: () => t });
				function t(r) {
			...
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/truncate.js'(C, l, e) {
				e.d(l, { x: () => t });
				function t(r, o, c) {
			...
			'./components/src/components/Molecules/Carousel/Carousel.tsx'(C, l, e) {
				...
				const Y = ({ vertical: M, theme: z }) =>
					...
					I = (0, _.PA)((M) => {
						const z = (0, W.u)(),
							re = (0, j.LU)(),
							me = {
								breakpoints: M.vertical ? JSON.parse(JSON.stringify(V)) : JSON.parse(JSON.stringify(Z)),
								pagination: !1,
								navigation: !0,
						...
						let i = (0, v.v6)('carousel', z, me, M),
							d;
						if (
							!(M.theme?.type == 'templates' || z?.type == 'templates') &&
							i.breakpoints &&
						...
						let U = i.pagination,
							m = i.navigation,
							H = i.scrollbar;
						const oe = { icon: { internalClassName: 'ss__carousel__icon', ...(0, T.s)({ disableStyles: G }), theme: i.theme, treePath: se } },
							x = Array.isArray(de) ? [D.A, b.A, y.A, L.A].concat(de) : [D.A, b.A, y.A, L.A],
								...
								? (0, t.Y)(R._, {
										children: (0, t.FD)('div', {
											...
											children: [
												m !== !1 &&
													(0, t.Y)('div', {
														className: s()('ss__carousel__prev-wrapper', { 'ss__carousel__prev-wrapper--hidden': ae }),
														children: (0, t.Y)('div', {
												...
												(0, t.Y)(p.RC, {
													...
													onBeforeInit: (n) => {
														m &&
															...
															(n.params.navigation.nextEl = N.current ? N.current : void 0)),
															k && k(n);
													},
													onInit: (n) => {
														ie && ie(n);
												...
												m !== !1 &&
													(0, t.Y)('div', {
														className: s()('ss__carousel__next-wrapper', { 'ss__carousel__next-wrapper--hidden': ae }),
														children: (0, t.Y)('div', {
				...
				e.d(l, ['FN', 0, I, 'K', 0, Z, 'og', 0, V]);
			},
			'./components/src/components/Molecules/Result/Result.tsx'(C, l, e) {
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					r = e('../../node_modules/preact/hooks/dist/hooks.module.js'),
				...
				const I = () =>
					...
					M = (0, o.PA)((z) => {
						...
						const m = P?.display?.mappings.core || P?.mappings?.core,
							...
							x = {
								variantSelection: {
									...
									...(0, f.s)({ disableStyles: k }),
									theme: d.theme,
									treePath: A,
								},
								price: { internalClassName: 'ss__result__price', ...(0, f.s)({ disableStyles: k }), theme: d.theme, treePath: A },
								calloutBadge: {
								...
								image: {
									...
									alt: m?.name || '',
									src: m?.imageUrl || '',
									...(0, f.s)({ disableStyles: k, fallback: ie }),
									theme: d.theme,
									treePath: A,
								},
								rating: {
						...
						const $ = (0, b.Z)(d, I),
							N = { addToCartButtonText: { value: H ? _e : de } },
							S = w()(N, d.lang || {}),
							fe = (0, Y.u)(S, { result: P, controller: G }, { activeBreakpoint: re?.activeBreakpoint }),
						...
						return m
							? (0, t.Y)(p._, {
									children: (0, t.FD)('article', {
										...$,
										className: _()('ss__result', `ss__result--${te}`, { 'ss__result--sale': q }, le, ce),
										ref: J,
										children: [
											!ae &&
												(0, t.Y)('div', {
													...
													children: (0, t.Y)('a', {
														...
														children: ee
															? (0, t.Y)(u._, { ...x.image })
															: (0, t.Y)(R.Q, { ...x.overlayBadge, controller: G, children: (0, t.Y)(u._, { ...x.image }) }),
													}),
												}),
											(0, t.FD)('div', {
			...
			'./components/src/components/Templates/Recommendation/Recommendation.tsx'(C, l, e) {
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					r = e('../../node_modules/preact/hooks/dist/hooks.module.js'),
					o = e('../../node_modules/@emotion/react/dist/emotion-react.browser.esm.js'),
					c = e('../../node_modules/classnames/index.js'),
				...
				const Z = ({ vertical: I }) => (0, o.AH)({ height: I ? '100%' : void 0, '.ss__result__image-wrapper': { height: I ? '85%' : void 0 } }),
					V = (0, _.PA)((I) => {
						const M = (0, g.u)(),
							z = (0, W.LU)(),
							re = {
								breakpoints: I.vertical ? JSON.parse(JSON.stringify(p.og)) : JSON.parse(JSON.stringify(p.K)),
								pagination: !1,
								loop: !0,
							...
							me = { name: I.controller?.store?.profile?.tag?.toLowerCase(), ...I };
						let i = (0, f.v6)('recommendation', M, re, me),
							d;
						!(I.theme?.type == 'templates' || M?.type == 'templates') &&
							i.breakpoints &&
						...
						const {
							...
							ne = U ? oe : A,
							$ = { enabled: !0, offset: '10%', ...de };
						if (!O || O.type !== 'recommendation')
							throw new Error("<Recommendation> Component requires 'controller' prop with an instance of RecommendationController");
						const N = X || O.store?.results;
						if (Array.isArray(B) && B.length !== N.length)
							return (
								O.log.error(
						...
						const S = {
							...
							[q, n] = (0, r.J0)(!1),
							a = (0, r.li)(null);
						(!$?.enabled || (0, b.v)(a, `${$.offset} 0px ${$.offset} 0px`, !0)) && n(!0);
						const Pe = { titleText: { value: `${P}` } },
							De = E()(Pe, i.lang || {}),
							Me = (0, w.u)(De, {}, { activeBreakpoint: M?.activeBreakpoint });
						return (Array.isArray(B) && B.length) || N?.length
							? (0, t.Y)(L._, {
									children: (0, t.Y)('div', {
										...fe,
										...
										children: q
														...
														(0, t.Y)(p.FN, {
															...
															children:
																Array.isArray(B) && B.length
																	? B.map((Q, Oe) => (0, t.Y)(Y.o, { controller: O, result: N[Oe], children: Q }))
																	: N.map((Q) =>
																			(0, t.Y)(Y.o, {
																				controller: O,
																				result: Q,
											...
											: (0, t.Y)(K.l, {
													...
													children:
														Array.isArray(B) && B.length
															? B.map((Q, Oe) => (0, t.Y)(Y.o, { controller: O, result: N[Oe], children: (0, t.Y)(t.FK, {}) }))
															: N.map((Q) => (0, t.Y)(Y.o, { controller: O, result: Q, children: (0, t.Y)(t.FK, {}) })),
											  }),
									}),
							  })
							: (0, t.Y)(t.FK, {});
			...
			'./components/src/components/Trackers/Recommendation/ProfileTracker/RecommendationProfileTracker.tsx'(C, l, e) {
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const E = () => (0, o.AH)({}),
					p = (0, c.PA)((h) => {
						const { children: T, className: v, internalClassName: f } = h,
							D = (0, r.v2)(T),
							b = (0, u.Z)(h, E);
						return D.length ? (0, t.Y)('div', { className: _()('ss__recommendation-profile-tracker', v, f), ...b, children: T }) : null;
					});
				e.d(l, ['l', 0, p]);
			},
			'./components/src/components/Trackers/ResultTracker/ResultTracker.tsx'(C, l, e) {
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const p = { ResultTracker: () => (0, r.AH)({}) },
					h = (0, o.PA)((T) => {
						const v = (0, _.u)(),
							f = (0, u.v6)('resultTracker', v, {}, T),
							D = { impression: !0, click: !0 },
							{ children: b, result: y, track: L, controller: g, className: R, internalClassName: W, disableStyles: j, style: K } = f,
							w = { ...D, ...L },
						...
						return (
							...
							(0, t.Y)('div', {
								className: s()('ss__result-tracker', `ss__${g?.type}-result-tracker`, R, W),
								onClick: (I) => {
									w.click && g?.track.product.click(I, y);
								},
								ref: Y,
								...V,
								children: b,
			...
			'./components/src/hooks/useIntersection.tsx'(C, l, e) {
			...
			'./components/src/hooks/useIntersectionAdvanced.tsx'(C, l, e) {
				var t = e('../../node_modules/preact/hooks/dist/hooks.module.js');
				const r = 250,
					o = (s, _ = {}) => {
			...
			'./components/src/utilities/createImpressionObserver.ts'(C, l, e) {
				e.d(l, { Q: () => s });
				var t = e('../../node_modules/preact/hooks/dist/hooks.module.js'),
					...
					(r.prototype.toName = function (E) {
						...
						if (E?.closest) {
							var v = this.toRgb(),
								f = 1 / 0,
								D = 'black';
							if (!u.length) for (var b in c) u[b] = new r(c[b]).toRgb();
							for (var y in c) {
