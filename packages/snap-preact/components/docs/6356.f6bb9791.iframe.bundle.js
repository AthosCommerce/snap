				...
				const j = () =>
					...
					Z = (0, n.PA)((X) => {
						...
						const f = M?.display?.mappings.core || M?.mappings?.core,
							...
							W = {
								...
								button: {
									...
									onClick: (S) => {
										Q(!0), Y && Y(S, M), k?.addToCart([M]), setTimeout(() => Q(!1), ae);
									},
									...(0, m.s)({ disableStyles: I }),
									theme: u.theme,
									treePath: A,
						...
						const ue = (0, R.Z)(u, j),
							...
							pe = K()(fe, u.lang || {}),
							ge = (0, V.u)(pe, { result: M, controller: k }, { activeBreakpoint: z?.activeBreakpoint }),
									...
									children: (0, s.FD)('article', {
										...
										children: [
											...
											(0, s.FD)('div', {
												...
												children: [
													!H && (0, s.Y)(g.W, { ...W.calloutBadge, controller: k }),
													!ee &&
														(0, s.Y)('div', {
				...
				const V = ({ gapSize: C, columns: j }) =>
					...
					G = (0, l.PA)((C) => {
						const j = (0, D.u)(),
							...
							z = { name: C.controller?.store?.profile?.tag?.toLowerCase(), ...C };
						let d = (0, T.v6)('recommendationGrid', j, X, z);
						if (!(C.theme?.type == 'templates' || j?.type == 'templates')) {
							const v = (0, B.X)(d?.breakpoints || {}),
								f = r()(d?.theme || {}, v?.theme || {}, { arrayMerge: (de, Q) => Q });
							d = { ...d, ...v, theme: f };
						}
						const {
								disableStyles: q,
						...
						const ae = (0, P.Z)(d, V),
							...
							A = (0, U.li)(null);
						return (
							(!Y?.enabled || (0, x.v)(A, `${Y.offset} 0px ${Y.offset} 0px`, !0)) && ie(!0),
							E?.length
								? (0, s.Y)(m._, {
										children: (0, s.Y)('div', {
											...ae,
																...
																children: E.map((v) =>
																	J && L
																		? (0, _.Y)(J, {
																				controller: L,
																				result: v,
																				theme: N ? r()(F || {}, { components: { result: { customComponent: I } } }) : F,
																				treePath: $,
																		  })
																		: ne
																		? null
																		: (0, s.Y)(O.o, {
																				result: v,
																				controller: L,
																				children: (0, s.Y)(i.Q, { ...re.result, result: v, controller: L, treePath: $ }, v.id),
																		  })
																),
															}),
														],
				...
				const _ = { ResultTracker: () => (0, l.AH)({}) },
					p = (0, n.PA)((T) => {
						const P = (0, a.u)(),
							...
							{ children: R, result: b, track: B, controller: g, className: O, internalClassName: y, disableStyles: U, style: x } = m,
							K = { ...D, ...B },
							{ ref: V, inViewport: G } = (0, i.Q)();
						G && K.impression && g?.track.product.impression(b);
						const C = {};
						return (
							U ? x && (C.css = [x]) : (C.css = [_.ResultTracker(), x]),
							(0, s.Y)('div', {
				...
				function s(l, n) {
					...
					(l.prototype.toName = function (i) {
						...
						if (i?.closest) {
							...
							for (var b in o) {
								var B = ((_ = P), (p = r[b]), Math.pow(_.r - p.r, 2) + Math.pow(_.g - p.g, 2) + Math.pow(_.b - p.b, 2));
								B < m && ((m = B), (D = b));
							}
							return D;
						}
