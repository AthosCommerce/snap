...
\`\`\``,
        ...
        <div>props.children will be rendered here</div>
			...
			'./components/src/components/Atoms/Overlay/Overlay.tsx'(p, o, e) {
				...
				const g = ({ transitionSpeed: m, color: P }) =>
					(0, s.AH)({
						...
						top: '0',
						left: '-100%',
						'&.ss__overlay--active': { transition: `background ${m} ease, left 0s ease`, background: P, left: '0' },
					});
				function E(m) {
					const P = (0, n.u)(),
						L = { color: 'rgba(0,0,0,0.8)', transitionSpeed: '0.25s', treePath: (0, u.LU)() },
						S = (0, c.v6)('overlay', P, L, m),
						{ active: l, onClick: x, disableA11y: h, className: B, internalClassName: C } = S,
						{ overrideElement: W, shouldRenderDefault: f } = (0, _._)('overlay', S);
					if (!f) return W;
					const O = (0, v.Z)(S, g);
					return (0, t.Y)(a._, {
						children: (0, t.Y)('div', {
							onClick: (b) => x && l && x(b),
							ref: (b) => (h ? null : (0, i.iy)(b, l ? 0 : -1)),
							className: d()('ss__overlay', { 'ss__overlay--active': l }, B, C),
							...O,
						}),
					});
				}
				...
				const L = ({ slideDirection: l, transitionSpeed: x, width: h }) =>
					...
					S = (0, r.PA)((l) => {
						const x = (0, g.u)(),
							...
							{ overrideElement: F, shouldRenderDefault: J } = (0, P._)('slideout', C);
						if (!J) return F;
						const z = {
								overlay: {
									internalClassName: 'ss__slideout__overlay',
									...(0, c.s)({ disableStyles: N, color: Y, transitionSpeed: k }),
									theme: C?.theme,
									treePath: D,
								},
							},
						...
						return (
							(0, s.vJ)(() => {
								if (T) {
									let A;
									typeof T == 'string' ? (A = document.querySelector(T)) : (A = T), A && A.addEventListener('click', () => M());
								}
							}, []),
							R || !O
								? (0, t.FD)(i._, {
										children: [
											b &&
												(w
													? (0, u.Y)(b, { toggleActive: M, active: y, treePath: D })
													: (0, t.Y)('div', {
															className: 'ss__slideout__button',
															onClick: () => M(),
															children: (0, u.Y)(b, { active: y, treePath: D }),
													  })),
											(0, t.Y)('div', {
												className: n()('ss__slideout', V, $, { 'ss__slideout--active': y }),
												style: { visibility: O || R ? 'visible' : 'hidden' },
												...Z,
												children: H && (0, u.Y)(W, { toggleActive: M, active: y, treePath: D }),
											}),
											(0, t.Y)(j.h, { ...z.overlay, active: y, onClick: M }),
										],
								  })
								: null
						);
						...
						c &&
							n.addEventListener('keydown', function (i) {
								...
								(i.key === 'Tab' || i.keyCode === t) &&
									(i.shiftKey
										? document.activeElement === E && (m.focus(), i.preventDefault())
										: document.activeElement === m && (E.focus(), i.preventDefault()));
							}));
				}
			},
...
//# sourceMappingURL=components-Molecules-Slideout-Slideout-stories.a028df76.iframe.bundle.js.map
