				...
				const H = () =>
					...
					I = (0, n.PA)(($) => {
						...
						const _ = c?.display?.mappings.core || c?.mappings?.core,
							...
							g = {
								...
								button: {
									...
									onClick: (v) => {
										te(!0), q && q(v, c), b?.addToCart([c]), setTimeout(() => te(!1), de);
									},
									...(0, u.s)({ disableStyles: E }),
									theme: m.theme,
									treePath: P,
						...
						const ge = (0, D.Z)(m, H),
							...
							Ee = V()(he, m.lang || {}),
							oe = (0, C.u)(Ee, { result: c, controller: b }, { activeBreakpoint: W?.activeBreakpoint }),
							ne = !!(_?.msrp && _?.price && _?.price < _?.msrp),
							ve = b?.store?.config?.asyncState?.product?.price ? c.state.priceFetched : !0;
						return _
							? (0, s.Y)(f._, {
												...
												(0, s.FD)('div', {
													...
													children: [
														(0, s.Y)('a', {
															...
															children: U
																? (0, s.Y)(a._, { ...g.image })
																: (0, s.Y)(Y.Q, { ...g.overlayBadge, controller: b, children: (0, s.Y)(a._, { ...g.image }) }),
														}),
														!ce && b?.quickviewManager && (0, s.Y)(A.$, { ...g.quickviewButton, ...oe.quickviewButtonText.attributes }),
													],
												}),
											(0, s.FD)('div', {
												className: 'ss__result__details',
												children: [
													!U && (0, s.Y)(S.W, { ...g.calloutBadge, controller: b }),
													!F &&
														(0, s.Y)('div', {
				...
				const y = { default: {}, mobile: {}, tablet: {}, desktop: {} },
					...
					Y = (0, n.PA)((R) => {
						const A = (0, u.u)(),
							...
							{ controller: L, results: Q, resultWidth: H, treePath: I, disableStyles: $, internalClassName: W, className: G } = C,
							B = C.resultComponent,
							m = (0, O.uk)(),
							c = typeof B == 'string',
							U = c ? B : '',
							F = m?.templates?.library.import.component.result || {},
							{ ComponentOverride: Z, shouldWaitForNamedOverride: J } = (0, T.x)(F, c ? U : void 0),
							K = c ? Z : B,
							X = {
						...
						return k.length > 0
							? (0, s.Y)('div', {
									className: a()('ss__recommendation-email', G, W),
									...E,
									children: k.map((N, j) =>
										(0, s.Y)(
											'div',
