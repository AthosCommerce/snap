		...
		[7615],
		{
			...
			'./components/src/components/Molecules/Carousel/Carousel.tsx'(Y, p, e) {
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					M = e('../../node_modules/swiper/modules/pagination.mjs'),
					...
					Me = e('./components/src/hooks/useCustomComponentOverride.tsx');
				const Te = ({ vertical: N, theme: G }) =>
					...
					Re = (0, f.PA)((N) => {
						...
						if (
							...
							(R = (0, he.X)(_.breakpoints)),
							R && Object.keys(R).length)
						) {
							const o = S()(_?.theme || {}, R?.theme || {}, { arrayMerge: (d, _e) => _e });
							_.autoAdjustSlides &&
								_.children.length < R.slidesPerView &&
								((R.slidesPerView = _.children.length), (R.slidesPerGroup = _.children.length)),
								(_ = { ..._, ...R, theme: o });
						}
						const {
								children: Se,
							...
							{ overrideElement: me, shouldRenderDefault: Be } = (0, Me._)('carousel', _);
						if (!Be) return me;
						let Z = _.pagination,
							A = _.navigation,
							j = _.scrollbar;
						const ue = { icon: { internalClassName: 'ss__carousel__icon', ...(0, W.s)({ disableStyles: c }), theme: _.theme, treePath: H } },
							pe = Array.isArray(y) ? [z.A, M.A, se.A, re.A].concat(y) : [z.A, M.A, se.A, re.A],
						...
						(0, l.vJ)(() => {
							if (Q.current) {
								const d = Q.current.querySelector('.swiper');
						...
						const ve = () => {
							if (Q.current) {
								const d = Q.current?.querySelectorAll('.swiper-slide-visible');
								d.forEach((_e, Ge) => {
			...
			'./components/src/components/Templates/RecommendationBundle/RecommendationBundle.tsx'(Y, p, e) {
				...
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					Me = e('./components/src/components/Molecules/Checkbox/Checkbox.tsx'),
				...
				var Re = e('./components/src/components/Atoms/Button/Button.tsx'),
				...
				const R = ({ vertical: h, separatorIcon: g, carousel: D, ctaInline: b, hasSeed: I, hideSeed: E, carouselEnabled: a, limit: u, alias: v }) => {
					...
					Se = (0, f.PA)((h) => {
						...
						const dt = (0, z.Z)({ ...a, carousel: { ...ye, slidesPerView: ie }, hasSeed: Ke, carouselEnabled: De }, R),
						...
						const Ne = (s) => {
							...
							[ut, pt] = (0, r.J0)(!1),
							Qe = (0, r.li)(null);
						(!We?.enabled || (0, je.v)(Qe, `${We.offset} 0px ${We.offset} 0px`, !0)) && pt(!0);
						const ft = {
								seedText: { value: O },
							...
							Xe = (0, r.Kr)(
								() =>
									T.map((s, C) => {
										...
										return (
											w && (ee = { ...ee, seedText: O, seed: !0, icon: J, lang: { seedText: X.seedText } }),
											!w || ((le || $?.enabled == !1) && w && !j)
												? (0, t.Y)(
														he.o,
														{
				...
				const S = () => (0, i.AH)({}),
					k = (0, m.PA)((B) => {
						const { children: W, className: te, internalClassName: U } = B,
							z = (0, l.v2)(W),
							M = (0, x.Z)(B, S);
						return z.length ? (0, t.Y)('div', { className: f()('ss__recommendation-profile-tracker', te, U), ...M, children: W }) : null;
					});
				e.d(p, ['l', 0, k]);
			},
					...
					(l.prototype.toName = function (S) {
						...
						if (S?.closest) {
							var te = this.toRgb(),
								U = 1 / 0,
								z = 'black';
							if (!x.length) for (var M in m) x[M] = new l(m[M]).toRgb();
							for (var se in m) {
