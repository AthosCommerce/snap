		...
		[594],
		{
			'./components/src/components/Molecules/Grid/Grid.tsx'(ts, b, s) {
				...
				var o = s('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					i = s('../../node_modules/mobx-react-lite/es/index.js'),
				...
				(0, F.X$)([rs.A]);
				const _s = ({ gapSize: L, columns: m, theme: S, disableOverflowAction: j }) =>
						(0, I.AH)({
							'.ss__grid__options': {
								display: 'flex',
								flexFlow: 'row wrap',
					...
					is = (0, i.PA)((L) => {
						const m = (0, g.u)(),
							j = { multiSelect: !1, columns: 4, gapSize: '8px', treePath: (0, w.LU)() },
						...
						const B = (t, d) => {
							...
							us = () => {
								const t = $ ? _ : !0,
									...
									h = c()(d, x.lang || {}),
									p = (0, z.u)(h, { limited: _, remainder: v });
								return t && v > 0 && D.length !== R
									? (0, o.Y)('div', {
											...
											...(_ ? p.showMoreText.attributes : p.showLessText.attributes),
											children: k
												? (0, ns.Y)(k, { limited: _, remainder: v, treePath: q })
												: _
									...
									children: (0, o.FD)('div', {
										...
										children: [
											...
											(0, o.FD)('div', {
												...
												children: [
													D.map((t, d) => {
														const h = C.some((O) => O.value == t.value);
														let p = !1;
							...
							D == 'slideshow' &&
								T.forEach((e) => {
									...
									if (v)
										try {
											const _ = (0, J.Mj)(v);
											_.isValid() && (R = _.isDark());
										} catch {}
									C.push({
										onClick: (_) => !k && !e?.disabled && es(_, e),
										content: (0, o.Y)('div', {
							...
							typeof T == 'object' && T?.length
								? (0, o.Y)(r._, {
										children: (0, o.Y)('div', {
											...
											children:
												D == 'slideshow'
													? (0, o.Y)(rs.b, { slides: C, ...G.slideshow })
													: (0, o.Y)(z.x, {
															...G.grid,
															options: T,
															onSelect: (e, f) => {
			...
			'./components/src/hooks/useDisplaySettings.tsx'(ts, b, s) {
				...
				function y(l) {
					...
					return (
						(0, o.vJ)(() => (n(), () => window.removeEventListener('resize', i)), []),
						(0, u.I)(() => {
							P(r(l)), n();
						}, [l]),
						c
				...
				const r = (l) => {
					...
					if (i.length) {
						for (let n = 0; n < i.length; n++) {
							const g = i[n],
								w = parseInt(Object.keys(g)[0]);
							if (n + 1 === i.length || (n === 0 && P < w)) {
								c = i[n][w];
								break;
							} else {
								const K = parseInt(Object.keys(i[n + 1])[0]);
								if (P >= w && P < K) {
									c = i[n][w];
									break;
								}
