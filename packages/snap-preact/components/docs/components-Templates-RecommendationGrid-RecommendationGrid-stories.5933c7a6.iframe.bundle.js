  ...
  return <div style={{
    maxWidth: '1200px'
				...
				const L = () =>
					...
					Q = (0, n.PA)((X) => {
						...
						const b = B?.display?.mappings.core || B?.mappings?.core,
							...
							S = {
								...
								button: {
									...
									onClick: (N) => {
										Z(!0), z && z(N, B), k?.addToCart([B]), setTimeout(() => Z(!1), ae);
									},
									...(0, m.s)({ disableStyles: U }),
									theme: T.theme,
									treePath: W,
						...
						const _e = (0, C.Z)(T, L),
							...
							fe = g()(pe, T.lang || {}),
							ge = (0, M.u)(fe, { result: B, controller: k }, { activeBreakpoint: G?.activeBreakpoint }),
											...
											!H &&
												(0, s.Y)('div', {
													...
													children: (0, s.Y)('a', {
														...
														children: J
															? (0, s.Y)(a._, { ...S.image })
															: (0, s.Y)(x.Q, { ...S.overlayBadge, controller: k, children: (0, s.Y)(a._, { ...S.image }) }),
													}),
												}),
											(0, s.FD)('div', {
												className: 'ss__result__details',
												children: [
													!J && (0, s.Y)(y.W, { ...S.calloutBadge, controller: k }),
													!ee &&
														(0, s.Y)('div', {
				...
				const M = ({ gapSize: f, columns: L }) =>
					...
					R = (0, l.PA)((f) => {
						const L = (0, E.u)(),
							...
							G = { name: f.controller?.store?.profile?.tag?.toLowerCase(), ...f };
						let _ = (0, h.v6)('recommendationGrid', L, X, G);
						if (!(f.theme?.type == 'templates' || L?.type == 'templates')) {
							const I = (0, A.X)(_?.breakpoints || {}),
								b = a()(_?.theme || {}, I?.theme || {}, { arrayMerge: (me, Z) => Z });
							_ = { ..._, ...I, theme: b };
						}
						const {
								disableStyles: q,
																...
																children: D.map((I) =>
																	$ && w
																		? (0, d.Y)($, {
																				controller: w,
																				result: I,
																				theme: Y ? a()(F || {}, { components: { result: { customComponent: U } } }) : F,
																				treePath: H,
																		  })
																		: ne
																		? null
																		: (0, s.Y)(x.o, {
																				result: I,
																				controller: w,
																				children: (0, s.Y)(c.Q, { ...re.result, result: I, controller: w, treePath: H }, I.id),
																		  })
																),
															}),
														],
			...
			'./components/src/utilities/createImpressionObserver.ts'(O, i, e) {
				...
				function t(r) {
					const a = (0, s.li)(null),
						{ inViewport: c, updateRef: d } = (0, l.v)(a, { ...r, fireOnce: !0, threshold: n, minVisibleTime: o });
			...
			'./components/src/utilities/snapify.ts'(O, i, e) {
				...
				function x(p) {
					...
					return new l.Tp(p.controller, {
						...
						store: new a.U(p.controller, { urlManager: g }),
						urlManager: g,
					...
					(l.prototype.toName = function (c) {
						...
						if (c?.closest) {
							var P = this.toRgb(),
								m = 1 / 0,
								E = 'black';
							if (!a.length) for (var C in o) a[C] = new l(o[C]).toRgb();
							for (var v in o) {
								var A = ((d = P), (u = a[v]), Math.pow(d.r - u.r, 2) + Math.pow(d.g - u.g, 2) + Math.pow(d.b - u.b, 2));
								A < m && ((m = A), (E = v));
							}
							return E;
						}
...
//# sourceMappingURL=components-Templates-RecommendationGrid-RecommendationGrid-stories.5933c7a6.iframe.bundle.js.map
