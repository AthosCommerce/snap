	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[3715],
		{
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/fieldNameToComponentName/fieldNameToComponentName.js'(w, c, t) {
				'use strict';
				const l = (a) => a.replace(/_/g, '-').toLowerCase();
				t.d(c, ['P', 0, l]);
			},
...
`,
					b = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, l.FD)('div', {
										children: [(0, l.Y)(a.oz, { options: { overrides: { code: n.Z } }, children: i }), (0, l.Y)(a.uY, { story: a.h1 })],
									}),
							},
						},
					...
					u = o.p.search({ id: 'Results', globals: { siteId: 'atkzs2' } }),
					p = (f, { loaded: { controller: E } }) =>
						(0, l.Y)('div', {
							style: { maxWidth: f?.layout == 'list' ? '650px' : '800px' },
							children: (0, l.Y)(r.n, { ...f, controller: E, results: E?.store?.results }),
						});
				(p.loaders = [async () => (await u.search(), { controller: u })]), (p.args = { layout: 'grid' });
				const m = (f, { loaded: { controller: E } }) =>
					(0, l.Y)('div', {
						style: { maxWidth: f?.layout == 'list' ? '650px' : '800px' },
						children: (0, l.Y)(r.n, { ...f, controller: E, results: E?.store?.results, layout: s.V.list }),
					});
  ...
  return <div style={{
    maxWidth: args?.layout == 'list' ? '650px' : '800px'
			...
			'./components/src/hooks/useIntersectionAdvanced.tsx'(w, c, t) {
				'use strict';
				var l = t('../../node_modules/preact/hooks/dist/hooks.module.js');
				const a = 250,
					r = (e, o = {}) => {
						const { rootMargin: s = '0px', fireOnce: i = !1, threshold: b = 0, minVisibleTime: u = 0 } = o,
							[p, m] = (0, l.J0)(!1),
							d = (0, l.li)(null),
							f = (0, l.li)(null),
							[E, y] = (0, l.J0)(0),
						...
						return (
							(0, l.vJ)(() => {
								...
								return (
									...
									() => {
										m(!1), O(), d.current && window.clearTimeout(d.current), v && e.current && v.unobserve(e.current);
									}
								);
							}, [e, E]),
							{ inViewport: p, updateRef: x }
						);
					};
				function n(e) {
			...
			'./components/src/providers/withTracking.tsx'(w, c, t) {
				...
				function e(o) {
					...
					return (b) => {
						...
						if (b.trackingRef) return (0, l.Y)(s, { ...b });
						...
						const { ref: y, inViewport: x, updateRef: v } = (0, a.Q)(),
							R = (p || m || (d && f?.[d]?.[0]))?.responseId,
							O = (0, r.li)(R),
							P = (0, r.li)(!1);
						O.current !== R && (P.current = !0),
							(0, r.vJ)(() => {
								O.current !== R && ((O.current = R), v(y.current));
							}, [R, v]),
							(0, r.vJ)(() => {
								P.current && !x && (P.current = !1);
							}, [x, R]);
						const g = d && f && !p && ['search', 'autocomplete'].includes(u?.type || '');
						x && !P.current && (g ? u?.track.banner.impression(f[d][0]) : p?.bundleSeed || u?.track.product.impression(p || m));
						const h = (0, r.hb)(
							(_) => {
			...
			'./components/src/types.ts'(w, c, t) {
				'use strict';
				t.d(c, { Q: () => a, V: () => l });
				var l = ((r) => ((r.grid = 'grid'), (r.list = 'list'), r))(l || {}),
					a = ((r) => (
						(r.GRID = 'grid'),
						(r.PALETTE = 'palette'),
						(r.LIST = 'list'),
			...
			'./components/src/utilities/createImpressionObserver.ts'(w, c, t) {
				...
				function e(o) {
					const s = (0, l.li)(null),
						{ inViewport: i, updateRef: b } = (0, a.v)(s, { fireOnce: !0, threshold: r, minVisibleTime: n, ...o });
			...
			'./components/src/utilities/snapify.ts'(w, c, t) {
				...
				class v {
					static recommendation(h) {
						const k = h.id;
						if (y[k]) return y[k];
						const _ = (y[k] = O({ client: x, controller: h }));
						return (
					...
					static autocomplete(h) {
						const k = h.id;
						if (y[k]) return y[k];
						const _ = (y[k] = P({ client: x, controller: h }));
						return (
							_.on('afterStore', async ({ controller: T }, I) => {
								T.log.debug('controller', T), T.log.debug('store', T.store.toJSON()), await I();
							}),
					...
					static search(h) {
						const k = h.id;
						if (y[k]) return y[k];
						const _ = (y[k] = R({ client: x, controller: h }));
						return (
							_.on('afterStore', async ({ controller: T }, I) => {
								T.log.debug('controller', T), T.log.debug('store', T.store.toJSON()), await I();
							}),
				...
				function P(g) {
					...
					return new r.Z(g.controller, {
						client: new e.K(g.client.globals, g.client.config),
						store: new o.Y(g.controller, { urlManager: h }),
						urlManager: h,
						eventManager: new m.E(),
						profiler: new d.U(),
						logger: new f.V(),
			...
			'./components/src/utilities/storybook.tsx'(w, c, t) {
				...
				const r = 'prism-block',
					n = (e) => {
						...
						return (
							(0, a.vJ)(() => {
								o.current && e.className?.includes('lang-') && !e.className?.includes(r) && window?.Prism?.highlightElement(o.current);
							}, [e.className, e.children, o]),
							(0, l.Y)('code', { ...e, ref: o, 'data-prismjs-copy': 'Copy' })
						);
					};
				t.d(c, ['Z', 0, n]);
			},
				...
				var l = function (a, r) {
					...
					(a.prototype.toName = function (i) {
						...
						if (i?.closest) {
							...
							for (var y in n) {
								var x = ((b = m), (u = s[y]), Math.pow(b.r - u.r, 2) + Math.pow(b.g - u.g, 2) + Math.pow(b.b - u.b, 2));
								x < d && ((d = x), (f = y));
							}
							return f;
						}
			...
			'../../node_modules/dequal/dist/index.mjs'(w, c, t) {
				...
				function a(n, e, o) {
					for (o of n.keys()) if (r(o, e)) return o;
				}
				function r(n, e) {
					var o, s, i;
					if (n === e) return !0;
					if (n && e && (o = n.constructor) === e.constructor) {
						if (o === Date) return n.getTime() === e.getTime();
						if (o === RegExp) return n.toString() === e.toString();
						if (o === Array) {
						...
						if (o === ArrayBuffer) (n = new Uint8Array(n)), (e = new Uint8Array(e));
						else if (o === DataView) {
						...
						if (!o || typeof n == 'object') {
							s = 0;
							for (o in n) if ((l.call(n, o) && ++s && !l.call(e, o)) || !(o in e) || !r(n[o], e[o])) return !1;
			...
			'../../node_modules/memoizerific sync recursive'(w) {
				function c(t) {
					const l = new Error("Cannot find module '" + t + "'");
...
//# sourceMappingURL=components-Organisms-Results-Results-stories.a15b70cb.iframe.bundle.js.map
