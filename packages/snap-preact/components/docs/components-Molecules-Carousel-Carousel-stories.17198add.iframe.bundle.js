	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[3049],
		{
			'./components/src/components/Molecules/Carousel/Carousel.stories.tsx'(v, u, n) {
				'use strict';
				n.r(u), n.d(u, { Colors: () => x, __namedExportsOrder: () => b, default: () => c });
...
`,
				...
				(x.args = { pagination: !0, hideButtons: !0, loop: !1 }),
					(x.parameters = {
						...x.parameters,
						docs: {
							...x.parameters?.docs,
        ...
        margin: '0 auto'
			...
			'./components/src/components/Molecules/Carousel/Carousel.tsx'(v, u, n) {
				...
				var t = n('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					x = n('./components/src/utilities/mergeStyles.ts'),
					b = n('../../node_modules/swiper/modules/index.mjs'),
					P = n('./components/src/components/Atoms/Icon/Icon.tsx'),
					...
					Q = n('./components/src/hooks/useCustomComponentOverride.tsx');
				const q = ({ vertical: y, theme: C }) =>
						(0, h.AH)({
							display: 'flex',
							maxWidth: '100%',
					...
					ee = (0, o.PA)((y) => {
						...
						let g = (0, f.v6)('carousel', C, ne, y),
							w;
						if (
							!(y.theme?.type == 'templates' || C?.type == 'templates') &&
							g.breakpoints &&
							...
							const r = c()(g?.theme || {}, w?.theme || {}, { arrayMerge: (p, O) => O });
							g.autoAdjustSlides &&
						...
						const {
							...
							{ overrideElement: ce, shouldRenderDefault: de } = (0, Q._)('carousel', g);
						if (!de) return ce;
						let k = g.pagination,
							_ = g.navigation,
							B = g.scrollbar;
						...
						(0, m.vJ)(() => {
							...
							_ &&
								(typeof _ == 'object'
									? (_ = { nextEl: '.ss_carousel_DNE', prevEl: '.ss_carousel_DNE', ..._ })
									: (_ = { nextEl: '.ss_carousel_DNE', prevEl: '.ss_carousel_DNE' })),
							B && (typeof B == 'object' ? (B = { enabled: !0, ...B }) : (B = { enabled: !0 }));
						const j = () => {
							if (D.current) {
								const p = D.current?.querySelectorAll('.swiper-slide-visible');
								p.forEach((O, me) => {
									O.classList.remove('swiper-last-visible-slide'), me == p.length - 1 && O.classList.add('swiper-last-visible-slide');
								});
							}
						};
						return (
							...
							R?.length
								? (0, t.Y)(V._, {
										children: (0, t.FD)('div', {
											ref: D,
											...ue,
											className: s()('ss__carousel', M ? 'ss__carousel-vertical' : '', ae, le),
											children: [
												_ !== !1 &&
													(0, t.Y)('div', {
														...
														children: (0, t.Y)('div', {
															...
															ref: I,
															onClick: z && ((r) => z(r)),
															children: re || (0, t.Y)(P.I, { icon: M ? 'angle-up' : 'angle-left', ...J.icon, name: 'prev' }),
														}),
													}),
												(0, t.Y)(i.RC, {
													...
													onBeforeInit: (r) => {
														_ &&
															...
															(r.params.navigation.nextEl = S.current ? S.current : void 0)),
															U && U(r);
													},
													onInit: (r) => {
														W && W(r);
													...
													scrollbar: B,
													onResize: (r) => {
														E.onResize && E.onResize(), r.updateSlidesClasses(), j();
													},
													onTransitionEnd: () => {
														E.onTransitionEnd && E.onTransitionEnd(), j();
													},
												...
												_ !== !1 &&
													(0, t.Y)('div', {
														...
														children: (0, t.Y)('div', {
															...
															ref: S,
															onClick: $ && ((r) => $(r)),
															children: oe || (0, t.Y)(P.I, { icon: M ? 'angle-down' : 'angle-right', ...J.icon, name: 'next' }),
														}),
													}),
											],
										}),
					...
					if (i.length) {
						for (let a = 0; a < i.length; a++) {
							...
							if (a + 1 === i.length || (a === 0 && c < f)) {
								...
								const P = parseInt(Object.keys(i[a + 1])[0]);
								if (c >= f && c < P) {
									l = i[a][f];
									break;
								}
...
//# sourceMappingURL=components-Molecules-Carousel-Carousel-stories.17198add.iframe.bundle.js.map
