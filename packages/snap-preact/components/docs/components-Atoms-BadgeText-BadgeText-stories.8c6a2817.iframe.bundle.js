	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[5114],
		{
			'./components/src/components/Atoms/BadgeText/BadgeText.stories.tsx'(c, s, e) {
				'use strict';
				e.r(s), e.d(s, { Default: () => r, __namedExportsOrder: () => u, default: () => i });
			...
			'./components/src/components/Atoms/BadgeText/BadgeText.tsx'(c, s, e) {
				...
				const y = ({ colorText: p }) =>
					...
					f = (0, o.PA)((p) => {
						const T = (0, i.u)(),
							h = { colorText: '#000000', treePath: (0, r.LU)() },
							g = (0, u.v6)('badgeText', T, h, p),
							{ value: x, tag: v, className: E, internalClassName: O } = g,
							{ overrideElement: P, shouldRenderDefault: B } = (0, _._)('badgeText', g);
						if (!B) return P;
						const b = (0, m.Z)(g, y);
						return x
							? (0, t.Y)(a._, {
									children: (0, t.Y)('div', {
										...b,
										className: d()('ss__badge-text', `ss__badge-text--${v}`, E, O),
