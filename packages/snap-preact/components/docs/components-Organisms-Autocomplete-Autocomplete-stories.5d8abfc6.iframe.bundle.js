(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9885],
		{
			'./components/src/components/Organisms/Autocomplete/Autocomplete.stories.tsx'(P, u, e) {
				'use strict';
				...
				const h = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, o.FD)('div', {
										children: [(0, o.Y)(y.oz, { options: { overrides: { code: E.Z } }, children: M }), (0, o.Y)(y.uY, { story: y.h1 })],
									}),
							},
						},
						decorators: [
					...
					l = (m, { loaded: { controller: C } }) => {
						const [a, g] = (0, T.J0)(''),
							p = [
								{ active: a === 'dress', preview: () => g('dress'), value: 'dress', type: 'suggested', url: { href: '#' } },
								{ active: a === 'shirt', preview: () => g('shirt'), value: 'shirt', type: 'suggested', url: { href: '#' } },
								{ active: a === 'shoes', preview: () => g('shoes'), value: 'shoes', type: 'suggested', url: { href: '#' } },
								{ active: a === 'hat', preview: () => g('hat'), value: 'hat', type: 'suggested', url: { href: '#' } },
								{ active: a === 'pants', preview: () => g('pants'), value: 'pants', type: 'suggested', url: { href: '#' } },
								{ active: a === 'socks', preview: () => g('socks'), value: 'socks', type: 'suggested', url: { href: '#' } },
							];
						return (
							(C.store.history = p),
							setTimeout(() => {
  ...
  return <Autocomplete {...args} controller={controller} input={controller?.config.selector} />;
			...
			'./components/src/components/Atoms/Banner/Banner.tsx'(P, u, e) {
				'use strict';
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
			...
			'./components/src/components/Organisms/Facets/Facets.tsx'(P, u, e) {
				'use strict';
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const a = () => (0, y.AH)({}),
					g = (0, M.PA)((p) => {
						const _ = (0, h.u)(),
							A = (0, f.LU)(),
							O = { facets: p.controller?.store?.facets, treePath: A };
						let t = (0, m.v6)('facets', _, O, p);
						...
						return D && D?.length > 0
							? (0, o.Y)(T._, {
									children: (0, o.Y)('div', {
										...
										...V,
										children: D.map((w) => (0, o.Y)(x.s, { ...W.facet, facet: w }, w.field)),
									}),
							  })
							: null;
					});
			...
			'./components/src/hooks/useIntersectionAdvanced.tsx'(P, u, e) {
				'use strict';
				var o = e('../../node_modules/preact/hooks/dist/hooks.module.js');
				const y = 250,
					d = (n, v = {}) => {
						const { rootMargin: M = '0px', fireOnce: x = !1, threshold: T = 0, minVisibleTime: h = 0 } = v,
							[f, l] = (0, o.J0)(!1),
							s = (0, o.li)(null),
							m = (0, o.li)(null),
							[C, a] = (0, o.J0)(0),
							...
							(0, o.vJ)(() => {
										...
										h > 0
											? ((m.current = Date.now()),
											  ...
											  (s.current = window.setTimeout(() => {
													l(!0), x && n.current && p && p.unobserve(n.current);
											  }, h)))
											: (l(!0), x && n.current && p && p.unobserve(n.current));
									},
									t = () => {
								...
								return (
									(p = new IntersectionObserver(
										...
										{ rootMargin: M, threshold: T }
									)),
									n.current && p.observe(n.current),
									() => {
										l(!1), A(), s.current && window.clearTimeout(s.current), p && n.current && p.unobserve(n.current);
									}
								);
							}, [n, C]),
							{ inViewport: f, updateRef: g }
						);
					};
				function E(n) {
			...
			'./components/src/providers/withTracking.tsx'(P, u, e) {
				'use strict';
				e.d(u, { N: () => E, W: () => n });
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				function n(v) {
					...
					return (T) => {
						...
						if (T.trackingRef) return (0, o.Y)(M, { ...T });
						...
						const { ref: a, inViewport: g, updateRef: p } = (0, y.Q)(),
							_ = (f || l || (s && m?.[s]?.[0]))?.responseId,
							A = (0, d.li)(_),
							O = (0, d.li)(!1);
						A.current !== _ && (O.current = !0),
							(0, d.vJ)(() => {
								A.current !== _ && ((A.current = _), p(a.current));
							}, [_, p]),
							(0, d.vJ)(() => {
								O.current && !g && (O.current = !1);
							}, [g, _]);
						const t = s && m && !f && ['search', 'autocomplete'].includes(h?.type || '');
						g && !O.current && (t ? h?.track.banner.impression(m[s][0]) : f?.bundleSeed || h?.track.product.impression(f || l));
						const r = (0, d.hb)(
							(c) => {
			...
			'./components/src/utilities/componentArgs.ts'(P, u, e) {
				'use strict';
				const o = {
					className: {
			...
			'./components/src/utilities/createImpressionObserver.ts'(P, u, e) {
				'use strict';
				e.d(u, { Q: () => n });
				var o = e('../../node_modules/preact/hooks/dist/hooks.module.js'),
				...
				function n(v) {
					const M = (0, o.li)(null),
						{ inViewport: x, updateRef: T } = (0, y.v)(M, { fireOnce: !0, threshold: d, minVisibleTime: E, ...v });
					return { ref: M, inViewport: x, updateRef: T };
				}
			},
			'./components/src/utilities/snapify.ts'(P, u, e) {
				'use strict';
				e.d(u, { p: () => p });
				...
				class p {
					static recommendation(r) {
						const i = r.id;
						if (a[i]) return a[i];
						const c = (a[i] = A({ client: g, controller: r }));
						return (
					...
					static autocomplete(r) {
						const i = r.id;
						if (a[i]) return a[i];
						const c = (a[i] = O({ client: g, controller: r }));
						return (
							c.on('afterStore', async ({ controller: b }, S) => {
								b.log.debug('controller', b), b.log.debug('store', b.store.toJSON()), await S();
							}),
					...
					static search(r) {
						const i = r.id;
						if (a[i]) return a[i];
						const c = (a[i] = _({ client: g, controller: r }));
						return (
							c.on('afterStore', async ({ controller: b }, S) => {
								b.log.debug('controller', b), b.log.debug('store', b.store.toJSON()), await S();
							}),
				...
				function A(t) {
					...
					return new E.c(t.controller, {
						client: new n.K(t.client.globals, t.client.config),
						store: new x.t(t.controller, { urlManager: r }),
						urlManager: r,
						eventManager: new l.E(),
						profiler: new s.U(),
						logger: new m.V(),
			...
			'./components/src/utilities/storybook.tsx'(P, u, e) {
				'use strict';
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
			...
			'../../node_modules/memoizerific sync recursive'(P) {
				...
				(u.keys = () => []), (u.resolve = u), (u.id = '../../node_modules/memoizerific sync recursive'), (P.exports = u);
			},
		},
	]);
})();

//# sourceMappingURL=components-Organisms-Autocomplete-Autocomplete-stories.5d8abfc6.iframe.bundle.js.map
