(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[7845],
		{
			'./components/src/components/Templates/AutocompleteSlideout/AutocompleteSlideout.stories.tsx'(x, a, e) {
				'use strict';
				e.r(a), e.d(a, { Default: () => m, __namedExportsOrder: () => b, default: () => S });
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					u = e('../../node_modules/@storybook/blocks/dist/index.mjs'),
					f = e('./components/src/components/Templates/AutocompleteSlideout/AutocompleteSlideout.tsx'),
				...
				const S = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, o.FD)('div', {
										children: [(0, o.Y)(u.oz, { options: { overrides: { code: g.Z } }, children: M }), (0, o.Y)(u.uY, { story: u.h1 })],
									}),
							},
						},
						decorators: [
					...
					m = (h, { loaded: { controller: y } }) => {
						const [d, s] = (0, T.J0)(''),
							w = [
								{ active: d === 'dress', preview: () => s('dress'), value: 'dress', type: 'suggested', url: { href: '#' } },
								{ active: d === 'shirt', preview: () => s('shirt'), value: 'shirt', type: 'suggested', url: { href: '#' } },
								{ active: d === 'shoes', preview: () => s('shoes'), value: 'shoes', type: 'suggested', url: { href: '#' } },
								{ active: d === 'hat', preview: () => s('hat'), value: 'hat', type: 'suggested', url: { href: '#' } },
								{ active: d === 'pants', preview: () => s('pants'), value: 'pants', type: 'suggested', url: { href: '#' } },
								{ active: d === 'socks', preview: () => s('socks'), value: 'socks', type: 'suggested', url: { href: '#' } },
							];
						y.store.history = w;
						const [D, P] = (0, T.J0)(!1);
						return (
							(0, T.vJ)(() => {
								document.querySelector('#searchInput') && P(!0);
							}, []),
							D ? (0, o.Y)(f.o, { ...h, controller: y, input: y?.config.selector }) : (0, o.Y)(o.FK, {})
						);
					};
				(m.loaders = [async () => ({ controller: await v })]),
					(m.parameters = {
						...m.parameters,
						docs: {
							...m.parameters?.docs,
  ...
  return inputFound ? <AutocompleteSlideout {...args} controller={controller} input={controller?.config.selector} /> : <></>;
			...
			'./components/src/components/Templates/AutocompleteSlideout/AutocompleteSlideout.tsx'(x, a, e) {
				'use strict';
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const w = ({}) =>
					...
					D = (0, f.PA)((P) => {
						const B = (0, S.u)(),
							...
							t = (0, p.v6)('autocompleteSlideout', B, L, P),
							r = '';
						let n = t.input,
							c = t.buttonSelector;
						...
						let A = t.controller,
							K = [A];
						I && I.active && ((A = I.active?.controller), (K = I.tabs.map((R) => R.controller)));
						const F = (0, u.li)(null),
							O = () => {
								W(!1), A.setFocused();
							},
							j = {
								autocompleteLayout: { onReset: () => O(), layout: l, tabManager: I, ...(0, i.s)({ disableStyles: _ }), theme: t?.theme, treePath: C },
								slideout: {
									width: z,
									rerender: !1,
									overlayColor: N,
						...
						n &&
							...
							(V = (0, s.x)({ input: n, controllers: K, renderedInputRef: F, renderInput: !!U, buttonSelector: c })));
						const E = { ...t };
						return (
							delete E.width,
							delete E.className,
							...
							l?.length
								? (0, o.Y)(T._, {
										children: (0, o.Y)(m.S, {
											...H,
											...j.slideout,
											className: h()('ss__autocomplete-slideout', 'ss__autocomplete-slideout__slideout', Y, J),
											active: X,
											children: (0, o.FD)('div', {
												className: 'ss__autocomplete-slideout__inner',
												ref: (R) => (0, d.iy)(R, 0, !0, O),
												children: [
													U ? (0, o.Y)(y.D, { ...j.searchInput, value: A.store.state.input || '', inputRef: F }) : (0, o.Y)(o.FK, {}),
													(0, o.Y)(v.h, { ...E, ...j.autocompleteLayout, input: V, controller: A, treePath: `${C} slideout` }),
												],
											}),
										}),
								  })
			...
			'./components/src/utilities/componentArgs.ts'(x, a, e) {
				'use strict';
				const o = {
					className: {
			...
			'./components/src/utilities/snapify.ts'(x, a, e) {
				'use strict';
				e.d(a, { p: () => D });
				...
				class D {
					static recommendation(r) {
						const n = r.id;
						if (s[n]) return s[n];
						const c = (s[n] = B({ client: w, controller: r }));
						return (
					...
					static autocomplete(r) {
						const n = r.id;
						if (s[n]) return s[n];
						const c = (s[n] = L({ client: w, controller: r }));
						return (
							c.on('afterStore', async ({ controller: l }, _) => {
								l.log.debug('controller', l), l.log.debug('store', l.store.toJSON()), await _();
							}),
					...
					static search(r) {
						const n = r.id;
						if (s[n]) return s[n];
						const c = (s[n] = P({ client: w, controller: r }));
						return (
							c.on('afterStore', async ({ controller: l }, _) => {
								l.log.debug('controller', l), l.log.debug('store', l.store.toJSON()), await _();
							}),
				...
				function P(t) {
					const r = new S.V(new m.E({ settings: { coreType: 'query', corePrefix: t.controller.id } }), v.X);
					return new u.Tp(t.controller, {
						client: new i.K(t.client.globals, t.client.config),
						store: new M.U(t.controller, { urlManager: r }),
						urlManager: r,
				...
				function B(t) {
					const r = new S.V(new m.E(), v.X).detach(!0);
				...
				function L(t) {
					const r = new S.V(new m.E(), v.X).detach();
			...
			'./components/src/utilities/storybook.tsx'(x, a, e) {
				'use strict';
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					u = e('../../node_modules/preact/hooks/dist/hooks.module.js');
				const f = 'prism-block',
					g = (i) => {
						...
						return (
							(0, u.vJ)(() => {
								p.current && i.className?.includes('lang-') && !i.className?.includes(f) && window?.Prism?.highlightElement(p.current);
			...
			'../../node_modules/memoizerific sync recursive'(x) {
				...
				(a.keys = () => []), (a.resolve = a), (a.id = '../../node_modules/memoizerific sync recursive'), (x.exports = a);
			},
		},
	]);
})();

//# sourceMappingURL=components-Templates-AutocompleteSlideout-AutocompleteSlideout-stories.ac6932a2.iframe.bundle.js.map
