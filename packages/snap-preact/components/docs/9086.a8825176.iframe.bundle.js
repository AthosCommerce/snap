	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9086],
		{
													...
													!Q && Ee && l.price && l.price > 0
														? (0, t.Y)('div', {
																...
																children: k
																	? (0, t.FD)(t.FK, {
																			children: [
																				(0, t.Y)(D.g, { ...g.price, value: l.msrp, lineThrough: !0, name: 'msrp' }),
																				'\xA0',
																				(0, t.Y)(D.g, { ...g.price, value: l.price, name: 'price' }),
																			],
																	  })
																	: (0, t.Y)(D.g, { ...g.price, value: l.price }),
														  })
														: null,
				...
				const v = { ResultTracker: () => (0, p.AH)({}) },
					f = (0, T.PA)((x) => {
						const b = (0, h.u)(),
							...
							s = { ...B, ...S },
							{ ref: r, inViewport: i } = (0, D.Q)();
						i && s.impression && A?.track.product.impression(m);
						const n = {};
						return (
							W ? o && (n.css = [o]) : (n.css = [v.ResultTracker(), o]),
							(0, t.Y)('div', {
			...
			'./components/src/utilities/snapify.ts'(E, a, e) {
				...
				function L(o) {
					const s = new v.V(new x.E({ settings: { coreType: 'query', corePrefix: o.controller.id } }), f.X);
				...
				function K(o) {
					const s = new v.V(new x.E(), f.X).detach(!0);
					return new O.c(o.controller, {
						client: new d.K(o.client.globals, o.client.config),
						store: new D.t(o.controller, { urlManager: s }),
						urlManager: s,
						eventManager: new b.E(),
						profiler: new _.U(),
						logger: new B.V(),
				...
				function W(o) {
					const s = new v.V(new x.E(), f.X).detach();
