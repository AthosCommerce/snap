				...
				const O = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, s.FD)('div', {
										children: [(0, s.Y)(i.oz, { options: { overrides: { code: u.Z } }, children: t }), (0, s.Y)(i.uY, { story: i.h1 })],
									}),
							},
						},
					...
					f = (y, { loaded: { controller: M } }) => {
						...
						return (
							...
							(0, s.Y)('div', { style: { maxWidth: y?.vertical ? '500px' : '1200px' }, children: (0, s.Y)(o.i, { ...y, controller: M, terms: D }) })
						);
					};
  ...
  return <div style={{
    maxWidth: args?.vertical ? '500px' : '1200px'
			...
			'./components/src/components/Molecules/Terms/Terms.tsx'(T, c, e) {
				...
				const m = ({ vertical: _, theme: g }) =>
					...
					w = (_, g) => {
						if (_ && g) {
							const r = _.match(D(g));
							if (g && _ && r && typeof r.index == 'number') {
								const l = _.slice(0, r.index),
									n = _.slice(r.index + g.length, _.length);
						...
						return j?.length
							? (0, s.Y)(t._, {
									children: (0, s.FD)('div', {
										...
										children: [
											d ? (0, s.Y)('div', { className: 'ss__terms__title', children: (0, s.Y)('h5', { ...F.title.all }) }) : null,
											(0, s.Y)('ul', {
												...
												children: j?.map((E, U) => {
													...
													return (0, s.Y)('li', {
														...
														children: (0, s.Y)('a', { onClick: (X) => $(X, E), href: E.url.href, ...(I ? (0, O.l)(E.preview) : {}), ...Z.term?.all }),
													});
												}),
											}),
										],
			...
			'./components/src/toolbox/createHoverProps/createHoverProps.ts'(T, c, e) {
				'use strict';
				const s = (i, u = { delay: 333, focusElem: !0 }) => {
					let h;
					return {
						onMouseEnter: (o) => {
							clearTimeout(h),
			...
			'./components/src/utilities/snapify.ts'(T, c, e) {
				...
				function A(r) {
					const l = new O.V(new f.E({ settings: { coreType: 'query', corePrefix: r.controller.id } }), x.X);
					return new i.Tp(r.controller, {
						client: new o.K(r.client.globals, r.client.config),
						store: new a.U(r.controller, { urlManager: l }),
						urlManager: l,
...
//# sourceMappingURL=components-Molecules-Terms-Terms-stories.2e648e6c.iframe.bundle.js.map
