	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9983],
		{
			'./components/src/components/Molecules/LoadMore/LoadMore.stories.tsx'(v, a, e) {
				'use strict';
				e.r(a), e.d(a, { Default: () => s, __namedExportsOrder: () => b, default: () => f });
				...
				const E =
					...
					f = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, o.FD)('div', {
										children: [(0, o.Y)(i.oz, { options: { overrides: { code: u.Z } }, children: E }), (0, o.Y)(i.uY, { story: i.h1 })],
									}),
							},
						},
						argTypes: {
					...
					s = (P, { loaded: { controller: M } }) => (0, o.Y)(n.e, { ...P, controller: M });
  ...
  return <LoadMore {...args} controller={controller} />;
			...
			'./components/src/components/Atoms/Button/Button.tsx'(v, a, e) {
				...
				const U = ({ native: R, color: c, backgroundColor: d, borderColor: _, theme: m }) =>
					...
					W = (0, r.PA)((R) => {
						const c = (0, l.u)(),
							_ = { disableA11y: !1, treePath: (0, E.LU)() },
							m = (0, b.v6)('button', c, _, R),
							{
								content: p,
								children: g,
								disabled: O,
							...
							{ overrideElement: H, shouldRenderDefault: G } = (0, y._)('button', m);
						if (!G) return H;
						const J = { icon: { internalClassName: 'ss__button__icon', ...(0, s.s)({ disableStyles: Z }), theme: m?.theme, treePath: L } },
							I = {
								...(0, P.Z)(m, U),
									...
									children: j
										? (0, o.FD)('button', {
												...
												children: [
													...
													x && (0, o.Y)(M.I, { ...J.icon, ...(typeof x == 'string' ? { icon: x } : x) }),
												],
										  })
										: (0, o.FD)('div', {
												...(F ? {} : Q),
				...
				const R = ({ pagination: d, progressIndicatorWidth: _, progressIndicatorSize: m, color: p, backgroundColor: g, theme: O }) =>
					...
					c = (0, t.PA)((d) => {
						const _ = (0, h.u)(),
							...
							{ overrideElement: G, shouldRenderDefault: J } = (0, A._)('loadMore', g);
						if (!J) return G;
						const D = O || j?.store?.pagination,
							...
							V = {
								button: {
									...
									...(0, b.s)({ disableStyles: X }),
									theme: g?.theme,
									treePath: H,
								},
								icon: { internalClassName: 'ss__load-more__icon', ...(0, b.s)({ disableStyles: X }), theme: g?.theme, treePath: H },
							};
						if (!D) return null;
						const q = (0, M.Z)({ ...g, pagination: D }, R),
							B = {};
						if (F) {
							const z = (0, i.li)(null);
							B.ref = z;
						...
						const ee = {
							...
							Y = E()(ee, g.lang || {}),
							te = (0, y.u)(Y, { pagination: D });
						return D.totalResults
							? (0, o.Y)(f._, {
									children: (0, o.FD)('div', {
										...q,
										...B,
										className: r()('ss__load-more', { 'ss__load-more--loading': I }, { 'ss__load-more--autoFetch': F }, oe, $),
										children: [
											!F &&
												(0, o.FD)(o.FK, {
													children: [
					...
					return (
						(0, o.vJ)(() => {
							const E = new IntersectionObserver(
								([f]) => {
									l(f.isIntersecting), r && f.isIntersecting && E.unobserve(n.current);
								},
								{ rootMargin: u }
							);
							return (
			...
			'./components/src/utilities/snapify.ts'(v, a, e) {
				...
				class K {
					static recommendation(d) {
						const _ = d.id;
						if (y[_]) return y[_];
						const m = (y[_] = W({ client: A, controller: d }));
						return (
					...
					static autocomplete(d) {
						const _ = d.id;
						if (y[_]) return y[_];
						const m = (y[_] = R({ client: A, controller: d }));
						return (
							m.on('afterStore', async ({ controller: p }, g) => {
								p.log.debug('controller', p), p.log.debug('store', p.store.toJSON()), await g();
							}),
					...
					static search(d) {
						const _ = d.id;
						if (y[_]) return y[_];
						const m = (y[_] = U({ client: A, controller: d }));
						return (
							m.on('afterStore', async ({ controller: p }, g) => {
								p.log.debug('controller', p), p.log.debug('store', p.store.toJSON()), await g();
							}),
				...
				function W(c) {
					...
					return new u.c(c.controller, {
						client: new r.K(c.client.globals, c.client.config),
						store: new E.t(c.controller, { urlManager: d }),
						urlManager: d,
						eventManager: new b.E(),
						profiler: new P.U(),
						logger: new M.V(),
...
//# sourceMappingURL=components-Molecules-LoadMore-LoadMore-stories.795f995d.iframe.bundle.js.map
