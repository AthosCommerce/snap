	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[2751],
		{
				...
				const P = () =>
					...
					R = (0, d.PA)((n) => {
						...
						const v = {
							...
							K = a()({}, n.lang || {}),
							S = (0, p.u)(K, {}, { activeBreakpoint: n?.theme?.activeBreakpoint });
						return (0, e.FD)(e.FK, {
							children: [
								(0, e.FD)('div', {
											...
											children: [
												n.ctaIcon
													? (0, e.Y)('div', {
															...
															children: (0, e.Y)(g.I, { ...v.icon, ...(typeof n.ctaIcon == 'string' ? { icon: n.ctaIcon } : n.ctaIcon) }),
													  })
													: (0, e.Y)(e.FK, {}),
			...
			'./components/src/hooks/useIntersectionAdvanced.tsx'(D, _, t) {
				...
				const c = 250,
					o = (s, I = {}) => {
						const { rootMargin: h = '0px', fireOnce: i = !1, threshold: u = 0, minVisibleTime: B = 0 } = I,
							[g, E] = (0, e.J0)(!1),
							l = (0, e.li)(null),
							A = (0, e.li)(null),
							[C, w] = (0, e.J0)(0),
