		...
		[5143],
		{
															...
															d.storedState.activeTab === 'templates'
																? (0, t.FD)(t.FK, {
																		children: [
																			...
																			(0, t.Y)(K, { editorStore: d, data: W.controllers.search, feature: 'controllers/search' }),
																			(0, t.Y)('h1', { children: 'Autocomplete' }),
																			(0, t.Y)(K, { editorStore: d, data: 0, feature: 'targets/autocomplete' }),
																			(0, t.Y)(K, { editorStore: d, data: W.controllers.autocomplete, feature: 'controllers/autocomplete' }),
																		],
																  })
																: '',
				...
				const A = ({ vertical: S }) => (0, f.AH)({ height: S ? '100%' : void 0, '.ss__result__image-wrapper': { height: S ? '85%' : void 0 } }),
					m = (0, _.PA)((S) => {
						...
						const {
							...
							{ ComponentOverride: ce, shouldWaitForNamedOverride: Oe } = (0, O.x)(pe, G ? ie : void 0),
							he = G ? ce : oe,
						...
						const _e = {
							...
							[Ee, De] = (0, p.J0)(!1),
							Pe = (0, p.li)(null);
						(!me?.enabled || (0, B.v)(Pe, `${me.offset} 0px ${me.offset} 0px`, !0)) && De(!0);
						const ve = { titleText: { value: `${Z}` } },
							fe = M()(ve, i.lang || {}),
							Me = (0, U.u)(fe, {}, { activeBreakpoint: g?.activeBreakpoint });
									...
									children: (0, t.Y)('div', {
										...
										children: Ee
											? (0, t.FD)(T.l, {
													controller: j,
													children: [
														Z && !k && (0, t.Y)('h3', { className: 'ss__recommendation__title', ...Me.titleText?.all, children: Z }),
					...
					A = (0, p.PA)((m) => {
						...
						if (!(m.theme?.type == 'templates' || S?.type == 'templates')) {
							const G = (0, y.X)(v?.breakpoints || {}),
								ie = D()(v?.theme || {}, G?.theme || {}, { arrayMerge: (pe, ce) => ce });
							v = { ...v, ...G, theme: ie };
						}
						const {
								disableStyles: i,
			...
			'./components/src/index.ts'(ee, R, e) {
				...
				var t = e('./components/src/components/Atoms/BadgeImage/BadgeImage.tsx'),
					...
					k = e('./components/src/components/Organisms/Facets/Facets.tsx'),
					...
					G = e('./components/src/components/Organisms/Sidebar/Sidebar.tsx'),
