...
`;
			...
			'./components/src/components/Atoms/Button/Button.tsx'(b, r, e) {
				...
				var o = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					K = e.n(R);
				const W = ({ native: B, color: E, backgroundColor: T, borderColor: C, theme: f }) =>
						B
							? (0, l.AH)({})
							: (0, l.AH)({
									display: 'inline-flex',
									...
									border: `1px solid ${C || E || f?.variables?.colors?.primary || '#333'}`,
					...
					N = (0, i.PA)((B) => {
						...
						const k = { icon: { internalClassName: 'ss__button__icon', ...(0, n.s)({ disableStyles: F }), theme: f?.theme, treePath: h } },
							...
							X = K()(z, L || {}),
							P = (0, S.u)(X, {}),
							G = !!I.dangerouslySetInnerHTML;
						return v || x || p || L?.button?.value || G
							? (0, o.Y)(t._, {
									children: A
										? (0, o.FD)('button', {
												...j,
												children: [
													(0, o.FD)('span', {
														...
														...P.button?.all,
														children: [(0, u.Y)(v, { treePath: h }), (0, u.Y)(x, { treePath: h })],
													}),
