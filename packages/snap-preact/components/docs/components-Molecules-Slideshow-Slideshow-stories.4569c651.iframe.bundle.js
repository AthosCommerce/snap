(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9935],
		{
			'../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs'(g, o, t) {
				'use strict';
				t.d(o, { f: () => b });
										...
										.then(({ MDXProvider: f }) =>
											y(
												e.default.createElement(
													d,
													{ showException: p, key: Math.random() },
													e.default.createElement(f, { components: c }, e.default.createElement(u, { context: n, docsParameter: i }))
												),
												l
											)
										)
			...
			'./components/src/components/Molecules/Slideshow/Slideshow.stories.tsx'(g, o, t) {
				'use strict';
				t.r(o),
					t.d(o, {
						AutoPlay: () => c,
						...
						Loop: () => u,
						NoNavigation: () => m,
						__namedExportsOrder: () => f,
						default: () => n,
					});
				var e = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					y = t('../../node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs'),
					h = t('../../node_modules/@storybook/blocks/dist/index.mjs'),
					a = t('./components/src/components/Molecules/Slideshow/Slideshow.tsx'),
				...
				const b =
					...
					n = {
						...
						decorators: [(s) => (0, e.Y)('div', { style: { maxWidth: '750px' }, children: (0, e.Y)(s, {}) })],
						argTypes: {
							slides: {
					...
					l = (s) => (0, e.Y)(a.b, { ...s });
				l.args = { slides: i };
				const c = (s) => (0, e.Y)(a.b, { ...s });
				c.args = { slides: i, slidesToShow: 3, slidesToMove: 1, autoPlay: !0, autoPlayInterval: 2e3 };
				const u = (s) => (0, e.Y)(a.b, { ...s });
				u.args = { slides: i, slidesToShow: 2, slidesToMove: 1, loop: !0 };
				const m = (s) => (0, e.Y)(a.b, { ...s });
				m.args = { slides: i, slidesToShow: 3, showNavigation: !1 };
				const p = (s) => (0, e.Y)(a.b, { ...s });
				(p.args = {
					slides: [
						{
							...
							price: '$299.99',
							onClick: (s) => {
								console.log('Product clicked:', s),
									alert(`Opening product details for ${s.alt}
Price: ${s.price}
...
Click tracked for analytics`);
				...
				const f = ['Default', 'AutoPlay', 'Loop', 'NoNavigation', 'ClickableSlides'];
			},
			'./components/src/utilities/componentArgs.ts'(g, o, t) {
				'use strict';
				const e = {
					className: {
			...
			'./components/src/utilities/storybook.tsx'(g, o, t) {
				'use strict';
				var e = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
...
//# sourceMappingURL=components-Molecules-Slideshow-Slideshow-stories.4569c651.iframe.bundle.js.map
