(() => {
		...
		[5497],
		{
			'./components/src/components/Templates/SearchCollapsible/SearchCollapsible.stories.tsx'(f, a, e) {
				...
				var s = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					r = e('./components/src/components/Templates/SearchCollapsible/SearchCollapsible.tsx');
				const c = {
						...
						decorators: [(b) => (0, s.Y)('div', { style: { maxWidth: '1200px' }, children: (0, s.Y)(b, {}) })],
						argTypes: {
							controller: {
					...
					h = (b, { loaded: { controller: T } }) => (0, s.Y)(r.x, { ...b, controller: T });
				h.loaders = [async () => (await E.search(), { controller: E })];
				const g = (b, { loaded: { controller: T } }) => (0, s.Y)(r.x, { ...b, controller: T });
  ...
  return <SearchCollapsible {...args} controller={controller} />;
			...
			'./components/src/components/Templates/SearchCollapsible/SearchCollapsible.tsx'(f, a, e) {
				...
				const t = (0, d.PA)((n) => (0, s.Y)(u._, { children: (0, s.Y)(o.v, { ...n, alias: 'searchCollapsible' }) }));
			},
			'./components/src/components/Trackers/ResultTracker/ResultTracker.tsx'(f, a, e) {
				...
				const E = { ResultTracker: () => (0, d.AH)({}) },
					S = (0, u.PA)((h) => {
						const g = (0, n.u)(),
							O = (0, r.v6)('resultTracker', g, {}, h),
							b = { impression: !0, click: !0 },
							{ children: T, result: y, track: P, controller: C, className: D, internalClassName: v, disableStyles: x, style: l } = O,
							i = { ...b, ...P },
							{ ref: p, inViewport: _ } = (0, c.Q)();
						_ && i.impression && C?.track.product.impression(y);
						const m = {};
						return (
							x ? l && (m.css = [l]) : (m.css = [E.ResultTracker(), l]),
							(0, s.Y)('div', {
								className: t()('ss__result-tracker', `ss__${C?.type}-result-tracker`, D, v),
								onClick: (M) => {
									i.click && C?.track.product.click(M, y);
								},
								ref: p,
								...m,
								children: T,
			...
			'./components/src/utilities/snapify.ts'(f, a, e) {
				...
				class C {
					...
					static search(i) {
						const p = i.id;
						if (y[p]) return y[p];
						const _ = (y[p] = D({ client: P, controller: i }));
						return (
							_.on('afterStore', async ({ controller: m }, M) => {
								m.log.debug('controller', m), m.log.debug('store', m.store.toJSON()), await M();
							}),
...
//# sourceMappingURL=components-Templates-SearchCollapsible-SearchCollapsible-stories.08b47ad6.iframe.bundle.js.map
