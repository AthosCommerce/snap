	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[9712],
		{
			...
			'./components/src/components/Molecules/OverlayResult/OverlayResult.tsx'(v, d, t) {
				...
				const H = (A) => {
						const { overlayBackground: M, disableSlide: E } = A;
						return (0, s.AH)({
							position: 'relative',
							overflow: 'hidden',
					...
					Z = (0, l.PA)((A) => {
						...
						const c = m?.display?.mappings.core || m?.mappings?.core,
							...
							u = {
								...
								button: {
									...
									onClick: (b) => {
										I(!0), w && w(b, m), P?.addToCart([m]), setTimeout(() => I(!1), oe);
									},
									...(0, f.s)({ disableStyles: y }),
									theme: _.theme,
									treePath: h,
						...
						const _e = (0, T.Z)(_, H),
							me = { addToCartButtonText: { value: ce ? re : L } },
							fe = Y()(me, _.lang || {}),
												...
												children: [
													...
													(0, a.Y)('div', {
														...
														children: (0, a.FD)('div', {
															...
															children: [
																!k && (0, a.Y)(D.W, { ...u.calloutBadge, controller: P }),
																...
																!ae &&
																	(0, a.Y)('div', {
																		...
																		children: (0, a.Y)(W.$, { ...u.button, content: L, ...ue.addToCartButtonText.all }),
																	}),
															],
														}),
													}),
				...
				var a = function (n, l) {
					...
					(n.prototype.toName = function (i) {
						...
						if (i?.closest) {
							...
							for (var x in s) {
								var D = ((g = R), (p = r[x]), Math.pow(g.r - p.r, 2) + Math.pow(g.g - p.g, 2) + Math.pow(g.b - p.b, 2));
								D < f && ((f = D), (O = x));
							}
							return O;
						}
