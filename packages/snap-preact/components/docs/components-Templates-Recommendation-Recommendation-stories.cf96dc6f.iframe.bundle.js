  ...
  return <Recommendation {...props} controller={controller} />;
			...
			'./components/src/components/Molecules/Carousel/Carousel.tsx'(R, r, e) {
				...
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					I = e('../../node_modules/swiper/modules/a11y.mjs'),
				...
				const y = ({ vertical: U, theme: J }) =>
						(0, s.AH)({
							display: 'flex',
							maxWidth: '100%',
							maxHeight: U ? '100%' : void 0,
							margin: 0,
							padding: 0,
							overflow: 'hidden',
					...
					C = (0, i.PA)((U) => {
						const J = (0, j.u)(),
							re = (0, N.LU)(),
							me = {
								breakpoints: U.vertical ? JSON.parse(JSON.stringify(b)) : JSON.parse(JSON.stringify(x)),
								pagination: !1,
								navigation: !0,
								slidesPerGroup: !U.breakpoints || !Object.keys(U.breakpoints).length ? 5 : void 0,
								slidesPerView: !U.breakpoints || !Object.keys(U.breakpoints).length ? 5 : void 0,
								spaceBetween: 10,
								loop: !0,
								autoAdjustSlides: !1,
								treePath: re,
							};
						let _ = (0, v.v6)('carousel', J, me, U),
							h;
						if (
							!(U.theme?.type == 'templates' || J?.type == 'templates') &&
							_.breakpoints &&
						...
						const se = { icon: { internalClassName: 'ss__carousel__icon', ...(0, T.s)({ disableStyles: G }), theme: _.theme, treePath: oe } },
							W = Array.isArray(de) ? [D.A, A.A, O.A, I.A].concat(de) : [D.A, A.A, O.A, I.A],
								...
								? (0, t.Y)(L._, {
										children: (0, t.FD)('div', {
											...
											children: [
												g !== !1 &&
													(0, t.Y)('div', {
														className: o()('ss__carousel__prev-wrapper', { 'ss__carousel__prev-wrapper--hidden': ae }),
														children: (0, t.Y)('div', {
												...
												(0, t.Y)(d.RC, {
													...
													children: B.map((a) => (a != null ? (0, t.Y)(d.qr, { children: (0, f.Y)(a, { treePath: oe }) }) : null)),
												}),
												g !== !1 &&
													(0, t.Y)('div', {
														className: o()('ss__carousel__next-wrapper', { 'ss__carousel__next-wrapper--hidden': ae }),
														children: (0, t.Y)('div', {
			...
			'./components/src/components/Molecules/Result/Result.tsx'(R, r, e) {
				...
				const C = () =>
					...
					U = (0, s.PA)((J) => {
						...
						if (!k) return _e;
						const g = B?.display?.mappings.core || B?.mappings?.core,
							[F, se] = (0, n.J0)(!1),
							W = {
								variantSelection: {
								...
								image: {
									...
									alt: g?.name || '',
									src: g?.imageUrl || '',
									...(0, m.s)({ disableStyles: V, fallback: le }),
									theme: h.theme,
									treePath: K,
								},
								rating: {
								...
								button: {
									...
									onClick: (c) => {
										se(!0), ge && ge(c, B), G?.addToCart([B]), setTimeout(() => se(!1), pe);
									},
									...(0, m.s)({ disableStyles: V }),
									theme: h.theme,
									treePath: K,
						...
						const Z = (0, A.Z)(h, C),
							Y = { addToCartButtonText: { value: F ? ue : de } },
							z = P()(Y, h.lang || {}),
							fe = (0, y.u)(z, { result: B, controller: G }, { activeBreakpoint: re?.activeBreakpoint }),
							q = !!(g?.msrp && g?.price && g?.price < g?.msrp),
							a = G?.store?.config?.asyncState?.product?.price ? B.state.priceFetched : !0;
						return g
							? (0, t.Y)(d._, {
									children: (0, t.FD)('article', {
										...Z,
										className: i()('ss__result', `ss__result--${te}`, { 'ss__result--sale': q }, ie, ce),
										ref: H,
										children: [
											!ae &&
												(0, t.Y)('div', {
											...
											(0, t.FD)('div', {
												...
												children: [
													...
													!S && a && g.price && g.price > 0
														...
														: null,
													(0, v.Y)(Q, { result: B, treePath: K }),
													!Ee && B.variants?.selections.length
														? (0, t.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: B.variants?.selections.map((c) => (0, t.Y)(b.m, { ...W.variantSelection, type: c.type, selection: c })),
														  })
														: null,
													!ve &&
														(0, t.Y)('div', {
			...
			'./components/src/components/Templates/Recommendation/Recommendation.tsx'(R, r, e) {
				...
				const x = ({ vertical: C }) => (0, s.AH)({ height: C ? '100%' : void 0, '.ss__result__image-wrapper': { height: C ? '85%' : void 0 } }),
					b = (0, i.PA)((C) => {
						...
						let _ = (0, m.v6)('recommendation', U, re, me),
							h;
						!(C.theme?.type == 'templates' || U?.type == 'templates') &&
							_.breakpoints &&
						...
						const Pe = { titleText: { value: `${B}` } },
							be = E()(Pe, _.lang || {}),
							Oe = (0, P.u)(be, {}, { activeBreakpoint: U?.activeBreakpoint });
									...
									children: (0, t.Y)('div', {
										...
										children: q
											? (0, t.FD)(p.l, {
													controller: w,
													children: [
														B && !pe && (0, t.Y)('h3', { className: 'ss__recommendation__title', ...Oe.titleText?.all, children: B }),
				...
				const d = { ResultTracker: () => (0, n.AH)({}) },
					f = (0, s.PA)((T) => {
						const v = (0, i.u)(),
							...
							{ children: A, result: O, track: I, controller: M, className: L, internalClassName: j, disableStyles: N, style: p } = m,
							P = { ...D, ...I },
						...
						return (
							...
							(0, t.Y)('div', {
								className: o()('ss__result-tracker', `ss__${M?.type}-result-tracker`, L, j),
								onClick: (C) => {
						...
						return (
							(0, t.vJ)(() => {
								...
								return (
									...
									() => {
										v(!1), j(), m.current && window.clearTimeout(m.current), M && o.current && M.unobserve(o.current);
									}
								);
							}, [o, A]),
			...
			'./components/src/utilities/snapify.ts'(R, r, e) {
				...
				class M {
					static recommendation(P) {
						const y = P.id;
						if (O[y]) return O[y];
						const x = (O[y] = j({ client: I, controller: P }));
						return (
					...
					static autocomplete(P) {
						const y = P.id;
						if (O[y]) return O[y];
						const x = (O[y] = N({ client: I, controller: P }));
						return (
							x.on('afterStore', async ({ controller: b }, C) => {
								b.log.debug('controller', b), b.log.debug('store', b.store.toJSON()), await C();
							}),
					...
					static search(P) {
						const y = P.id;
						if (O[y]) return O[y];
						const x = (O[y] = L({ client: I, controller: P }));
						return (
							x.on('afterStore', async ({ controller: b }, C) => {
								b.log.debug('controller', b), b.log.debug('store', b.store.toJSON()), await C();
							}),
				...
				function t(n, s) {
					...
					(n.prototype.toName = function (E) {
						...
						if (E?.closest) {
							...
							for (var O in l) {
								var I = ((d = v), (f = u[O]), Math.pow(d.r - f.r, 2) + Math.pow(d.g - f.g, 2) + Math.pow(d.b - f.b, 2));
								I < m && ((m = I), (D = O));
							}
							return D;
						}
...
//# sourceMappingURL=components-Templates-Recommendation-Recommendation-stories.cf96dc6f.iframe.bundle.js.map
