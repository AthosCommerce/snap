		...
		[9354],
		{
			...
			'./components/src/components/Molecules/Result/Result.tsx'(g, d, t) {
				var a = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					S = t('./components/src/components/Molecules/CalloutBadge/CalloutBadge.tsx'),
					...
					K = t.n(w),
					j = t('./components/src/hooks/useLang.tsx'),
					Y = t('./components/src/hooks/useCustomComponentOverride.tsx'),
					z = t('./components/src/components/Molecules/VariantSelection/VariantSelection.tsx');
				const V = () =>
						(0, s.AH)({
							'&.ss__result--grid': {
								display: 'flex',
					...
					H = (0, r.PA)((G) => {
						const x = (0, h.u)(),
							...
							{ overrideElement: ce, shouldRenderDefault: fe } = (0, Y._)('result', {
								...f,
						...
						const c = m?.display?.mappings.core || m?.mappings?.core,
							...
							_ = {
								...
								price: { internalClassName: 'ss__result__price', ...(0, u.s)({ disableStyles: v }), theme: f.theme, treePath: b },
								calloutBadge: {
								...
								image: {
									...
									alt: c?.name || '',
									src: c?.imageUrl || '',
									...(0, u.s)({ disableStyles: v, fallback: q }),
									theme: f.theme,
									treePath: b,
								},
								rating: {
								...
								button: {
									...
									onClick: (E) => {
										L(!0), R && R(E, m), P?.addToCart([m]), setTimeout(() => L(!1), le);
									},
									...(0, u.s)({ disableStyles: v }),
									theme: f.theme,
									treePath: b,
						...
						let I = c?.name;
						f.truncateTitle && (I = M.x(c?.name || '', f.truncateTitle.limit, f.truncateTitle.append));
						const ue = (0, T.Z)(f, V),
							_e = { addToCartButtonText: { value: me ? oe : ne } },
							ge = K()(_e, f.lang || {}),
							pe = (0, j.u)(ge, { result: m, controller: P }, { activeBreakpoint: x?.activeBreakpoint }),
							k = !!(c?.msrp && c?.price && c?.price < c?.msrp),
							he = P?.store?.config?.asyncState?.product?.price ? m.state.priceFetched : !0;
						return c
							? (0, a.Y)(p._, {
									children: (0, a.FD)('article', {
										...ue,
										className: o()('ss__result', `ss__result--${se}`, { 'ss__result--sale': k }, ee, te),
										ref: de,
										children: [
											!J &&
												(0, a.Y)('div', {
											...
											(0, a.FD)('div', {
												...
												children: [
													!A && (0, a.Y)(S.W, { ..._.calloutBadge, controller: P }),
													!Z &&
														(0, a.Y)('div', {
													...
													!F && he && c.price && c.price > 0
														...
														: null,
													(0, B.Y)(X, { result: m, treePath: b }),
													!ae && m.variants?.selections.length
														? (0, a.Y)('div', {
																className: 'ss__result__details__variant-selection',
																children: m.variants?.selections.map((E) => (0, a.Y)(z.m, { ..._.variantSelection, type: E.type, selection: E })),
														  })
														: null,
													!re &&
														(0, a.Y)('div', {
															className: 'ss__result__add-to-cart-wrapper',
															children: (0, a.Y)(W.$, { ..._.button, ...pe.addToCartButtonText.all }),
														}),
												],
											}),
										],
