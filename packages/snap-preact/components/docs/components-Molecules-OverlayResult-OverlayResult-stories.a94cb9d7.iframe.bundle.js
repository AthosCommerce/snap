	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[1663],
		{
			...
			'./components/src/components/Molecules/OverlayResult/OverlayResult.stories.tsx'(E, i, e) {
				'use strict';
				e.r(i), e.d(i, { Default: () => x, __namedExportsOrder: () => P, default: () => T, hideSections: () => C, truncateTitle: () => c });
  ...
  return <div style={{
    maxWidth: '300px'
            ...
            <OverlayResult {...args} result={resultToUse} />
				...
				const P = ['Default', 'hideSections', 'truncateTitle'];
			},
				...
				const b = (K) => {
					...
					M = (0, n.PA)((K) => {
						...
						const g = B?.display?.mappings.core || B?.mappings?.core,
							...
							R = {
								...
								button: {
									...
									onClick: (w) => {
										F(!0), V && V(w, B), L?.addToCart([B]), setTimeout(() => F(!1), ae);
									},
									...(0, c.s)({ disableStyles: A }),
									theme: y.theme,
									treePath: D,
						...
						const ue = (0, h.Z)(y, b),
							...
							pe = u()(me, y.lang || {}),
							_e = (0, f.u)(pe, { result: B, controller: L }),
														...
														children: (0, r.FD)('div', {
															...
															children: [
																...
																!$ && g.price && g.price > 0
																	...
																	: null,
																(0, C.Y)(Q, { result: B, treePath: D }),
																!re && B.variants?.selections.length
																	? (0, r.Y)('div', {
																			className: 'ss__overlay-result__details__variant-selection',
																			children: B.variants?.selections.map((w) => (0, r.Y)(O.m, { ...R.variantSelection, selection: w })),
																	  })
																	: null,
																!oe &&
																	(0, r.Y)('div', {
...
//# sourceMappingURL=components-Molecules-OverlayResult-OverlayResult-stories.a94cb9d7.iframe.bundle.js.map
