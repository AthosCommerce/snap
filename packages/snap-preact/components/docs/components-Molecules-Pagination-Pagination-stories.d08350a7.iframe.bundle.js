				...
				const D = () =>
					...
					C = (0, p.PA)((j) => {
						...
						const F = {
							...
							te = Number.isInteger(v) && Number.isInteger(U) ? [v, U] : [u],
							R = l?.getPages(...te),
							T = R?.map((E) => E.number),
							ne = (0, M.Z)(a, D),
							se = {
									...
									children: (0, n.Y)('div', {
										...
										children: (0, n.FD)('nav', {
											...
											children: [
												...
												R &&
													R.map((E) => {
														const oe = { page: { attributes: { 'aria-label': `go to page ${E.number}` } } },
															re = b()(oe, a.lang || {}),
															Y = (0, f.u)(re, { pagination: l, page: E });
														return E.active
															? (0, n.Y)('span', {
...
//# sourceMappingURL=components-Molecules-Pagination-Pagination-stories.d08350a7.iframe.bundle.js.map
