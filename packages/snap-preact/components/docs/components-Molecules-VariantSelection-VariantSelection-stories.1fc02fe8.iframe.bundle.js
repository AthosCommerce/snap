(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[2271],
		{
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/fieldNameToComponentName/fieldNameToComponentName.js'(N, i, e) {
				'use strict';
				e.d(i, { P: () => t });
				const t = (p) => p.replace(/_/g, '-').toLowerCase();
			},
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/handleize.js'(N, i, e) {
				'use strict';
				e.d(i, { p: () => t });
				function t(p) {
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.stories.tsx'(N, i, e) {
				'use strict';
				e.r(i), e.d(i, { Dropdown: () => u, List: () => T, Swatches: () => M, __namedExportsOrder: () => U, default: () => g });
            ...
            rgba(255, 0, 0, 1) 100%
				...
				(u.loaders = [
					async () => (
						S.on('afterSearch', async ({ response: m }, j) => {
							m.results?.length &&
  ...
  return <div style={{
    maxWidth: args?.type == 'list' ? '500px' : '300px'
			...
			'./components/src/components/Molecules/List/List.tsx'(N, i, e) {
				'use strict';
				e.d(i, { B: () => f });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				function f(r) {
					...
					if (q) {
						const d = (0, j.x)(x?.templates?.library.import.component.list || {}, q);
						if (d) return (0, t.Y)(d, { ...E });
					}
					let D = E.selected;
					const I = {
							checkbox: { native: C, ...(0, y.s)({ disableStyles: J }), theme: E?.theme, treePath: L },
							icon: { internalClassName: 'ss__list__option__icon', size: '16px', ...(0, y.s)({ disableStyles: J }), theme: E?.theme, treePath: L },
						},
						se = (0, S.Z)(E, Z);
					...
					const ne = (d, z) => {
							let h;
							H
								? W.find((B) => B.value === z.value)
									? ((h = [...W]),
									  h.splice(
											h.findIndex((B) => B.value === z.value),
											1
									  ),
									  h.length == 0 && G && (h = [z]))
									: (h = [...W, z])
								: !G && W.find((B) => B.value === z.value)
								? (h = [])
								: (h = [z]),
								K && K(d, z, h),
								ee(h);
						...
						oe = {},
						te = o()(oe, E.lang || {}),
						le = (0, m.u)(te, { options: R, selectedOptions: W });
					return typeof R == 'object' && R?.length
						? (0, t.Y)(g._, {
								children: (0, t.FD)('div', {
									...se,
									className: s()('ss__list', { 'ss__list--native': C, 'ss__list--disabled': w }, $, O),
									children: [
										...
										(0, t.Y)('ul', {
											...
											'aria-label': _,
											children: R.map((d) => {
												const z = W.some((h) => h.value == d.value);
												return (0, t.FD)('li', {
													className: s()(`ss__list__option ss__list__option--${l.p(d.value?.toString())}`, {
														'ss__list__option--selected': z,
														'ss__list__option--disabled': d?.disabled,
														'ss__list__option--unavailable': d?.available === !1,
													}),
													ref: (h) => (0, U.iy)(h),
													onClick: (h) => !w && !d?.disabled && ne(h, d),
													title: d.label,
													role: 'option',
													'aria-selected': z,
													'aria-disabled': d.disabled || d?.available === !1,
													children: [
														!X && (0, t.Y)(u.S, { ...I.checkbox, checked: z, disableA11y: !0, 'aria-label': d.label }),
														d.icon && !k && (0, t.Y)(Y.I, { ...I.icon, ...(typeof d.icon == 'string' ? { icon: d.icon } : d.icon) }),
														!Q && (d.label || !d.icon) && (0, t.Y)('label', { className: 'ss__list__option__label', children: d.label || d.value }),
													],
												});
											}),
										}),
			...
			'./components/src/components/Molecules/VariantSelection/VariantSelection.tsx'(N, i, e) {
				'use strict';
				e.d(i, { m: () => f });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					p = e('../../node_modules/mobx-react-lite/es/index.js'),
					...
					A = e('./components/src/components/Molecules/Swatches/Swatches.tsx'),
				...
				const Y = () =>
					...
					f = (0, p.PA)((r) => {
						const v = (0, o.u)(),
							x = (0, l.uk)(),
							P = (0, g.LU)(),
							V = { name: (0, j.P)(r.selection.field), treePath: P },
							E = (0, T.v6)('variantSelection', v, V, r),
							{ selection: _, onSelect: K, disableStyles: C, className: H, internalClassName: Q, treePath: k, customComponent: X } = E;
						if (X) {
							const O = (0, m.x)(x?.templates?.library.import.component.variantSelection || {}, X);
							if (O) return (0, t.Y)(O, { ...E });
						}
						let w = E.type;
						w || (_.type == 'swatch' ? (w = 'swatches') : (w = 'dropdown'));
						const F = (O, L) => {
								K && K(O, L), _.select(L.value);
							},
							R = {
								dropdown: {
						...
						return _.values.length
							? (0, t.Y)(n._, {
									children: (0, t.Y)('div', {
										...G,
										className: s()('ss__variant-selection', `ss__variant-selection--${w}`, `ss__variant-selection--${_.field}`, H, Q),
										children: (() => {
											switch (w) {
												case 'dropdown':
													return (0, t.Y)(t.FK, {
															...
															const O = (L) => {
																...
																return (0, t.FD)(t.FK, {
																	children: [
																		...
																		(0, t.Y)(u.I, { icon: q ? 'angle-up' : 'angle-down', ...R.icon, treePath: L.treePath }),
																	],
																});
															};
															return (0, t.Y)(S.m, { button: (0, t.Y)(O, { treePath: k }), ...R.dropdown, content: (0, t.Y)($, {}) });
														})(),
													});
												case 'list':
													return (0, t.Y)(t.FK, { children: (0, t.Y)(y.B, { ...R.list, options: _.values }) });
												case 'swatches':
													return (0, t.Y)(t.FK, { children: (0, t.Y)(A.l, { ...R.swatches, options: _.values }) });
											}
										})(),
									}),
							  })
			...
			'./components/src/utilities/componentArgs.ts'(N, i, e) {
				'use strict';
				e.d(i, { F: () => t });
				const t = {
					className: {
			...
			'./components/src/utilities/snapify.ts'(N, i, e) {
				'use strict';
				e.d(i, { p: () => m });
				...
				class m {
					static recommendation(r) {
						const v = r.id;
						if (u[v]) return u[v];
						const x = (u[v] = Y({ client: U, controller: r }));
						return (
							x.on('afterStore', async ({ controller: P }, V) => {
					...
					static autocomplete(r) {
						const v = r.id;
						if (u[v]) return u[v];
						const x = (u[v] = Z({ client: U, controller: r }));
						return (
							x.on('afterStore', async ({ controller: P }, V) => {
								P.log.debug('controller', P), P.log.debug('store', P.store.toJSON()), await V();
							}),
					...
					static search(r) {
						const v = r.id;
						if (u[v]) return u[v];
						const x = (u[v] = j({ client: U, controller: r }));
						return (
							x.on('afterStore', async ({ controller: P }, V) => {
								P.log.debug('controller', P), P.log.debug('store', P.store.toJSON()), await V();
							}),
				...
				function j(f) {
					const r = new g.V(new T.E({ settings: { coreType: 'query', corePrefix: f.controller.id } }), b.X);
					return new p.Tp(f.controller, {
						client: new s.K(f.client.globals, f.client.config),
						store: new o.U(f.controller, { urlManager: r }),
						urlManager: r,
						eventManager: new M.E(),
						profiler: new y.U(),
						logger: new A.V(),
						tracker: new S.J(f.client.globals),
					});
				}
				function Y(f) {
					const r = new g.V(new T.E(), b.X).detach(!0);
					return new a.c(f.controller, {
						client: new s.K(f.client.globals, f.client.config),
						store: new l.t(f.controller, { urlManager: r }),
						urlManager: r,
						eventManager: new M.E(),
						profiler: new y.U(),
						logger: new A.V(),
				...
				function Z(f) {
					const r = new g.V(new T.E(), b.X).detach();
					return new c.Z(f.controller, {
						client: new s.K(f.client.globals, f.client.config),
						store: new n.Y(f.controller, { urlManager: r }),
						urlManager: r,
						eventManager: new M.E(),
						profiler: new y.U(),
						logger: new A.V(),
			...
			'./components/src/utilities/storybook.tsx'(N, i, e) {
				'use strict';
				e.d(i, { Z: () => a });
				var t = e('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					p = e('../../node_modules/preact/hooks/dist/hooks.module.js');
			...
			'../../node_modules/colord/plugins/names.mjs'(N, i, e) {
				'use strict';
					...
					(p.prototype.toName = function (l) {
						...
						if (l?.closest) {
							var M = this.toRgb(),
								y = 1 / 0,
								A = 'black';
							if (!o.length) for (var S in a) o[S] = new p(a[S]).toRgb();
							for (var u in a) {
								var U = ((g = M), (b = o[u]), Math.pow(g.r - b.r, 2) + Math.pow(g.g - b.g, 2) + Math.pow(g.b - b.b, 2));
								U < y && ((y = U), (A = u));
							}
							return A;
						}
						...
						c.string.push([
							function (l) {
								var g = l.toLowerCase(),
									b = g === 'transparent' ? '#0000' : a[g];
								return b ? new p(b).toRgb() : null;
							},
							'name',
						]);
				}
			},
			'../../node_modules/dequal/dist/index.mjs'(N, i, e) {
				'use strict';
				e.d(i, { j: () => c });
				...
				function c(a, s) {
					...
					if (a && s && (n = a.constructor) === s.constructor) {
						...
						if (n === Map) {
							if (a.size !== s.size) return !1;
							for (o of a) if (((l = o[0]), (l && typeof l == 'object' && ((l = p(s, l)), !l)) || !c(o[1], s.get(l)))) return !1;
							return !0;
						}
			...
			'../../node_modules/memoizerific sync recursive'(N) {
				...
				(i.keys = () => []), (i.resolve = i), (i.id = '../../node_modules/memoizerific sync recursive'), (N.exports = i);
			},
		},
	]);
})();

//# sourceMappingURL=components-Molecules-VariantSelection-VariantSelection-stories.1fc02fe8.iframe.bundle.js.map
