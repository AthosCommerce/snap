				...
				const s = ({ vertical: r, theme: b }) =>
					...
					d = (0, f.PA)((r) => {
						...
						let E = (0, m.v6)('carousel', b, K, r),
							A;
						if (
							!(r.theme?.type == 'templates' || b?.type == 'templates') &&
							E.breakpoints &&
				...
				const a = ({ vertical: d }) => (0, _.AH)({ height: d ? '100%' : void 0, '.ss__result__image-wrapper': { height: d ? '85%' : void 0 } }),
					P = (0, f.PA)((d) => {
						...
						let K = (0, u.v6)('recommendation', r, ae, ie),
							E;
						!(d.theme?.type == 'templates' || r?.type == 'templates') &&
							K.breakpoints &&
							((E = (0, T.X)(K.breakpoints)), E && Object.keys(E).length && (K = { ...K, ...E }));
						const {
								title: A,
								description: J,
								controller: x,
...
//# sourceMappingURL=components-Templates-Recommendation-Recommendation-stories.e1b70d9a.iframe.bundle.js.map
