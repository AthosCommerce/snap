	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[1059],
		{
				...
				const T = ({ gapSize: D, columns: B }) =>
					...
					x = (0, d.PA)((D) => {
						const B = (0, v.u)(),
							...
							V = { name: D.controller?.store?.profile?.tag?.toLowerCase(), ...D };
						let l = (0, h.v6)('recommendationGrid', B, U, V);
			...
			'./components/src/components/Trackers/Recommendation/ProfileTracker/RecommendationProfileTracker.tsx'(R, a, e) {
				...
				const i = () => (0, c.AH)({}),
					P = (0, s.PA)((f) => {
						const { children: h, className: O, internalClassName: u } = f,
							v = (0, d.v2)(h),
							g = (0, n.Z)(f, i);
						return v.length ? (0, r.Y)('div', { className: o()('ss__recommendation-profile-tracker', O, u), ...g, children: h }) : null;
					});
			},
			'./components/src/components/Trackers/ResultTracker/ResultTracker.tsx'(R, a, e) {
				...
				const P = { ResultTracker: () => (0, d.AH)({}) },
					f = (0, c.PA)((h) => {
						const O = (0, o.u)(),
							u = (0, n.v6)('resultTracker', O, {}, h),
							v = { impression: !0, click: !0 },
							{ children: g, result: A, track: L, controller: m, className: M, internalClassName: p, disableStyles: C, style: T } = u,
							x = { ...v, ...L },
							{ ref: D, inViewport: B } = (0, i.Q)();
						B && x.impression && m?.track.product.impression(A);
						const y = {};
						return (
							C ? T && (y.css = [T]) : (y.css = [P.ResultTracker(), T]),
							(0, r.Y)('div', {
								className: t()('ss__result-tracker', `ss__${m?.type}-result-tracker`, M, p),
								onClick: (U) => {
									x.click && m?.track.product.click(U, A);
								},
								ref: D,
								...y,
								children: g,
						...
						return (
							(0, r.vJ)(() => {
								...
								const p = () => {
									...
									T = () => {
										u.current && window.clearTimeout(u.current), (u.current = null), (v.current = null), O(!1);
									};
								return (
									...
									() => {
										O(!1), p(), u.current && window.clearTimeout(u.current), m && t.current && m.unobserve(t.current);
									}
								);
							}, [t, g]),
							{ inViewport: h, updateRef: L }
						);
					};
				function s(t) {
