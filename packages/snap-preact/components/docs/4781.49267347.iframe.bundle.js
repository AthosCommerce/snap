	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[4781, 8554],
		{
			...
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/currency.js'(O, l, e) {
				...
				function c(r, s) {
					const o = { symbol: '$', thousandsSeparator: ',', decimalPlaces: 2, ...s };
					return (0, t.Z)(r, o);
				}
			},
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/formatNumber.js'(O, l, e) {
				...
				e.d(l, { Z: () => t });
				function t(r, s) {
					const o = { symbol: '', decimalPlaces: 3, padDecimalPlaces: !0, thousandsSeparator: '', decimalSeparator: '.', symbolAfter: !1, ...s };
					if (typeof r != 'number' || Number.isNaN(r)) return;
					const a = c(r, o.decimalPlaces).split('.');
					(a[0] = a[0].replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1' + o.thousandsSeparator)),
						o.decimalPlaces > 0 && o.padDecimalPlaces && (a[1] = (a[1] || '').padEnd(o.decimalPlaces, '0'));
					let n = a.join(o.decimalSeparator);
					return o.symbolAfter ? (n = n + o.symbol) : (n = o.symbol + n), n;
				}
				function c(r, s) {
					const o = r.toString(),
						a = o.indexOf('.'),
						n = a == -1 ? o.length : 1 + a + (s || -1);
					return o.substr(0, n);
				}
			},
			...
			'./components/src/components/Atoms/BadgeImage/BadgeImage.tsx'(O, l, e) {
				...
				const P = () => (0, c.AH)({ maxHeight: '100%', maxWidth: '100%' }),
					h = (0, o.PA)((f) => {
						const E = (0, n.u)(),
							C = { treePath: (0, d.LU)() },
							p = (0, u.v6)('badgeImage', E, C, f),
							{ label: i, url: m, tag: _, className: g, internalClassName: b } = p,
						...
						return m
							? (0, t.Y)(a._, {
									children: (0, t.Y)('img', {
										...x,
										className: s()('ss__badge-image', `ss__badge-image--${_}`, g, b),
										alt: i || `${_} badge`,
										src: m,
									}),
							  })
				...
				const P = ({ color: f, colorText: E }) =>
					...
					h = (0, o.PA)((f) => {
						const E = (0, n.u)(),
							...
							p = (0, u.v6)('badgePill', E, C, f),
							{ value: i, tag: m, className: _, internalClassName: g } = p,
						...
						return i
							? (0, t.Y)(a._, {
									children: (0, t.Y)('div', {
										...M,
										className: s()('ss__badge-pill', `ss__badge-pill--${m}`, _, g),
					...
					h = (0, o.PA)((f) => {
						...
						return i
							? (0, t.Y)(a._, {
									children: (0, t.Y)('div', {
										...M,
										className: s()('ss__badge-rectangle', `ss__badge-rectangle--${m}`, _, g),
					...
					h = (0, o.PA)((f) => {
						...
						return i
							? (0, t.Y)(a._, {
									children: (0, t.Y)('div', {
										...M,
										className: s()('ss__badge-text', `ss__badge-text--${m}`, _, g),
				...
				const h = ({ transitionSpeed: E, color: T }) =>
					...
					f = (0, o.PA)((E) => {
						const T = (0, n.u)(),
							...
							{ active: m, onClick: _, disableA11y: g, className: b, internalClassName: D } = i,
				...
				const h = ({ theme: E }) =>
					...
					f = (0, c.PA)((E) => {
						const T = (0, d.u)(),
							...
							{ overrideElement: w, shouldRenderDefault: R } = (0, P._)('price', i);
						if (!R) return w;
						let I;
						_ && (I = g ? g(_) : r.G(_, { symbol: '', decimalPlaces: D, padDecimalPlaces: M, thousandsSeparator: x, decimalSeparator: A }));
						const N = (0, y.Z)(i, h);
						return I
							? j
								...
								: (0, t.Y)(n._, {
										children: (0, t.FD)('span', {
											...N,
											className: a()('ss__price', { 'ss__price--strike': m }, S, K),
											children: [
												!g && b && !B ? (0, t.Y)('span', { className: 'ss__price__symbol', children: b }) : (0, t.Y)(t.FK, {}),
												(0, t.Y)('span', { className: 'ss__price__value', children: I }),
												!g && b && B ? (0, t.Y)('span', { className: 'ss__price__symbol', children: b }) : (0, t.Y)(t.FK, {}),
												!g && U && W
													? (0, t.FD)(t.FK, { children: ['\xA0', (0, t.Y)('span', { className: 'ss__price__code', children: W })] })
													: (0, t.Y)(t.FK, {}),
											],
										}),
								  })
			...
			'./components/src/components/Molecules/CalloutBadge/CalloutBadge.tsx'(O, l, e) {
				...
				const T = () => (0, c.AH)({ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '5px' }),
					C = ({ badge: i, badgeComponentMap: m, treePath: _ }) => {
						const { ComponentOverride: g } = (0, f.x)(m, i.component);
						return g ? (0, t.Y)(g, { ...i, ...i.parameters, treePath: _ }) : null;
					},
					p = (0, o.PA)((i) => {
						const m = (0, n.u)(),
							_ = (0, d.uk)(),
							g = (0, u.LU)(),
							b = { name: i.tag ? (0, h.P)(i.tag) : void 0, tag: 'callout', limit: 1, treePath: g },
							D = (0, v.v6)('calloutBadge', m, b, i),
							{ result: M, tag: x, renderEmpty: A, limit: B, className: W, internalClassName: U, treePath: j } = D,
							{ overrideElement: S, shouldRenderDefault: K } = (0, E._)('calloutBadge', D);
						if (!K) return S;
						const w = { ...P.q, ...(_?.templates?.library.import.component.badge || {}), ...D.componentMap },
							R = (0, y.Z)(D, T),
							I = M?.display?.badges?.atLocation(x).slice(0, B);
						return A || I?.length
							? (0, t.Y)(a._, {
									children: (0, t.Y)('div', {
										...R,
										className: s()('ss__callout-badge', `ss__callout-badge--${x?.replace('/', '-')}`, W, U),
										children: I.map((N, $) => (0, t.Y)(C, { badge: N, badgeComponentMap: w, treePath: j }, `${N.component}-${$}`)),
									}),
							  })
							: null;
					});
			...
			'./components/src/components/Molecules/OverlayBadge/OverlayBadge.tsx'(O, l, e) {
				...
				const E = ({ section: i, top: m, bottom: _, index: g, tag: b }) =>
						(0, c.AH)({
							position: 'relative',
							display: 'flex',
					...
					C = ({ badge: i, badgeComponentMap: m, treePath: _ }) => {
						const { ComponentOverride: g } = (0, h.x)(m, i.component);
						return g ? (0, t.Y)(g, { ...i, ...i.parameters, treePath: _ }) : null;
					},
					p = (0, o.PA)((i) => {
						const m = (0, n.u)(),
							...
							{ result: M, children: x, controller: A, renderEmpty: B, limit: W, className: U, internalClassName: j, treePath: S } = D,
							{ overrideElement: K, shouldRenderDefault: w } = (0, f._)('overlayBadge', D);
						if (!w) return K;
						if (!x) return A?.log?.warn('OverlayBadge component must have children'), null;
						const R = A?.store?.meta;
						if (!R) return A?.log?.warn('Controller must have a meta store'), (0, t.Y)(t.FK, { children: x });
						const I = 'overlay',
							N = { ...P.q, ...(_?.templates?.library.import.component.badge || {}), ...D.componentMap },
							Q = R?.badges?.groups?.[I]?.sections
								?.map((L) => {
									const V = R?.data?.badges?.locations[L],
										k = V?.map((Y, F) => ({
											tag: Y.tag,
											name: Y.name,
											top: F == 0,
											bottom: F == V.length - 1,
											badges: M?.display?.badges?.atLocation(`${L}/${Y.tag}`).slice(0, W),
										})).filter((Y) => Y.badges?.length);
									return { section: L, slots: k };
								})
								.filter((L) => L.slots?.length),
							z = (0, y.Z)(D, T);
						return B || Q?.length
							? (0, t.Y)(a._, {
									children: (0, t.FD)('div', {
										...z,
										className: s()('ss__overlay-badge', U, j),
										children: [
											(0, t.Y)('div', {
												className: 'ss__overlay-badge__grid-wrapper',
												children: Q.map((L, V) =>
													L.slots?.map((k) => {
														const Y = E({ ...D, tag: k.tag, section: L.section, index: V, top: k.top, bottom: k.bottom });
														return (0, t.Y)(
															'div',
															{
																className: s()('ss__overlay-badge__grid-wrapper__slot', `ss__overlay-badge__grid-wrapper__slot--${k.tag}`),
																css: [Y],
																children: k.badges.map((F, H) =>
																	(0, t.Y)(C, { badge: F, badgeComponentMap: N, treePath: S }, `${k.tag}-${F.component}-${H}`)
																),
															},
															`${L.section}-${k.tag}`
														);
				...
				const f = () =>
					...
					E = (0, c.PA)((T) => {
						const C = (0, n.u)(),
							...
							{ overrideElement: j, shouldRenderDefault: S } = (0, h._)('rating', m);
						if (!S) return j;
						const K = {
							fullIcon: { name: 'star--full', ...(0, u.s)({ disableStyles: A }), theme: m?.theme, treePath: U },
							emptyIcon: { name: 'star--empty', color: '#ccc', ...(0, u.s)({ disableStyles: A }), theme: m?.theme, treePath: U },
						};
						let w = m.value;
						isNaN(w) && (w = Number(w) || 0), w < 0 && (w = 0), w > 5 && (w = 5);
						const R = (0, y.Z)(m, f),
							I = D ? Math.floor(w) : Math.ceil(w);
						return _ || w || g
							? (0, t.Y)(a._, {
									children: (0, t.FD)('div', {
										className: o()('ss__rating', B, W),
										...R,
										children: [
											(0, t.FD)('div', {
													...
													(0, t.Y)('div', {
														...
														children: [...Array(5)].map(() =>
															(0, t.Y)('span', {
																...
																children: (0, t.Y)(P.I, { ...K.emptyIcon, ...(typeof M == 'string' ? { icon: M } : M) }),
															})
														),
													}),
													(0, t.Y)('div', {
														className: 'ss__rating__stars ss__rating__stars--full',
														children: [...Array(I)].map((N, $) => {
															let Q = 100;
															return (
																$ + 1 == I && !D && w % 1 != 0 && (Q = (w % 1 || 1) * 100),
																(0, t.Y)('span', {
																	className: 'ss__rating__stars__star ss__rating__stars__star--full',
																	style: { width: `${Q}%` },
																	children: (0, t.Y)(P.I, { ...K.fullIcon, ...(typeof x == 'string' ? { icon: x } : x) }),
																})
															);
														}),
													}),
											...
											g ? (0, t.FD)('span', { className: 'ss__rating__count', children: ['(', g, ')'] }) : (0, t.Y)(t.FK, {}),
			...
			'./components/src/hooks/useCreateController.tsx'(O, l, e) {
				...
				const c = (r, s, o) => {
					...
					return (
						(0, t.vJ)(() => {
							r.getController(o.id)
								.then((d) => {
									n(d);
								})
								.catch(async () => {
									let d = o;
									if (s === 'recommendation' && !o.plugins && !o.middleware)
										try {
											const u = await r.getInstantiator('recommendation');
											d = { ...o, plugins: u.config.config.plugins, middleware: u.config.config.middleware };
										} catch {}
									try {
										const u = await r.createController(s, d);
										n(u);
									} catch (u) {
										console.error(`useCreateController: failed to create controller "${o.id}"`, u);
									}
								});
						}, []),
						a
										...
										v > 0
											? ((f.current = Date.now()),
											  ...
											  (h.current = window.setTimeout(() => {
													P(!0), d && o.current && p && p.unobserve(o.current);
											  }, v)))
											: (P(!0), d && o.current && p && p.unobserve(o.current));
									},
									g = () => {
										h.current && window.clearTimeout(h.current), (h.current = null), (f.current = null), P(!1);
									};
								return (
									(p = new IntersectionObserver(
										([b]) => {
											b.isIntersecting
												? o.current && s(o.current)
													? (m(), _())
													: (g(),
													  i ||
									...
									() => {
										P(!1), m(), h.current && window.clearTimeout(h.current), p && o.current && p.unobserve(o.current);
									}
								);
							}, [o, E]),
			...
			'./components/src/providers/withTracking.tsx'(O, l, e) {
				...
				function o(a) {
					const n = a;
					return (u) => {
						const { controller: v, result: y, banner: P, type: h, content: f, ...E } = u;
						if (u.trackingRef) return (0, t.Y)(n, { ...u });
						!v && (!h || !f) && console.warn('Warning: No controller provided to withTracking', u),
							!y && !P && (!h || !f) && console.warn('Warning: No result or banner provided to withTracking');
						const { ref: T, inViewport: C, updateRef: p } = (0, c.Q)(),
							i = (y || P || (h && f?.[h]?.[0]))?.responseId,
							m = (0, r.li)(i),
							_ = (0, r.li)(!1);
						...
						const g = h && f && !y && ['search', 'autocomplete'].includes(v?.type || '');
						C && !_.current && (g ? v?.track.banner.impression(f[h][0]) : y?.bundleSeed || v?.track.product.impression(y || P));
						const b = (0, r.hb)(
							(M) => {
								g ? v?.track.banner.click(M, f[h][0]) : v?.track.product.click(M, y || P);
							},
							[v, y, P, h, f]
						);
						(0, r.vJ)(() => {
			...
			'./components/src/utilities/defaultBadgeComponentMap.ts'(O, l, e) {
				...
				const o = { BadgeText: () => t.p, BadgePill: () => c.L, BadgeRectangle: () => r.Z, BadgeImage: () => s.z };
			},
			'./components/src/utilities/storybook.tsx'(O, l, e) {
				...
				const r = 'prism-block',
					s = (o) => {
						...
						return (
							(0, c.vJ)(() => {
								a.current && o.className?.includes('lang-') && !o.className?.includes(r) && window?.Prism?.highlightElement(a.current);
			...
			'../../node_modules/dequal/dist/index.mjs'(O, l, e) {
				...
				function c(s, o, a) {
					for (a of s.keys()) if (r(a, o)) return a;
				}
				function r(s, o) {
					var a, n, d;
					if (s === o) return !0;
					if (s && o && (a = s.constructor) === o.constructor) {
						if (a === Date) return s.getTime() === o.getTime();
						if (a === RegExp) return s.toString() === o.toString();
						if (a === Array) {
							if ((n = s.length) === o.length) for (; n-- && r(s[n], o[n]); );
							return n === -1;
						}
						if (a === Set) {
							if (s.size !== o.size) return !1;
							for (n of s) if (((d = n), (d && typeof d == 'object' && ((d = c(o, d)), !d)) || !o.has(d))) return !1;
							return !0;
						}
						if (a === Map) {
							if (s.size !== o.size) return !1;
							for (n of s) if (((d = n[0]), (d && typeof d == 'object' && ((d = c(o, d)), !d)) || !r(n[1], o.get(d)))) return !1;
							return !0;
						}
						if (a === ArrayBuffer) (s = new Uint8Array(s)), (o = new Uint8Array(o));
						else if (a === DataView) {
							if ((n = s.byteLength) === o.byteLength) for (; n-- && s.getInt8(n) === o.getInt8(n); );
							return n === -1;
						}
						if (ArrayBuffer.isView(s)) {
							if ((n = s.byteLength) === o.byteLength) for (; n-- && s[n] === o[n]; );
							return n === -1;
						}
						if (!a || typeof s == 'object') {
							n = 0;
							for (a in s) if ((t.call(s, a) && ++n && !t.call(o, a)) || !(a in o) || !r(s[a], o[a])) return !1;
							return Object.keys(o).length === n;
						}
					}
					return s !== s && o !== o;
				}
