				...
				const H = () =>
					...
					G = (0, r.PA)(($) => {
						...
						const u = m?.display?.mappings.core || m?.mappings?.core,
							...
							_ = {
								...
								button: {
									...
									onClick: (g) => {
										L(!0), R && R(g, m), y?.addToCart([m]), setTimeout(() => L(!1), de);
									},
									...(0, f.s)({ disableStyles: E }),
									theme: c.theme,
									treePath: v,
						...
						const pe = (0, T.Z)(c, H),
							...
							be = Y()(he, c.lang || {}),
							N = (0, z.u)(be, { result: m, controller: y }, { activeBreakpoint: A?.activeBreakpoint }),
							S = !!(u?.msrp && u?.price && u?.price < u?.msrp),
							ve = y?.store?.config?.asyncState?.product?.price ? m.state.priceFetched : !0;
						return u
							? (0, a.Y)(h._, {
												...
												(0, a.FD)('div', {
													...
													children: [
														(0, a.Y)('a', {
															...
															children: k
																? (0, a.Y)(n._, { ..._.image })
																: (0, a.Y)(W.Q, { ..._.overlayBadge, controller: y, children: (0, a.Y)(n._, { ..._.image }) }),
														}),
														!ue && y?.quickviewManager && (0, a.Y)(x.$, { ..._.quickviewButton, ...N.quickviewButtonText.attributes }),
													],
												}),
											(0, a.FD)('div', {
												className: 'ss__result__details',
												children: [
													!k && (0, a.Y)(U.W, { ..._.calloutBadge, controller: y }),
													!J &&
														(0, a.Y)('div', {
													...
													!X && ve && u.price && u.price > 0
														? (0, a.Y)('div', {
																...
																children: S
																	? (0, a.FD)(a.FK, {
																			children: [
																				(0, a.Y)(i.g, { ..._.price, value: u.msrp, lineThrough: !0, name: 'msrp' }),
																				'\xA0',
																				(0, a.Y)(i.g, { ..._.price, value: u.price, name: 'price' }),
																			],
																	  })
																	: (0, a.Y)(i.g, { ..._.price, value: u.price }),
														  })
														: null,
													...
													!ne && m.variants?.selections.length
														? (0, a.Y)('div', {
																...
																children: m.variants?.selections.map((g) => (0, a.Y)(Q.m, { ..._.variantSelection, type: g.type, selection: g })),
														  })
														: null,
													!oe &&
														(0, a.Y)('div', {
															className: 'ss__result__add-to-cart-wrapper',
															children: (0, a.Y)(x.$, { ..._.button, ...N.addToCartButtonText.all }),
														}),
												],
											}),
										],
