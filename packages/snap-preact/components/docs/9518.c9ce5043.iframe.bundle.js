			...
			'./components/src/components/Organisms/Autocomplete/Autocomplete.tsx'(et, ge, o) {
				...
				const Ie = ({
						...
						return (0, Ee.AH)({
							...
							'&.ss__autocomplete--only-terms': { width: `${a || l || s ? B : '150px'}` },
							...
							'.ss__autocomplete__terms': {
								...
								flex: '1 1 auto',
								maxWidth: `${a || l ? 'auto' : '150px'}`,
								minWidth: '150px',
								order: 1,
								background: '#f8f8f8',
								'.ss__autocomplete__terms__options': {
									display: a || l ? 'flex' : void 0,
									justifyContent: 'space-evenly',
									flexWrap: 'wrap',
									'.ss__autocomplete__terms__option': {
										flexGrow: a || l ? '1' : void 0,
										textAlign: a || l ? 'center' : void 0,
										wordBreak: 'break-all',
										a: { display: 'block', padding: a || l ? '10px 30px' : '10px', em: { fontStyle: 'normal' } },
					...
					Fe = (0, ye.PA)((i) => {
						...
						let s = (0, Me.v6)('autocomplete', l, d, i);
						...
						const {
							...
							T = {
								facets: { limit: 3, ...(0, K.s)({ disableStyles: V }), theme: s.theme, treePath: u },
								banner: {
									internalClassName: 'ss__autocomplete__banner',
									controller: n,
									...(0, K.s)({ disableStyles: V }),
									theme: s.theme,
									treePath: u,
								},
								results: {
								...
								icon: { internalClassName: 'ss__autocomplete__icon', size: '10px', ...(0, K.s)({ disableStyles: V }), theme: s.theme, treePath: u },
							},
							{
								search: p,
								terms: Y,
						...
						const Qe = c === h.focusedInput && (Y.length > 0 || y?.length > 0 || f?.length > 0 || (h.input && n.store.loaded)),
							de = y?.filter((t) => t.active).pop(),
							pe = f?.filter((t) => t.active).pop();
						let L = !1;
						y?.length && ((Se && n.store.loaded) || (!_.length && !h.input)) && (L = !0);
						let se = !1;
						f?.length && ((Ue && n.store.loaded) || (!_.length && !h.input)) && (se = !0),
						...
						const Xe = !!(p?.query?.string && _.length === 0),
							...
							D = C()(qe, s.lang || {}),
							m = (0, U.u)(D, { controller: n }, { activeBreakpoint: l?.activeBreakpoint });
						return Qe
							? (0, e.Y)(be._, {
									children: (0, e.FD)('div', {
										...Ze,
																					...
																					(0, e.Y)('div', {
																						...
																						children: Y.map((t, r) => {
																							const P = {
																								...
																								A = C()(P, s.lang || {}),
																								M = (0, U.u)(A, { controller: n, term: t, index: r }, { activeBreakpoint: l?.activeBreakpoint });
																							return (0, e.Y)('div', {
															...
															children: [
																...
																(0, e.FD)('div', {
																	...
																	children: [
																		...
																		I ? null : (0, e.Y)(N.l, { ...T.banner, content: O.content, type: k.c.LEFT, name: 'left' }),
																	],
																}),
															],
													  })),
											Ne
												...
												? (0, e.Y)('div', {
														...
														children: (0, e.FD)(e.FK, {
															children: [
																I ? null : (0, e.Y)(N.l, { ...T.banner, content: O.content, type: k.c.HEADER, name: 'header' }),
																I ? null : (0, e.Y)(N.l, { ...T.banner, content: O.content, type: k.c.BANNER, name: 'banner' }),
																_.length > 0
																	? (0, e.Y)('div', {
																...
																I ? null : (0, e.Y)(N.l, { ...T.banner, content: O.content, type: k.c.FOOTER, name: 'footer' }),
																Ke
																	? null
																	: ue
					...
					$ = (i, l) => {
						if (i && l) {
							const v = i.match(We(l));
							if (l && i && v && typeof v.index == 'number') {
								const d = i.slice(0, v.index),
									s = i.slice(v.index + l.length, i.length);
								return (0, e.FD)(e.FK, { children: [d ? (0, e.Y)('em', { children: d }) : '', l, s ? (0, e.Y)('em', { children: s }) : ''] });
							}
						}
