	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[7845],
		{
			'./components/src/components/Templates/AutocompleteSlideout/AutocompleteSlideout.stories.tsx'(x, a, e) {
				'use strict';
				e.r(a), e.d(a, { Default: () => m, __namedExportsOrder: () => b, default: () => v });
			...
			'./components/src/components/Templates/AutocompleteSlideout/AutocompleteSlideout.tsx'(x, a, e) {
				...
				const w = ({}) =>
					...
					D = (0, f.PA)((P) => {
						...
						let A = t.controller,
							K = [A];
						I && I.active && ((A = I.active?.controller), (K = I.tabs.map((U) => U.controller)));
						const F = (0, u.li)(null),
							O = () => {
								W(!1), A.setFocused();
							},
						...
						n &&
							...
							(V = (0, s.x)({ input: n, controllers: K, renderedInputRef: F, renderInput: !!R, buttonSelector: c })));
						const E = { ...t };
						return (
							delete E.width,
							delete E.className,
								...
								? (0, o.Y)(T._, {
										children: (0, o.Y)(m.S, {
											...
											children: (0, o.FD)('div', {
												...
												ref: (U) => (0, d.iy)(U, 0, !0, O),
												children: [
													R ? (0, o.Y)(y.D, { ...j.searchInput, value: A.store.state.input || '', inputRef: F }) : (0, o.Y)(o.FK, {}),
													(0, o.Y)(S.h, { ...E, ...j.autocompleteLayout, input: V, controller: A, treePath: `${C} slideout` }),
												],
											}),
										}),
								  })
...
//# sourceMappingURL=components-Templates-AutocompleteSlideout-AutocompleteSlideout-stories.a03defc9.iframe.bundle.js.map
