							...
							Es = () => {
								...
								return o && I > 0 && C.length !== u
									? (0, t.Y)('div', {
											...
											children: B
												? (0, os.Y)(B, { limited: A, remainder: I, treePath: K })
												: A
																...
																children: (0, t.FD)('div', {
																	...
																	children: [
																		!o.background && o.backgroundImageUrl
																			...
																			: null,
																		R ? null : (0, t.Y)('label', { className: 'ss__grid__option__label', children: o.label || o.value }),
																	],
																}),
															});
													}),
				...
				const rs = ({ theme: O }) =>
					...
					is = (0, ts.PA)((O) => {
						...
						if (R && Object.keys(R).length) {
							const e = ns()(i?.theme || {}, R?.theme || {}, { arrayMerge: (h, W) => W });
							i = { ...i, ...R, theme: e };
						}
						const {
								onSelect: Y,
						...
						const K = {
								slideshow: {
									...
									autoPlay: !1,
									...C,
									...(0, g.s)({ breakpoints: L, disableStyles: T }),
									theme: i?.theme,
									treePath: U,
								},
								grid: {
									...
									columns: 6,
									...ds,
									...(0, g.s)({ disableStyles: T }),
									theme: i?.theme,
									treePath: U,
								},
								image: { internalClassName: 'ss__swatches__image', ...(0, g.s)({ disableStyles: T }), theme: i?.theme, treePath: U },
							},
							Q = i.selected,
							hs = (0, j.Z)(i, rs),
