	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[5019],
		{
			'./components/src/components/Molecules/FacetSlider/FacetSlider.stories.tsx'(z, k, o) {
				'use strict';
				o.r(k), o.d(k, { Price: () => d, __namedExportsOrder: () => v, default: () => B });
...
`,
			...
			'./components/src/components/Molecules/FacetSlider/FacetSlider.tsx'(z, k, o) {
				...
				var s = o('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					t = o.n(_),
					b = o('../../node_modules/react-ranger/dist/react-ranger.mjs'),
				...
				function S(...E) {
					for (var j = 0, n, M = E[j++], w = [], u, e, H, A; M; ) {
				...
				const ee = ({
					...
					I = (0, y.PA)((E) => {
						const j = (0, B.u)(),
							n = (0, d.LU)(),
							M = { tickSize: E.facet?.step ? E.facet?.step * 10 : 20, treePath: n },
							w = (0, a.v6)('facetSlider', j, M, E),
							...
							t &&
								(t?.value &&
									(typeof t.value == 'function'
										? (b.value = { 'ss-lang': _, dangerouslySetInnerHTML: { __html: t.value(y) } })
										: (b.value = { 'ss-lang': _, dangerouslySetInnerHTML: { __html: t.value } })),
								t?.attributes &&
									Object.keys(t?.attributes).length &&
									((b.attributes = { 'ss-lang': _ }),
									t?.attributes?.['aria-label'] &&
										(typeof t.attributes?.['aria-label'] == 'function'
											? (b.attributes['aria-label'] = t.attributes['aria-label'](y))
											: (b.attributes['aria-label'] = t.attributes['aria-label'])),
									t?.attributes?.['aria-valuetext'] &&
										(typeof t.attributes?.['aria-valuetext'] == 'function'
											? (b.attributes['aria-valuetext'] = t.attributes['aria-valuetext'](y))
											: (b.attributes['aria-valuetext'] = t.attributes['aria-valuetext'])),
									t?.attributes?.title &&
										(typeof t.attributes?.title == 'function'
											? (b.attributes.title = t.attributes.title(y))
											: (b.attributes.title = t.attributes.title)),
									t?.attributes?.alt &&
										(typeof t.attributes?.alt == 'function' ? (b.attributes.alt = t.attributes.alt(y)) : (b.attributes.alt = t.attributes.alt)),
									t?.attributes?.placeholder &&
										(typeof t.attributes?.placeholder == 'function'
											? (b.attributes.placeholder = t.attributes.placeholder(y))
											: (b.attributes.placeholder = t.attributes.placeholder))),
			...
			'../../node_modules/react-ranger/dist/react-ranger.mjs'(z, k, o) {
				...
				function y(d, v) {
					...
					var a = {},
						...
						D,
						S;
					for (S = 0; S < x.length; S++) (D = x[S]), !(v.indexOf(D) >= 0) && (a[D] = d[D]);
					return a;
				}
				var V = function (v) {
					...
					_ = function (v) {
						return [].concat(v).sort(function (a, x) {
					...
					b = {
						getPercentageForValue: function (v, a, x) {
							return Math.max(0, Math.min(100, ((v - a) / (x - a)) * 100));
						},
						getValueForClientX: function (v, a, x, D) {
							var S = a.left,
								T = a.width,
								C = (v - S) / T,
								W = (D - x) * C;
						...
						X = s.default.useCallback(
							function (r) {
								var l = e(),
									...
									g = A(m),
									L = Z(g),
									c = [].concat(S.slice(0, p), [L], S.slice(p + 1));
								f ? f(c) : u(c);
							},
							[e, A, Z, S]
						),
									...
									return {
										...
										getTickProps: function (m) {
											var g = m === void 0 ? {} : m,
												...
												F = i === void 0 ? {} : i,
												P = y(g, ['key', 'style']);
											return h({ key: c, style: h({ position: 'absolute', width: 0, left: Y(l) + '%', transform: 'translateX(-50%)' }, F) }, P);
										},
									};
								});
							},
