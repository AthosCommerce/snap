  ...
  return <Select {...args} options={iconOptions} />;
			...
			'./components/src/components/Atoms/Button/Button.tsx'(B, i, e) {
				...
				const K = ({ native: Q, color: m, backgroundColor: c, borderColor: g, theme: b }) =>
					...
					Y = (0, r.PA)((Q) => {
						const m = (0, s.u)(),
							g = { disableA11y: !1, treePath: (0, R.LU)() },
							...
							{ overrideElement: U, shouldRenderDefault: q } = (0, P._)('button', b);
						if (!q) return U;
			...
			'./components/src/components/Atoms/Dropdown/Dropdown.tsx'(B, i, e) {
				...
				const D = ({ disableOverlay: K }) =>
					...
					T = (0, s.PA)((K) => {
						...
						j ||
							(I = (0, l.L)((a) => {
								(U && te.current && te.current.contains(a.target)) || (L && (h || (X && N && N(!1), $ && $(a, !1))));
							})),
							(0, n.vJ)(() => {
								if (U && L) {
									const a = () => {
					...
					m = (0, n.PA)((c) => {
						...
						const ee = {
								dropdown: {
									...
									...(0, v.s)({ disableStyles: w, disabled: A }),
									theme: h?.theme,
									treePath: ie,
								},
								button: {
									internalClassName: 'ss__select__dropdown__button',
									...(0, v.s)({ disableStyles: w, disabled: A, color: H, backgroundColor: F, borderColor: J }),
									theme: h?.theme,
									treePath: ie,
								},
								icon: {
									internalClassName: 'ss__select__dropdown__button__icon',
									...(0, v.s)({ disableStyles: w, color: ne || H, size: '12px' }),
									theme: h?.theme,
									treePath: ie,
								},
							},
			...
			'./components/src/utilities/snapify.ts'(B, i, e) {
				...
				function Y(m) {
					...
					return new p.c(m.controller, {
						client: new r.K(m.client.globals, m.client.config),
						store: new R.t(m.controller, { urlManager: c }),
						urlManager: c,
						eventManager: new C.E(),
						profiler: new f.U(),
						logger: new E.V(),
...
//# sourceMappingURL=components-Molecules-Select-Select-stories.bbd66839.iframe.bundle.js.map
