			...
			'./components/src/components/Molecules/Result/Result.tsx'(O, l, e) {
				...
				const j = () =>
					...
					$ = (0, u.PA)((z) => {
						...
						const t = n?.display?.mappings.core || n?.mappings?.core,
							...
							a = {
								...
								button: {
									...
									onClick: (i) => {
										F(!0), V && V(i, n), m?.addToCart([n]), setTimeout(() => F(!1), le);
									},
									...(0, r.s)({ disableStyles: c }),
									theme: o.theme,
									treePath: _,
						...
						let H = t?.name;
						o.truncateTitle && (H = C.x(t?.name || '', o.truncateTitle.limit, o.truncateTitle.append));
						const ue = (0, f.Z)(o, j),
							pe = { addToCartButtonText: { value: de ? re : ae } },
							Ee = M()(pe, o.lang || {}),
							Pe = (0, y.u)(Ee, { result: n, controller: m }, { activeBreakpoint: Y?.activeBreakpoint }),
							Q = !!(t?.msrp && t?.price && t?.price < t?.msrp),
							Te = m?.store?.config?.asyncState?.product?.price ? n.state.priceFetched : !0;
						return t
							? (0, s.Y)(A._, {
									children: (0, s.FD)('article', {
										...ue,
										className: B()('ss__result', `ss__result--${te}`, { 'ss__result--sale': Q }, ee, se),
										ref: ie,
										children: [
											!X &&
												(0, s.Y)('div', {
											...
											(0, s.FD)('div', {
												...
												children: [
													!k && (0, s.Y)(E.W, { ...a.calloutBadge, controller: m }),
													!J &&
														(0, s.Y)('div', {
