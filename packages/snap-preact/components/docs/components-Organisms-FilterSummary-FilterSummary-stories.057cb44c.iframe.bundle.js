	...
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[6175],
		{
			'./components/src/components/Organisms/FilterSummary/FilterSummary.stories.tsx'(D, a, e) {
				'use strict';
				e.r(a), e.d(a, { Regular: () => o, __namedExportsOrder: () => g, customTitle: () => E, default: () => v, noFacetLabel: () => h });
				...
				const C =
					...
					o = (b, { loaded: { controller: y } }) => (0, s.Y)(_.r, { ...b, controller: y });
				o.loaders = [async () => (await f.search(), { controller: f })];
				const h = (b, { loaded: { controller: y } }) => (0, s.Y)(_.r, { ...b, controller: y });
				(h.loaders = [async () => (await f.search(), { controller: f })]), (h.args = { hideFacetLabel: !0 });
				const E = (b, { loaded: { controller: y } }) => (0, s.Y)(_.r, { ...b, controller: y });
				(E.loaders = [async () => (await f.search(), { controller: f })]),
					(E.args = { title: 'Selected Filters' }),
					(o.parameters = {
						...o.parameters,
						docs: {
							...o.parameters?.docs,
				...
				const M = ({ native: L, color: c, backgroundColor: n, borderColor: l, theme: u }) =>
					...
					A = (0, m.PA)((L) => {
						const c = (0, r.u)(),
							...
							{ overrideElement: K, shouldRenderDefault: J } = (0, y._)('button', u);
						if (!J) return K;
						const z = { icon: { internalClassName: 'ss__button__icon', ...(0, o.s)({ disableStyles: R }), theme: u?.theme, treePath: T } },
							$ = {
								...(0, E.Z)(u, M),
								className: _()('ss__button', { 'ss__button--native': Y, 'ss__button--disabled': F }, V, H),
								disabled: F,
								onClick: (Q) => !F && W && W(Q),
								...I,
							},
						...
						return p || P || O || N?.button?.value || ee
							? (0, s.Y)(t._, {
									children: Y
										? (0, s.FD)('button', {
												...$,
												children: [
													(0, s.FD)('span', {
														...
														...X.button?.all,
														children: [(0, f.Y)(p, { treePath: T }), (0, f.Y)(P, { treePath: T })],
													}),
							...
							? (0, s.Y)(v._, {
									children: (0, s.Y)('a', {
										...
										children: (0, s.FD)(h.$, {
											...K.button,
											children: [
												(0, s.Y)(E.I, { ...K.icon, ...(typeof U == 'string' ? { icon: U } : U) }),
												!Y &&
													(0, s.FD)('span', {
														className: 'ss__filter__label',
														children: [I, R && (0, s.Y)('span', { className: 'ss__filter__label__separator', children: R })],
													}),
					...
					j = (0, m.PA)((M) => {
						...
						const K = {
								filter: {
									...
									...(0, r.s)({ disableStyles: N, separator: Y, hideFacetLabel: W, icon: P }),
									theme: n.theme,
									treePath: k,
								},
							},
							J = (0, v.Z)(n, x),
							z = { title: { value: u }, clearAllLabel: { value: R } },
							w = y()(z, n.lang || {}),
							$ = (0, E.u)(w, { filters: l });
						return l?.length
							? (0, s.Y)(f._, {
									children: (0, s.FD)('div', {
										...
										children: [
											!U && (0, s.Y)('div', { className: 'ss__filter-summary__title', ...$.title?.all }),
											(0, s.FD)('div', {
						...
						C &&
							t.addEventListener('keydown', function (o) {
								...
								(o.key === 'Tab' || o.keyCode === s) &&
									(o.shiftKey
										? document.activeElement === E && (g.focus(), o.preventDefault())
										: document.activeElement === g && (E.focus(), o.preventDefault()));
							}));
				}
				e.d(a, ['DH', 0, _, 'aZ', 0, i]);
			},
			...
			'./components/src/utilities/snapify.ts'(D, a, e) {
				...
				class j {
					static recommendation(n) {
						const l = n.id;
						if (y[l]) return y[l];
						const u = (y[l] = A({ client: x, controller: n }));
						return (
					...
					static autocomplete(n) {
						const l = n.id;
						if (y[l]) return y[l];
						const u = (y[l] = L({ client: x, controller: n }));
						return (
							u.on('afterStore', async ({ controller: p }, P) => {
								p.log.debug('controller', p), p.log.debug('store', p.store.toJSON()), await P();
							}),
					...
					static search(n) {
						const l = n.id;
						if (y[l]) return y[l];
						const u = (y[l] = M({ client: x, controller: n }));
						return (
							u.on('afterStore', async ({ controller: p }, P) => {
								p.log.debug('controller', p), p.log.debug('store', p.store.toJSON()), await P();
							}),
				...
				function M(c) {
					const n = new v.V(new o.E({ settings: { coreType: 'query', corePrefix: c.controller.id } }), f.X);
				...
				function A(c) {
					const n = new v.V(new o.E(), f.X).detach(!0);
				...
				function L(c) {
					const n = new v.V(new o.E(), f.X).detach();
...
//# sourceMappingURL=components-Organisms-FilterSummary-FilterSummary-stories.057cb44c.iframe.bundle.js.map
