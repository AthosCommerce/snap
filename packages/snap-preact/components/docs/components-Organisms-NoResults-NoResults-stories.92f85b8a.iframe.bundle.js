(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[3471],
		{
			'../../node_modules/@athoscommerce/snap-toolbox/dist/esm/filters/handleize.js'(d, a, t) {
				'use strict';
				t.d(a, { p: () => s });
				function s(r) {
			...
			'./components/src/components/Organisms/NoResults/NoResults.stories.tsx'(d, a, t) {
				'use strict';
				t.r(a), t.d(a, { Default: () => e, WithRecommendations: () => o, __namedExportsOrder: () => v, default: () => c });
				var s = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
					...
					l = t('./components/src/components/Organisms/NoResults/NoResults.tsx'),
					m = t('./components/src/utilities/storybook.tsx'),
					n = t('./components/src/utilities/componentArgs.ts');
				const i = `# NoResults
...
`,
			...
			'./components/src/components/Organisms/NoResults/NoResults.tsx'(d, a, t) {
				'use strict';
				var s = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
			...
			`,
						...
						return (0, s.FD)('div', {
							className: n()('ss__no-results', z, J),
							...Q,
							children: [
								f &&
									(typeof f == 'string'
			...
			'./components/src/hooks/useCreateController.tsx'(d, a, t) {
				'use strict';
				...
				const r = (l, m, n) => {
					...
					return (
						(0, s.vJ)(() => {
							l.getController(n.id)
								.then((e) => {
									c(e);
								})
								.catch(async () => {
									let e = n;
									if (m === 'recommendation' && !n.plugins && !n.middleware)
										try {
											const o = await l.getInstantiator('recommendation');
											e = { ...n, plugins: o.config.config.plugins, middleware: o.config.config.middleware };
										} catch {}
									try {
										const o = await l.createController(m, e);
										c(o);
									} catch (o) {
										console.error(`useCreateController: failed to create controller "${n.id}"`, o);
									}
								});
						}, []),
						i
			...
			'./components/src/hooks/useLang.tsx'(d, a, t) {
				'use strict';
				const s = (r, l, m) => {
					const n = m ? { ...l, ...m } : l,
						i = {};
							...
							e &&
								(e?.value &&
									(typeof e.value == 'function'
										? (o.value = { 'ss-lang': c, dangerouslySetInnerHTML: { __html: e.value(n) } })
			...
			'./components/src/utilities/componentArgs.ts'(d, a, t) {
				'use strict';
				const s = {
					className: {
			...
			'./components/src/utilities/storybook.tsx'(d, a, t) {
				'use strict';
				var s = t('../../node_modules/@emotion/react/jsx-runtime/dist/emotion-react-jsx-runtime.browser.esm.js'),
				...
				const l = 'prism-block',
					m = (n) => {
						...
						return (
							(0, r.vJ)(() => {
								i.current && n.className?.includes('lang-') && !n.className?.includes(l) && window?.Prism?.highlightElement(i.current);
							}, [n.className, n.children, i]),
							(0, s.Y)('code', { ...n, ref: i, 'data-prismjs-copy': 'Copy' })
						);
					};
				t.d(a, ['Z', 0, m]);
			},
...
//# sourceMappingURL=components-Organisms-NoResults-NoResults-stories.92f85b8a.iframe.bundle.js.map
