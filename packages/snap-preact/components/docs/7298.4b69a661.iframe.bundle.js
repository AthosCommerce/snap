...
(() => {
	(self.webpackChunk_athoscommerce_snap_preact = self.webpackChunk_athoscommerce_snap_preact || []).push([
		[7298],
		{
			'./src/Templates/Stores/library/languages/fr.ts'(l, t, a) {
				a.r(t);
				const r = {
					recommendation: {},
					autocompleteLayout: {
					...
					tabSelection: {
						tabList: { attributes: { 'aria-label': 'Onglets de r\xE9sultats' } },
						tabButton: {
							attributes: {
								'aria-label': (e) => `${e.tab.label || e.tab.id}${typeof e.resultCount == 'number' ? `, ${e.resultCount} r\xE9sultats` : ''}`,
							},
						},
					},
					...
					result: {
						addToCartButtonText: { value: 'Tout ajouter au panier', attributes: { 'aria-label': 'Tout ajouter au panier' } },
						addToCartButtonSuccessText: { value: 'Ajout\xE9 !' },
						quickviewButtonText: { value: 'Aper\xE7u rapide', attributes: { 'aria-label': 'Aper\xE7u rapide' } },
					},
					overlayResult: {
						addToCartButtonText: { value: 'Tout ajouter au panier', attributes: { 'aria-label': 'Tout ajouter au panier' } },
						addToCartButtonSuccessText: { value: 'Ajout\xE9 !' },
					...
					quantityPicker: {
						quantityInput: { attributes: { 'aria-label': 'quantit\xE9' } },
						decrementButton: { attributes: { 'aria-label': 'diminuer la quantit\xE9' } },
						incrementButton: { attributes: { 'aria-label': 'augmenter la quantit\xE9' } },
					},
					searchHeader: {
						titleText: {
                ...
                ${e?.search?.query ? `pour <span class="ss__search-header__results-query">"${e?.search?.query.string}"</span>` : ''}`,
                    ...
                    Aucun r\xE9sultat pour <span class="ss__search-header__results-query">"${e?.search?.query?.string}"</span> trouv\xE9e.
						...
						expandedSearchText: {
							value: (e) =>
								`Nous n'avons pas pu trouver de correspondance exacte pour "<span class="ss__search-header__results-query">${e?.search?.query?.string}</span>", mais voici quelque chose de similaire:`,
						},
					},
					noResults: {
						suggestionsTitleText: { value: 'Suggestions' },
						suggestionsList: {
							value: `<ul class="ss__no-results__suggestions__list"><li class="ss__no-results__suggestions__list__option">V\xE9rifiez les fautes d\u2019orthographe.</li><li class="ss__no-results__suggestions__list__option">Supprimez les \xE9ventuels mots-cl\xE9s redondants (ie: "produits").</li><li class="ss__no-results__suggestions__list__option">Utilisez d'autres mots pour d\xE9crire ce que vous recherchez.</li></ul>`,
						},
					},
					gallery: {
						gallery: { attributes: { 'aria-label': "Galerie d'images" } },
						zoomOutButton: { attributes: { 'aria-label': 'Zoom arri\xE8re' } },
						zoomInButton: { attributes: { 'aria-label': 'Zoom avant' } },
						closeButton: { attributes: { 'aria-label': 'Fermer la galerie' } },
						prevButton: { attributes: { 'aria-label': 'Image pr\xE9c\xE9dente' } },
						nextButton: { attributes: { 'aria-label': 'Image suivante' } },
					},
					quickviewLayout: {
						quickview: { attributes: { 'aria-label': 'Aper\xE7u rapide' } },
						closeButton: { attributes: { 'aria-label': "Fermer l'aper\xE7u rapide" } },
						addToCartButton: { value: 'Ajouter au panier' },
						moreInfoButton: { value: "Plus d'informations" },
						loadingText: { value: 'Chargement\u2026' },
					},
				};
				a.d(t, ['fr', 0, r]);
			},
...
//# sourceMappingURL=7298.4b69a661.iframe.bundle.js.map
