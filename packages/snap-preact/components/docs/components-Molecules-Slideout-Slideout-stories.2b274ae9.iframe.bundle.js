					...
					u = {
						...
						parameters: {
							docs: {
								page: () =>
									(0, t.FD)('div', {
										children: [(0, t.Y)(i.oz, { options: { overrides: { code: d.Z } }, children: n }), (0, t.Y)(i.uY, { story: i.h1 })],
									}),
							},
						},
						argTypes: {
							...
							onChange: {
								...
								table: { type: { summary: '(active: boolean) => void' } },
								control: 'none',
							},
							...a.F,
						},
				...
				const C = ({ transitionSpeed: g, color: O }) =>
					...
					P = (0, a.PA)((g) => {
						const O = (0, u.u)(),
							...
							{ overrideElement: E, shouldRenderDefault: M } = (0, s._)('overlay', l);
						if (!M) return E;
						const T = (0, y.Z)(l, C);
						return (0, t.Y)(n._, {
							children: (0, t.Y)('div', {
				...
				const j = ({ slideDirection: l, transitionSpeed: b, width: m }) =>
					...
					L = (0, r.PA)((l) => {
						const b = (0, f.u)(),
							...
							{ overrideElement: z, shouldRenderDefault: H } = (0, g._)('slideout', S);
						if (!H) return z;
						const J = {
								overlay: {
									internalClassName: 'ss__slideout__overlay',
									...(0, c.s)({ disableStyles: V, color: Y, transitionSpeed: N }),
									theme: S?.theme,
									treePath: A,
								},
							},
							...
							R || !M
								? (0, t.FD)(s._, {
										children: [
											...
											(0, t.Y)(O.h, { ...J.overlay, active: _, onClick: D }),
										],
								  })
								: null
						);
						...
						c &&
							n.addEventListener('keydown', function (s) {
								const f = n.querySelectorAll(d),
									...
									P = f[f.length - 1];
								if (s.keyCode == i) {
									n.focus(), h && h(s), s.preventDefault(), s.stopPropagation();
									return;
								}
								(s.key === 'Tab' || s.keyCode === t) &&
									(s.shiftKey
										? document.activeElement === C && (P.focus(), s.preventDefault())
										: document.activeElement === P && (C.focus(), s.preventDefault()));
							}));
				}
				e.d(o, ['DH', 0, d, 'aZ', 0, r]);
			},
...
//# sourceMappingURL=components-Molecules-Slideout-Slideout-stories.2b274ae9.iframe.bundle.js.map
