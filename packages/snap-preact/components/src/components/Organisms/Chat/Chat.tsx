...
export const ChatOrganism = observer((properties: ChatOrganismProps): JSX.Element => {
	...
	const defaultProps: Partial<ChatOrganismProps> = {
		...
		primaryColorBg: globalTheme?.variables?.colors?.primary || '#253B80',
		primaryColorFg: '#fff',
		primaryAccentColorBg: globalTheme?.variables?.colors?.accent || '#feeeae',
		primaryAccentColorFg: '#000000',
		secondaryAccentColorBg: globalTheme?.variables?.colors?.secondary || '#000000',
