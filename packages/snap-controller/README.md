...
Although `@athoscommerce/snap-controller` is published as a standalone package, it is not intended to be used directly. Internally it is a dependency of the `@athoscommerce/snap-preact` package.
